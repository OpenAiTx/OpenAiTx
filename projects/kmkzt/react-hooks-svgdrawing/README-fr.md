...
[![version npm](https://badge.fury.io/js/react-hooks-svgdrawing.svg)](https://www.npmjs.com/package/react-hooks-svgdrawing) [![téléchargement npm](https://img.shields.io/npm/dt/react-hooks-svgdrawing.svg)](https://www.npmjs.com/package/react-hooks-svgdrawing)

`react-hooks-svgdrawing` est une bibliothèque de dessin React. Cette bibliothèque est une extension React de [svg-drawing](https://github.com/kmkzt/svg-drawing)

**[démo](https://kmkzt.github.io/react-hooks-svgdrawing/)**
