...
I don't have access to TrainerRoad anymore. The account I used canceled the subscription. I don't use the platform and it's too expensive to have it for occasional fixes.  
To fix issues I can only rely on logs and HAR files from you.
