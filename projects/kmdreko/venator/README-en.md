...
Venator is an application for recording, viewing, and filtering logs and spans
...
Binaries are pre-built and available on the [releases page](https://github.com/kmdreko/venator/releases) for:
- Windows (x64)
...
<picture>
  <img alt="screenshots of events screen" src="https://raw.githubusercontent.com/kmdreko/venator/main/docs/images/screenshot-events.png">
</picture>
...
<picture>
  <img alt="screenshots of spans screen" src="https://raw.githubusercontent.com/kmdreko/venator/main/docs/images/screenshot-spans.png">
</picture>

Traces can be viewed that show both events and spans within a single execution.

<picture>
  <img alt="screenshots of trace screen" src="https://raw.githubusercontent.com/kmdreko/venator/main/docs/images/screenshot-traces.png">
</picture>
