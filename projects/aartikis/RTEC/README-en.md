...
RTEC is an open-source [Event Calculus](https://en.wikipedia.org/wiki/Event_calculus) dialect optimized for data stream reasoning. It is written in Prolog and has been tested under [SWI-Prolog](https://www.swi-prolog.org/) on Linux, MacOS, and Windows.
...
Latest [documentation](https://raw.githubusercontent.com/aartikis/RTEC/master/docs/contents.md).

# Feedback 

For more information and feedback, do not hesitate to send us an [email](https://raw.githubusercontent.com/aartikis/RTEC/master/mailto:a.artikis@gmail.com,periklismant1@gmail.com) or add an issue in this repository.
