...
ASMRoner, Go diliyle yazılmış, asmr.one sesli eserlerini aramak, indirmek, senkronize etmek için kullanılan bir komut satırı aracıdır ve basit bir web oynatıcı arayüzü sunar.

> 🌐 Türev proje: [asmr.furina.in](https://asmr.furina.in) — Temiz ve sade bir çevrimiçi ASMR dinleme sayfası
...
<details>
<summary><b>📋 Komut Seçenekleri Hızlı Bakış</b></summary>
