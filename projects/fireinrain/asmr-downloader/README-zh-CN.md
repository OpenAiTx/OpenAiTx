...
ASMRoner 是一个用 Go 语言开发的命令行工具，支持搜索、下载、同步 asmr.one 音声作品，并提供简易 Web 播放界面。

> 🌐 衍生项目：[asmr.furina.in](https://asmr.furina.in) —— 一个简洁纯净的在线 ASMR 播放页面
