...
```
### 4. (वैकल्पिक) प्रशिक्षण या कुशल इनफेरेंस के लिए k2 स्थापित करें

k2 प्रशिक्षण के लिए आवश्यक है और इनफेरेंस को तेज कर सकता है। फिर भी, आप k2 स्थापित किए बिना ZipVoice के इनफेरेंस मोड का उपयोग कर सकते हैं।

> **नोट:** सुनिश्चित करें कि आप अपने PyTorch और CUDA संस्करण के अनुसार k2 का संस्करण स्थापित कर रहे हैं। उदाहरण के लिए, यदि आप pytorch 2.5.1 और CUDA 12.1 का उपयोग कर रहे हैं, तो आप k2 को निम्न प्रकार स्थापित कर सकते हैं:
...
चीन मुख्य भूमि के उपयोगकर्ता https://k2-fsa.org/zh-CN/get-started/k2/ देख सकते हैं।

## उपयोग

### 1. एकल वक्ता भाषण निर्माण

हमारे प्री-ट्रेंड ZipVoice या ZipVoice-Distill मॉडलों के साथ एकल वक्ता भाषण उत्पन्न करने के लिए, निम्नलिखित कमांड का उपयोग करें (आवश्यक मॉडल HuggingFace से डाउनलोड हो जाएंगे):

#### 1.1 एकल वाक्य का अनुमापन
...
### 2. बोले गए संवाद जनरेशन

#### 2.1 अनुमान आदेश

हमारे प्री-ट्रेन्ड ZipVoice-Dialogue या ZipVoice-Dialogue-Stereo मॉडल के साथ द्विपक्षीय बोले गए संवाद जनरेट करने के लिए, निम्नलिखित कमांड का उपयोग करें (आवश्यक मॉडल HuggingFace से डाउनलोड किए जाएंगे):
...
```
- `wav_name` आउटपुट वेव फाइल का नाम है।
- `spk1_prompt_transcription` पहले वक्ता के प्रॉम्प्ट वेव का ट्रांसक्रिप्शन है, जैसे, "Hello"
- `spk2_prompt_transcription` दूसरे वक्ता के प्रॉम्प्ट वेव का ट्रांसक्रिप्शन है, जैसे, "How are you?"
- `spk1_prompt_wav` पहले वक्ता के प्रॉम्प्ट वेव फाइल का पथ है।
- `spk2_prompt_wav` दूसरे वक्ता के प्रॉम्प्ट वेव फाइल का पथ है।
- `text` वह पाठ है जिसे सिंथेसाइज़ करना है, जैसे "[S1] I'm fine. [S2] What's your name?"

### 3. अन्य विशेषताएँ

#### 3.1 चीनी बहु-ध्वनि अक्षरों का गलत उच्चारण सुधारना

हम [pypinyin](https://github.com/mozillazg/python-pinyin) का उपयोग चीनी अक्षरों को पिनयिन में बदलने के लिए करते हैं। हालांकि, यह कभी-कभी **बहु-ध्वनि अक्षरों** (多音字) का गलत उच्चारण कर सकता है।

इन गलत उच्चारणों को मैन्युअली सही करने के लिए, **सही पिनयिन** को कोणीय कोष्ठक `< >` में लिखें और **स्वर चिह्न** शामिल करें।

**उदाहरण:**

- मूल पाठ: `这把剑长三十公分`
- `长` के पिनयिन को सही करें:  `这把剑<chang2>三十公分`

> **नोट:** यदि आप मैन्युअली एक से अधिक पिनयिन असाइन करना चाहते हैं, तो प्रत्येक पिनयिन को `< >` में लिखें, जैसे, `这把<jian4><chang2><san1>十公分`

## अपना खुद का मॉडल ट्रेन करें

प्रशिक्षण और फाइन-ट्यूनिंग के उदाहरणों के लिए [egs](egs) डायरेक्टरी देखें।

## चर्चा और संचार

आप सीधे [Github Issues](https://github.com/k2-fsa/ZipVoice/issues) पर चर्चा कर सकते हैं।

आप हमारे वीचैट ग्रुप में शामिल होने या हमारे वीचैट आधिकारिक अकाउंट को फॉलो करने के लिए QR कोड भी स्कैन कर सकते हैं।

| वीचैट ग्रुप | वीचैट आधिकारिक अकाउंट |
| ------------ | ----------------------- |
