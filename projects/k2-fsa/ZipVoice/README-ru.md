...
```
### 4. (Необязательно) Установите k2 для обучения или эффективного вывода
...
```
Пожалуйста, обратитесь к https://k2-fsa.org/get-started/k2/ для получения подробной информации.
Пользователи из материкового Китая могут обратиться к https://k2-fsa.org/zh-CN/get-started/k2/.

## Использование

### 1. Генерация речи одного говорящего

Чтобы сгенерировать речь одного говорящего с помощью наших предварительно обученных моделей ZipVoice или ZipVoice-Distill, используйте следующие команды (необходимые модели будут загружены с HuggingFace):
...
### 2. Генерация устного диалога

#### 2.1 Команда для инференса

Чтобы сгенерировать двусторонние устные диалоги с помощью наших предварительно обученных моделей ZipVoice-Dialogue или ZipVoice-Dialogue-Stereo, используйте следующие команды (необходимые модели будут загружены с HuggingFace):
...
#### 3.1 Исправление неправильного произношения китайских многозначных иероглифов
...
Чтобы вручную исправить эти ошибки, заключите **исправленный пиньинь** в угловые скобки `< >` и добавьте **тон**.
...
> **Примечание:** Если вы хотите вручную указать несколько вариантов пиньиня, заключайте каждый в `<>`, например, `这把<jian4><chang2><san1>十公分`

## Обучение собственной модели

Смотрите директорию [egs](egs) для примеров обучения и дообучения.

## Обсуждение и коммуникация

Вы можете обсуждать напрямую на [Github Issues](https://github.com/k2-fsa/ZipVoice/issues).

Также вы можете отсканировать QR-код для вступления в нашу группу в WeChat или подписаться на наш официальный аккаунт WeChat.
