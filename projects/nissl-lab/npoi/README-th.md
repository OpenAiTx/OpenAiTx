...
<br />
โปรเจกต์นี้เป็นเวอร์ชัน .NET ของโปรเจกต์ Apache POI ด้วย NPOI คุณสามารถอ่าน/เขียนไฟล์ Office 2003/2007 ได้อย่างง่ายดาย<br />

Donation 
=========
หากคุณได้รับประโยชน์จาก NPOI กรุณา [สนับสนุนฉันผ่าน Github Sponsor](https://github.com/sponsors/tonyqus) หรือ [บริจาคให้โปรเจกต์นี้](https://github.com/nissl-lab/npoi/discussions/923) ขอบคุณ!
...
[ตัวอย่างโค้ด NPOI (repo ตัวอย่างนี้เป็นส่วนตัว คุณสามารถเข้าถึงได้โดยการสนับสนุนฉัน)](https://github.com/sponsors/tonyqus)

Advantage of NPOI
=================
a. ฟรีทั้งหมดในการใช้งาน

b. ครอบคลุมฟีเจอร์ส่วนใหญ่ของ Excel (รูปแบบเซลล์, รูปแบบข้อมูล, สูตร และอื่น ๆ)

c. รูปแบบไฟล์ที่รองรับ: xls, xlsx, docx

d. ออกแบบให้ใช้งานแบบเน้นอินเทอร์เฟซ (ดูที่ namespace NPOI.SS)

e. รองรับทั้งการส่งออกและนำเข้า

f. มีกรณีศึกษาความสำเร็จจริงทั่วโลก

g. ทำงานได้ทั้งบน Windows และ Linux 
