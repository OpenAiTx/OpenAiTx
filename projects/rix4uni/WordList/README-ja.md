...
- 上位50件まで => `*-small.txt`
- 上位500件まで => `*-medium.txt`
- 制限なし全ペイロード => `*-large.txt` 、50MBを超える場合は `*-large-1.txt`、`*-large-2.txt`

## テクノロジー
- 制限なし全テクノロジー => `techname/techname.txt`、50MBを超える場合は `techname/techname-1.txt`、`techname/techname-2.txt`
