...
## Payloads
- bis zu Top 50 => `*-small.txt`
- bis zu Top 500 => `*-medium.txt`
- alle Payloads ohne Limit => `*-large.txt`, falls größer als 50 MB dann `*-large-1.txt`, `*-large-2.txt`

## Technologien
- alle Technologien ohne Limit => `techname/techname.txt`, falls größer als 50 MB dann `techname/techname-1.txt`, `techname/techname-2.txt`

## nuclei-Technologien
Verwendung von: [nuclei-wordlist-generator.go](https://github.com/rix4uni/WordList/blob/main/wordlist-generator-tools/nuclei-wordlist-generator.go)
