...
Ten projekt bazuje na [index-tts](https://github.com/index-tts/index-tts) z Bilibili i oferuje rozwiązania **strojenia LoRA** dla konfiguracji **jedno- i wielomówcowych**. Celem jest poprawa **prozodii i naturalności** w wysokiej jakości syntezie głosu lektora.

### Trening i wnioskowanie

#### 1. Ekstrakcja tokena audio i warunku mówcy
...
Zbiór danych został podzielony na **244 próbki treningowe** i **26 próbek walidacyjnych**.
Uwaga: Transkrypcje zostały wygenerowane automatycznie za pomocą modeli ASR i interpunkcji, bez ręcznej korekty, więc można się spodziewać pewnych błędów.
