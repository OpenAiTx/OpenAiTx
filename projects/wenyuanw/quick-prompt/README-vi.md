...
### Cài đặt tiện ích đã được xây dựng
...
2. Nhấp vào "Firefox này"
3. Nhấp vào "Tải tạm thời tiện ích bổ sung"
...
2. Tạo nhánh chức năng của bạn (`git checkout -b feature/amazing-feature`)
