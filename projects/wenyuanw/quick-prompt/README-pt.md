...
### Instalando a extensão já compilada
...
4. Selecione o arquivo `manifest.json` dentro do diretório `.output/firefox-mv2/` do projeto
...
3. Faça o commit de suas alterações (`git commit -m 'Add some amazing feature'`)
