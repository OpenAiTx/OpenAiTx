...
A collection of automated items including spells, class features, monster features, etc., mechanics to make those possible, and quality-of-life based extensions for a high-automation Midi-QOL based D&D5e environment. Compendiums included in this module do not include item descriptions. While this module has several dependencies from different authors, do not pester tposney, Wasp, or any other module authors with bugs or issues related to this module. Bug reports and major module implementation requests may be made on GitHub. Faster support and feature requests can be accessed on the [Discord server](https://discord.gg/BumxBcQDrT).
...
- Various optional quality-of-life user-interface extensions.
