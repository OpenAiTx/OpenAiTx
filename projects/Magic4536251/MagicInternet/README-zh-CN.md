...
- **节点地区：香港、台湾、日本、美国、新加坡、韩国、越南、马来西亚、土耳其、菲律宾、阿根廷、俄罗斯节点**
- **节点个数：27+**
- **推荐指数：★★★★**
- ✅ 解锁流媒体、解锁ChatGPT
...
| 流量（单位：Gb） | 价格（单位：RMB） | 速率（单位：Mbps） | 设备支持在线个数 |
| ---------------- | :---------------- | ------------------ | ---------------- |
| 100G             | 8.80元 / 月       | 不限速             | 不限制           |
| 300G             | 25.80元 / 月      | 不限速             | 不限制           |
| 500G             | 39.80元 / 月      | 不限速             | 不限制           |
| 1024G            | 78.80元 / 月      | 不限速             | 不限制           |
...
> 描述：中转/iepl综合机场，最低6元/50G，机场有很多低倍节点，可免费试用，适合轻量用户。
...
| 流量（单位：Gb） | 价格（单位：人民币） | 速率（单位：Mbps） | 设备支持在线个数 |
| ---------------- | ----------------- | ------------------ | ---------------- |
| 50G              | 6.00元 / 月       | 不限速             | 不限             |
| 100G             | 12.00元 / 月      | 不限速             | 不限             |
| 200G             | 22.00元 / 月      | 不限速             | 不限             |
| 500G             | 55.00元 / 月      | 不限速             | 不限             |
