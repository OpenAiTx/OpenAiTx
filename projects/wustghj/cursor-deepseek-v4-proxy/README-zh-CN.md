...
> **Only requirement**: Install **Python 3.8** or higher (make sure to check `Add Python to PATH` during installation).
...
1.  Download the ZIP package of this project repository and extract it locally (**avoid Chinese characters in the path**).
2.  Enter the extracted folder, type `cmd` in the folder address bar and press Enter to open the command prompt window.
