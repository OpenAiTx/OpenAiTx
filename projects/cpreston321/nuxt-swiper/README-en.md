...
> [!IMPORTANT]
> ***Nuxt Swiper*** uses Swiper.js as its base via its web components. Please make sure to read the Swiper.js [documentation](https://swiperjs.com/element) before using this module and reporting any issues not directly related to Nuxt Swiper. If there is a fundamental bug, please file an issue in the Swiper.js [repository](https://github.com/nolimits4web/swiper/issues).
...
**X** (formerly known as Twitter) - [@christian_ggg](https://x.com/christian_ggg)
