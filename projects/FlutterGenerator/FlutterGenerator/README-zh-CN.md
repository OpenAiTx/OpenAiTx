...
1. 从 [GitHub Releases](https://gist.github.com/7b65cb208155a30d43bfda55568843c7.git) 下载并安装 PY（fwGeneratorOld.py）
2. 下载 Termux 并运行 fwGenerator.py，复制该文件并以该名称上传到你的 GitHub。
```
.github/workflows
```
