...
```
# ویدئوی آموزشی
[![مشاهده در یوتیوب](https://img.youtube.com/vi/oT6yT8LP1yY/0.jpg)](https://www.youtube.com/watch?v=oT6yT8LP1yY)

# [Flutter-SO-Build](https://github.com/FlutterGenerator/Flutter-SO-Build)

# اطلاعات

**🚀 نسخه دارت: 𒁍 2.7.0-dev.2.1 ➢ 3.12.2**

**🚀 نسخه فلاتر: 𒁍 v1.12.13+hotfix.5 ➢ 3.44.2**

یافتن نسخه دارت
-------
**یافتن نسخه پایدار در `libflutter.so` : `استفاده از ویرایشگر متن MT Manager`**
