...
1. Descargue e instale el archivo PY (fwGeneratorOld.py) desde [GitHub Releases](https://gist.github.com/7b65cb208155a30d43bfda55568843c7.git)
2. Descargue Termux, ejecute fwGenerator.py y copie el archivo y súbalo a su GitHub con el nombre.
```
.github/workflows
```
...
**🚀 Versión de Dart: 𒁍 2.7.0-dev.2.1 ➢ 3.12.2**

**🚀 Versión de Flutter: 𒁍 v1.12.13+hotfix.5 ➢ 3.44.2**

Encontrar la versión de Dart
-------
**Encontrar versión estable en `libflutter.so` : `Usar MT Manager Editor de Texto`**
