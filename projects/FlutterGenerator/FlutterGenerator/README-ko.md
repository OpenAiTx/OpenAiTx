...
1. [GitHub Releases](https://github.com/FlutterGenerator/FlutterGenerator/releases)에서 PY(fwGenerator.py)를 다운로드하고 설치합니다.
2. Termux를 다운로드하고 fwGenerator.py를 실행한 후 파일을 복사하여 이름과 함께 GitHub에 업로드합니다.
```
.github/workflows
```
