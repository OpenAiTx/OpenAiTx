...
```
# 튜토리얼 비디오
[![Youtube에서 재생](https://img.youtube.com/vi/oT6yT8LP1yY/0.jpg)](https://www.youtube.com/watch?v=oT6yT8LP1yY)

# [Flutter-SO-Build](https://github.com/FlutterGenerator/Flutter-SO-Build)

# 정보

**🚀 Dart 버전: 𒁍 2.7.0-dev.2.1 ➢ 3.12.2**

**🚀 Flutter 버전: 𒁍 v1.12.13+hotfix.5 ➢ 3.44.2**

Dart 버전 찾기
-------
**`libflutter.so`에서 Stable 버전 찾기 : `MT Manager 텍스트 에디터 사용`**
