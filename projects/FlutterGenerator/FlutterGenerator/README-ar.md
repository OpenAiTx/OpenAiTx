...
1. قم بتنزيل وتثبيت ملف PY (fwGeneratorOld.py) من [إصدارات GitHub](https://gist.github.com/7b65cb208155a30d43bfda55568843c7.git)
2. قم بتنزيل تطبيق Termux وتشغيل fwGenerator.py ونسخ الملف ثم رفعه إلى حسابك على GitHub بالاسم المطلوب.
```
.github/workflows
```
# Flutter YML القديم 32بت 64بت
```
...
```
# فيديو تعليمي
[![المشاهدة على يوتيوب](https://img.youtube.com/vi/oT6yT8LP1yY/0.jpg)](https://www.youtube.com/watch?v=oT6yT8LP1yY)

# [Flutter-SO-Build](https://github.com/FlutterGenerator/Flutter-SO-Build)

# معلومات

**🚀 إصدار Dart: 𒁍 2.7.0-dev.2.1 ➢ 3.12.2**

**🚀 إصدار Flutter: 𒁍 v1.12.13+hotfix.5 ➢ 3.44.2**

إيجاد إصدار Dart
-------
**إيجاد الإصدار المستقر في `libflutter.so` : `استخدم محرر نصوص MT Manager`**
