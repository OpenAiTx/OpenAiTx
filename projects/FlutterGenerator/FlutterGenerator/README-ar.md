...
```
# فيديو تعليمي
[![شاهد على يوتيوب](https://img.youtube.com/vi/oT6yT8LP1yY/0.jpg)](https://www.youtube.com/watch?v=oT6yT8LP1yY)

# [Flutter-SO-Build](https://github.com/FlutterGenerator/Flutter-SO-Build)

# معلومات

**🚀 إصدار دارت: 𒁍 2.7.0-dev.2.1 ➢ 3.10.7**

**🚀 إصدار فلاتر: 𒁍 v1.12.13+hotfix.5 ➢ 3.38.6**
