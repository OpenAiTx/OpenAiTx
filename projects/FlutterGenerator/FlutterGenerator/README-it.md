...
# Installazione di FlutterGenerator

1. Scarica e installa il file PY (fwGeneratorOld.py) da [GitHub Releases](https://gist.github.com/7b65cb208155a30d43bfda55568843c7.git)
2. Scarica Termux ed esegui fwGenerator.py, copia il file e caricalo su GitHub con il nome.
```
.github/workflows
```
# Flutter YML Vecchio 32bit 64bit
```
...
version code
```
# Archivio|Codice versione Flutter
```
...
```
# Video Tutorial
[![Guarda su Youtube](https://img.youtube.com/vi/oT6yT8LP1yY/0.jpg)](https://www.youtube.com/watch?v=oT6yT8LP1yY)

# [Flutter-SO-Build](https://github.com/FlutterGenerator/Flutter-SO-Build)

# Info

**🚀 Versione Dart: 𒁍 2.7.0-dev.2.1 ➢ 3.12.2**

**🚀 Versione Flutter: 𒁍 v1.12.13+hotfix.5 ➢ 3.44.2**

Trova la Versione di Dart
-------
**Trova la Versione Stabile in `libflutter.so` : `Usa MT Manager Text Editor`**
