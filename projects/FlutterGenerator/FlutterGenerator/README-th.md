...
2. ดาวน์โหลด Termux แล้วรัน fwGenerator.py จากนั้นคัดลอกไฟล์และอัปโหลดไปยัง GitHub ของคุณโดยใช้ชื่อที่ต้องการ
```
.github/workflows
```
...
**🚀 เวอร์ชัน Dart: 𒁍 2.7.0-dev.2.1 ➢ 3.11.0**

**🚀 เวอร์ชัน Flutter: 𒁍 v1.12.13+hotfix.5 ➢ 3.41.0**
