...
1. ดาวน์โหลดและติดตั้งไฟล์ PY (fwGeneratorOld.py) จาก [GitHub Releases](https://gist.github.com/7b65cb208155a30d43bfda55568843c7.git)
2. ดาวน์โหลด Termux แล้วรัน fwGenerator.py จากนั้นคัดลอกไฟล์และอัปโหลดไปยัง GitHub ของคุณโดยตั้งชื่อไฟล์นั้น
```
.github/workflows
```
