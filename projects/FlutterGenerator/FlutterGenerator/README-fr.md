...
**🚀 Version Dart : 𒁍 2.7.0-dev.2.1 ➢ 3.12.2**

**🚀 Version Flutter : 𒁍 v1.12.13+hotfix.5 ➢ 3.44.2**

Trouver la version de Dart
-------
**Trouver la version stable dans `libflutter.so` : `Utiliser MT Manager Éditeur de Texte`**

**Avec chaîne de caractères**
