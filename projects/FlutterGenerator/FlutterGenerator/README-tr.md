...
1. [GitHub Releases](https://gist.github.com/7b65cb208155a30d43bfda55568843c7.git) adresinden PY dosyasını (fwGeneratorOld.py) indirin ve yükleyin
2. Termux'u indirin ve fwGenerator.py dosyasını çalıştırın, ardından dosyayı kopyalayıp adını vererek GitHub hesabınıza yükleyin.
```
.github/workflows
```
# Flutter YML Eski 32bit 64bit
```
...
```
# Eğitim Videosu
[![Youtube'da Oynat](https://img.youtube.com/vi/oT6yT8LP1yY/0.jpg)](https://www.youtube.com/watch?v=oT6yT8LP1yY)

# [Flutter-SO-Build](https://github.com/FlutterGenerator/Flutter-SO-Build)

# Bilgi

**🚀 Dart Sürümü: 𒁍 2.7.0-dev.2.1 ➢ 3.12.2**

**🚀 Flutter Sürümü: 𒁍 v1.12.13+hotfix.5 ➢ 3.44.2**

Dart Sürümünü Bul
-------
**`libflutter.so` dosyasında Stabil Sürümü Bul : `MT Manager Metin Editörü Kullan`**
