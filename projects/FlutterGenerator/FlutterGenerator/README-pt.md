...
1. Baixe e instale o PY (fwGeneratorOld.py) a partir dos [GitHub Releases](https://gist.github.com/7b65cb208155a30d43bfda55568843c7.git)
2. Baixe o Termux, execute fwGenerator.py, copie o arquivo e faça o upload dele para o seu GitHub com o nome.
```
.github/workflows
```
...
```
# Vídeo Tutorial
[![Reproduzir no Youtube](https://img.youtube.com/vi/oT6yT8LP1yY/0.jpg)](https://www.youtube.com/watch?v=oT6yT8LP1yY)

# [Flutter-SO-Build](https://github.com/FlutterGenerator/Flutter-SO-Build)

# Informações

**🚀 Versão do Dart: 𒁍 2.7.0-dev.2.1 ➢ 3.12.2**

**🚀 Versão do Flutter: 𒁍 v1.12.13+hotfix.5 ➢ 3.44.2**

Encontrar a Versão do Dart
-------
**Encontrar Versão Estável em `libflutter.so` : `Usar Editor de Texto do MT Manager`**
