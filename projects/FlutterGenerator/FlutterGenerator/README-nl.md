...
1. Download en installeer het PY-bestand (fwGeneratorOld.py) van [GitHub Releases](https://gist.github.com/7b65cb208155a30d43bfda55568843c7.git)
...
**🚀 Dart-versie: 𒁍 2.7.0-dev.2.1 ➢ 3.12.2**

**🚀 Flutter-versie: 𒁍 v1.12.13+hotfix.5 ➢ 3.44.2**

Dart-versie vinden
-------
**Vind stabiele versie in `libflutter.so` : `Gebruik MT Manager Teksteditor`**
