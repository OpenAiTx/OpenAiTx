...
1. [GitHub Releases](https://gist.github.com/7b65cb208155a30d43bfda55568843c7.git) से PY (fwGeneratorOld.py) डाउनलोड करें और इंस्टॉल करें
2. Termux डाउनलोड करें और fwGenerator.py चलाएँ तथा फाइल को कॉपी करके उसे अपने GitHub में नाम सहित अपलोड करें.
```
.github/workflows
```
