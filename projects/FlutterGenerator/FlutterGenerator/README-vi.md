...
1. Tải xuống và cài đặt file PY (fwGeneratorOld.py) từ [GitHub Releases](https://gist.github.com/7b65cb208155a30d43bfda55568843c7.git)
2. Tải Termux và chạy fwGenerator.py rồi sao chép file và tải lên GitHub của bạn với tên đó.
```
.github/workflows
```
# Flutter YML Cũ 32bit 64bit
```
...
version code
```
# Lưu trữ|Mã phiên bản Flutter
```
https://docs.flutter.dev/release/archive
```
# Các lệnh trên Termux
```
...
**🚀 Phiên bản Dart: 𒁍 2.7.0-dev.2.1 ➢ 3.12.2**

**🚀 Phiên bản Flutter: 𒁍 v1.12.13+hotfix.5 ➢ 3.44.2**

Tìm Phiên Bản Dart
-------
**Tìm Phiên Bản Ổn Định trong `libflutter.so` : `Sử dụng MT Manager Text Editor`**
