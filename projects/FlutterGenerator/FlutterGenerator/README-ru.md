...
# Установка FlutterGenerator

1. Скачайте и установите PY (fwGeneratorOld.py) с [GitHub Releases](https://gist.github.com/7b65cb208155a30d43bfda55568843c7.git)
2. Скачайте Termux, запустите fwGenerator.py, скопируйте файл и загрузите его на свой GitHub под этим именем.
```
.github/workflows
```
# Flutter YML Старый 32-битный 64-битный
```
...
```
# Видеоурок
[![Смотреть на Youtube](https://img.youtube.com/vi/oT6yT8LP1yY/0.jpg)](https://www.youtube.com/watch?v=oT6yT8LP1yY)

# [Flutter-SO-Build](https://github.com/FlutterGenerator/Flutter-SO-Build)

# Информация

**🚀 Версия Dart: 𒁍 2.7.0-dev.2.1 ➢ 3.12.2**

**🚀 Версия Flutter: 𒁍 v1.12.13+hotfix.5 ➢ 3.44.2**

Поиск версии Dart
-------
**Поиск стабильной версии в `libflutter.so` : `Используйте текстовый редактор MT Manager`**
