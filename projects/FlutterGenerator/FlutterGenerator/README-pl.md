...
# Instalacja FlutterGenerator

1. Pobierz i zainstaluj plik PY (fwGeneratorOld.py) z [GitHub Releases](https://gist.github.com/7b65cb208155a30d43bfda55568843c7.git)
2. Pobierz Termux, uruchom fwGenerator.py, skopiuj plik i prześlij go na swój GitHub pod wybraną nazwą.
```
.github/workflows
```
# Flutter YML Stary 32bit 64bit
```
...
```
# Samouczek wideo
[![Odtwórz na Youtube](https://img.youtube.com/vi/oT6yT8LP1yY/0.jpg)](https://www.youtube.com/watch?v=oT6yT8LP1yY)

# [Flutter-SO-Build](https://github.com/FlutterGenerator/Flutter-SO-Build)

# Informacje

**🚀 Wersja Dart: 𒁍 2.7.0-dev.2.1 ➢ 3.12.2**

**🚀 Wersja Flutter: 𒁍 v1.12.13+hotfix.5 ➢ 3.44.2**

Znajdź wersję Dart
-------
**Znajdź stabilną wersję w `libflutter.so` : `Użyj MT Manager Text Editor`**
