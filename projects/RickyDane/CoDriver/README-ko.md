...
<p align="center">
  <a href='https://ko-fi.com/rickydane'>
      <img height='36px' style='border: 0px; height: 36px;' src='https://storage.ko-fi.com/cdn/kofi2.png?v=3' border='0' alt='ko-fi.com에서 커피 한 잔 사주세요' />
  </a>
</p>
...
<p align="center">
  러스트 언어를 배우고 싶어서 만든 간단한 파일 탐색기입니다.
  <br>
  운영체제에 독립적이며 최적화를 위해 다듬어졌습니다.
</p>

<br/><br/>

성능은 ["jwalk"](https://crates.io/crates/jwalk/versions) 및 ["Tauri"](https://tauri.app/)를 통해 달성됩니다.
<br/><br/>
CoDriver는 파일 및 폴더 접근 시 경로 캐싱을 사용하지 않으며, 성능은 Rust와 디스크 속도, 그리고 CPU 성능에 의해 결정됩니다.
...
- <a href="#dependencies-if-not-working-instantly">필수 의존성</a>
- <a href="#-ftp-sftp-integration">FTP / SFTP 통합</a>
- <a href="#-known-issues">알려진 문제</a>
- <a href="#-todos">할 일</a>
