...
- विंडोज़ पर आपको [Microsoft Visual C++ Redistributable](https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170) इंस्टॉल करनी पड़ सकती है
...
## योगदान कैसे करें
अपने सिस्टम पर tauri v1 एप्लिकेशन विकसित करने के लिए सेटअप करें: [Tauri आवश्यकताएँ](https://tauri.app/v1/guides/getting-started/prerequisites)
</br></br>
एक बार यह हो जाने के बाद बस ```git clone https://github.com/RickyDane/CoDriver``` या ```gh repo clone RickyDane/CoDriver``` अपने सिस्टम पर किसी स्थान पर करें।
</br></br>
...
macOS रिलीज आर्टिफैक्ट्स को साइन और नोटराइज़ किया जाना चाहिए ताकि Gatekeeper यह न बताए कि इंस्टॉल किया गया ऐप क्षतिग्रस्त है। आवश्यक GitHub Actions सीक्रेट्स और सत्यापन कमांड्स के लिए देखें [macOS साइनिंग और नोटराइज़ेशन](https://raw.githubusercontent.com/RickyDane/CoDriver/master/docs/macos-signing-notarization.md)।
