...
<p align="center">
  एक साधारण फाइल एक्सप्लोरर जो इसलिए बनाया गया क्योंकि मैं Rust भाषा सीखना चाहता था।
  <br>
...
<br/><br/>
CoDriver फाइलों और फोल्डरों तक पहुँचने के लिए पाथ कैशिंग का उपयोग नहीं करता है, इसलिए प्रदर्शन Rust, डिस्क की गति और सीपीयू की शक्ति पर निर्भर करता है।

⁉️ ध्यान दें कि यह सॉफ़्टवेयर अभी विकासाधीन है और इसमें बग्स हो सकते हैं!
<br/><br/>

# लिंक
- <a href="#basic-features">मूलभूत विशेषताएँ</a>
- <a href="#advanced-features">उन्नत विशेषताएँ</a>
- <a href="#dependencies-if-not-working-instantly">निर्भरता</a>
- <a href="#-ftp-sftp-integration">FTP / SFTP एकीकरण</a>
- <a href="#-known-issues">ज्ञात समस्याएँ</a>
