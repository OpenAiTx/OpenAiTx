...
<p align="center">
  <a href='https://ko-fi.com/rickydane'>
      <img height='36px' style='border: 0px; height: 36px;' src='https://storage.ko-fi.com/cdn/kofi2.png?v=3' border='0' alt='ko-fi.com पर मुझे कॉफी खरीदें' />
  </a>
</p>
...
<p align="center">
  एक साधारण फाइल एक्सप्लोरर जिसे मैंने Rust भाषा सीखने के लिए बनाया।
  <br>
  यह ऑपरेटिंग सिस्टम स्वतंत्र है और अनुकूलन के लिए ट्रिम किया गया है।
</p>

<br/><br/>

प्रदर्शन ["jwalk"](https://crates.io/crates/jwalk/versions) और ["Tauri"](https://tauri.app/) द्वारा प्राप्त किया गया है।
<br/><br/>
CoDriver फाइलों और फोल्डरों तक पहुंचने के लिए पथ कैशिंग का उपयोग नहीं करता है, इसलिए प्रदर्शन Rust, डिस्क की गति और सीपीयू की शक्ति पर निर्भर करता है।

⁉️ ध्यान दें कि यह सॉफ़्टवेयर अभी विकासाधीन है और इसमें बग हो सकते हैं!
<br/><br/>

# लिंक
- <a href="#basic-features">मूल विशेषताएँ</a>
- <a href="#advanced-features">उन्नत विशेषताएँ</a>
- <a href="#dependencies-if-not-working-instantly">निर्भरता</a>
- <a href="#%EF%B8%8F-ftp-sftp-integration">FTP / SFTP एकीकरण</a>
...
CoDriver पूरी तरह से मूल, आउट-ऑफ-द-बॉक्स FTP और SFTP रिमोट कनेक्शन का समर्थन करता है। किसी बाहरी निर्भरता, FUSE लेयर या `sshfs` माउंट की आवश्यकता नहीं है! बस अपने रिमोट सर्वर को साइडबार पैनल में सीधे कनेक्ट करें।

## 🏴‍☠️ भाषा समर्थन
- अंग्रेज़ी
  - जल्द ही भाषा चुनने का विकल्प उपलब्ध होगा ...

## ⚠️ ज्ञात समस्याएँ:
- विंडो से बाहर ड्रैग एंड ड्रॉप वर्तमान में लिनक्स पर हमेशा काम नहीं करता है
...
- ms-windows पर अनुमतियाँ थोड़ी अजीब हैं
  - यदि आपको एलिमेंट्स कॉपी करने या इसी तरह की समस्या आती है तो आपको प्रोग्राम को एडमिनिस्ट्रेटर के रूप में चलाना पड़ सकता है
- लिनक्स सिस्टम पर प्रोग्राम शुरू नहीं होने पर openssl1.1 इंस्टॉल करने की आवश्यकता हो सकती है
...
## योगदान कैसे करें
tauri v1 एप्लिकेशन के लिए अपनी मशीन सेटअप करें: [Tauri prerequisites](https://tauri.app/v1/guides/getting-started/prerequisites)
</br></br>
जब यह हो जाए तो बस अपनी मशीन पर ```git clone https://github.com/RickyDane/CoDriver``` या ```gh repo clone RickyDane/CoDriver``` किसी स्थान पर करें।
</br></br>
आपको इस प्रोजेक्ट की रूट डायरेक्टरी में ```cargo tauri dev``` चलाने में सक्षम होना चाहिए, जिससे CoDriver का निर्माण और चलना शुरू हो जाएगा।
</br>
सुनिश्चित करें कि tauri-cli इंस्टॉल हो: ```cargo install tauri-cli```
</br>

## रिलीज़ साइनिंग

macOS रिलीज़ आर्टीफैक्ट्स को साइन और नोटराइज़ करना आवश्यक है ताकि Gatekeeper इंस्टॉल किए गए ऐप को डैमेज्ड न बताए। आवश्यक GitHub Actions सीक्रेट्स और सत्यापन कमांड के लिए [macOS साइनिंग और नोटराइज़ेशन](https://raw.githubusercontent.com/RickyDane/CoDriver/master/docs/macos-signing-notarization.md) देखें।
