...
<p align="center">
  Rust言語を学びたくて作ったシンプルなファイルエクスプローラーです。
  <br>
  OSに依存せず、最適化のために軽量化されています。
</p>
...
<br/><br/>
CoDriverはファイルやフォルダへのアクセス時にパスキャッシュを使用していません。そのため、Rustの性能、ディスクの速度、CPUのパワーによってパフォーマンスが決まります。

⁉️ このソフトウェアはまだ開発中であり、不具合が含まれている可能性がありますのでご注意ください！
<br/><br/>
...
- <a href="#-ftp-sftp-integration">FTP / SFTP統合</a>
