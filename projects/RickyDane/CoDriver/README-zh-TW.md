...
本程式的效能來自於 ["jwalk"](https://crates.io/crates/jwalk/versions) 以及 ["Tauri"](https://tauri.app/)。
<br/><br/>
CoDriver 不使用路徑快取來存取檔案和資料夾，因此效能取決於 Rust、本機磁碟速度和 CPU 的運算能力。
...
- <a href="#-ftp-sftp-integration">FTP / SFTP 整合</a>
- <a href="#-known-issues">已知問題</a>
- <a href="#-todos">待辦事項</a>
