...
Bring powerful UI testing capabilities for Helm chart with minimal configuration just within the `values.yaml` file.
...
For more examples, see [example/app1](https://raw.githubusercontent.com/jlandowner/helm-chartsnap/main/example/app1).
...
For more examples, see [example/remote](https://raw.githubusercontent.com/jlandowner/helm-chartsnap/main/example/remote).

## Showcase & Users ✨

| Users / Projects | Description | URL |
|:---|:---|:---|
| Example | Example chart generated by `helm create` command | [`example/app1`](https://raw.githubusercontent.com/jlandowner/helm-chartsnap/main/example/app1) |
| Example | Example of snapshotting charts in remote Helm repositories | [`example/remote`](https://raw.githubusercontent.com/jlandowner/helm-chartsnap/main/example/remote) |
