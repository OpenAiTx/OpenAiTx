...
请勿在公共场所发布任何AADisplay教程相关的视频和图片，否则我将在中国以外地区停止更新。

让Android Auto显示任意应用，基于VirtualDisplay的套娃方案，Star! Star! Star!

仅支持A12+，需LSPosed，部分ROM可能存在崩溃的可能性，请自备救机常识。

理论上支持到A10+，由于没有设备和过多精力维护，所以没有支持，如有能力请自行PR。

与本项目无关的问题请勿提交Issue，必关！例如：Magisk/LSPosed环境安装，AA无法连接/使用等相关问题。
