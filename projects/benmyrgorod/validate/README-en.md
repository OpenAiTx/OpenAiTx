...
1. Use `go get` to download validate package.
   ...
   ```
2. Import the validate package into your project.
   ```go
...
This project has been written by Ben Myrgorod before Vibe Coding tools existed. Inspired by [go-playground/validator](https://github.com/go-playground/validator).
