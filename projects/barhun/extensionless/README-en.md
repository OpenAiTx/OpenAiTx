...
Note: If the `node` version is lower than `20.6.0`, this won't work and requires this flag instead:
...
This loader also adds support for Windows path resolution, allowing you to use either forward or backward slashes as separators.
