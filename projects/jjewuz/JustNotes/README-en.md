...
JustNotes is a simple Android app for taking notes, like there have been tens of thousands before. The app uses the Room database.

This repository is archived because the next updates will be commercial.
...
## App errors
If you face some app issues, you can report them on the GitHub issues page. Do not forget to write the name of your device, Android version, app build number, app version, and steps on how to reproduce the error.
