...
The library has everything inside its header, just include that and then use the `ESP32Can` object to send or receive `CanFrame`.


Here is a simple example of how to query and receive OBD2 PID frames:
```cpp
...
# Advanced
You can also set up your own masks and configurations:
