...
Biblioteca de controlador ESP32 para TWAI / CAN para Arduino usando controladores ESP-IDF.

Probado en ESP32 y ESP32-S3.

# Uso

La biblioteca tiene todo dentro de su encabezado, solo inclúyelo y luego usa el objeto `ESP32Can` para enviar o recibir `CanFrame`.


Aquí hay un ejemplo sencillo de cómo consultar y recibir tramas PID OBD2:
```cpp
...
# Avanzado
También puedes configurar tus propias máscaras y configuraciones:
...
```
Siga `soc/twai_types.h` para más información:
