...
# ريأكت نيتيف BTR
مكونات واجهة المستخدم لـ React Native :fire: :rocket: :star2:

![npm](https://img.shields.io/npm/v/react-native-btr) ![ترخيص MIT](https://img.shields.io/badge/license-MIT-brightgreen.svg)
...
## العرض التوضيحي
[![متجر Google Play](https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png?w=10)](https://play.google.com/store/apps/details?id=com.thakurballary.reactnativebtrdemo)
...
## الترخيص
[مرخصة بموجب MIT](https://github.com/ThakurBallary/react-native-btr/blob/master/LICENSE)
