...
# AnymeX: 다중 서비스 트래킹 클라이언트

**AnymeX**는 [**AniList**](https://anilist.co/), [**MyAnimeList**](https://myanimelist.net/), [**Simkl**](https://simkl.com/)에서 애니메이션과 만화의 진행 상황을 관리하고 추적하기 위해 설계된 다중 서비스 트래킹 클라이언트입니다.

> [!IMPORTANT]  
> **AnymeX는 오직 트래킹 도구입니다.** 스트리밍 콘텐츠, 미디어, 또는 제3자 확장 기능을 호스팅, 제공, 배포하거나 이를 지지하지 않습니다.  
>  
> **사용자 책임:** 사용자는 앱 및 선택적으로 사용하는 제3자 서비스, 확장 기능의 사용에 대해 전적으로 책임집니다. 사용자는 모든 관련 법률, 저작권, 지적 재산권을 준수해야 합니다.  
>  
> **책임 부인:** AnymeX 개발자는 사용자 행위에서 발생하는 오용, 법적 문제, 위반 사항에 대해 모든 책임을 부인합니다. 법적 문제(예: DMCA 클레임)는 AnymeX가 아닌 해당 제3자 서비스에 문의해야 합니다. 이 앱은 "있는 그대로" 제공되며, 어떠한 보증도 하지 않습니다.  
>  
> **서비스:** AnymeX는 지원되는 서비스(AniList, MyAnimeList, Simkl)의 공식 API만 통합합니다. 제3자 확장 기능은 해당 제작자에게 책임이 있으며, AnymeX 개발자와는 무관합니다.  
>  
> **AnymeX를 사용함으로써, [이용 약관](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/./TOS.md)을 준수하는 것에 동의합니다. DMCA 준수, 트래킹 기능, AniList, MyAnimeList, Simkl을 제외한 콘텐츠 및 서비스에 대한 비관여 사항을 이해하기 위해 약관을 반드시 확인해 주십시오.**
...
### iOS 사이드로딩 소스
  <p>
    ...
    <a href="https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="직접 소스 URL" src="https://img.shields.io/badge/copy_%2F_paste-_?style=for-the-badge&label=Direct%20Source%20URL&labelColor=black&color=white"></a>
  </p>
</div>
...
| 홈                                                                                                                                           | 검색                                                                                                                                          | 상세                                                                                                                      | 라이브러리                                                                                                              |
| ---------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
|![홈 페이지에는 여러분이 읽거나 시청한 여러 섹션이 표시됩니다.](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Home-portrait.png) | ![검색 페이지에 죠죠의 기묘한 모험 검색 결과가 다수 표시됩니다.](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Search-portrait.png) | ![Re:제로부터 시작하는 이세계 생활의 상세 페이지입니다.](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Details-portrait.png) | ![라이브러리 페이지에 사용자의 시청 목록이 표시됩니다.](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Library-portrait.png) |

<!-- 스크린샷이 준비되면 다시 추가할 예정입니다.
### 💻 데스크탑
...
<a href='https://ko-fi.com/ryanyuuki7' target='_blank'><img height='36' style='border:0px;height:36px;' src='https://storage.ko-fi.com/cdn/kofi1.png?v=3' border='0' alt='ko-fi.com에서 커피 사주기' /></a>

> [!TIP]
> ⭐ **이 저장소에 스타를 눌러 개발자를 응원하고 앱 개발을 격려해주세요!**

<details>
  <summary>스타 히스토리</summary>
  <a href="https://github.com/RyanYuuki/AnymeX/stargazers">
      <img alt="스타 히스토리 차트" src="https://starchart.cc/RyanYuuki/AnymeX.svg?variant=adaptive" width="370" height="235" />
  </a>
</details>

## 공식 커뮤니티

최신 소식을 받고 토론에 참여하시려면 커뮤니티에 가입하세요:
