...
**AnymeX** — это мультисервисный клиент для отслеживания, предназначенный исключительно для управления и отслеживания прогресса аниме и манги через [**AniList**](https://anilist.co/), [**MyAnimeList**](https://myanimelist.net/) и [**Simkl**](https://simkl.com/).

> [!ВАЖНО]  
> **AnymeX — это только инструмент для отслеживания.** Он не размещает, не предоставляет, не распространяет и не поддерживает какой-либо стриминговый контент, медиа или сторонние расширения.  
>  
> **Ответственность пользователя:** Пользователи несут полную ответственность за использование приложения и сторонних сервисов или расширений, с которыми они взаимодействуют. Пользователи должны соблюдать все применимые законы, авторские права и права интеллектуальной собственности.  
>  
> **Отказ от ответственности:** Разработчики AnymeX снимают с себя всю ответственность за неправильное использование, юридические проблемы или нарушения, возникающие в результате действий пользователей. Юридические вопросы, включая претензии DMCA, должны адресоваться соответствующим сторонним сервисам, а не AnymeX. Приложение предоставляется "как есть" без гарантий.  
>  
> **Сервисы:** AnymeX интегрируется только с официальными API поддерживаемых сервисов (AniList, MyAnimeList, Simkl). Сторонние расширения являются ответственностью их создателей, а не разработчиков AnymeX.  
>  
> **Используя AnymeX, вы соглашаетесь соблюдать наши [Условия использования](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/./TOS.md). Пожалуйста, ознакомьтесь с Условиями, чтобы понять нашу DMCA-совместимую функциональность отслеживания и наше отсутствие участия в любом контенте или сервисах, кроме AniList, MyAnimeList и Simkl.**
...
<details>
  ...
  <a href="https://github.com/RyanYuuki/AnymeX/stargazers">
      <img alt="График истории звёзд" src="https://starchart.cc/RyanYuuki/AnymeX.svg?variant=adaptive" width="370" height="235" />
  </a>
</details>
