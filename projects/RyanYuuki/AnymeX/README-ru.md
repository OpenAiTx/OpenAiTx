...
**AnymeX** — это мультисервисный клиент для трекинга, предназначенный исключительно для управления и отслеживания прогресса просмотра аниме и манги на [**AniList**](https://anilist.co/), [**MyAnimeList**](https://myanimelist.net/) и [**Simkl**](https://simkl.com/).

> [!ВАЖНО]  
> **AnymeX — только инструмент для трекинга.** Он не размещает, не предоставляет, не распространяет и не поддерживает никакой стриминговый контент, медиа или сторонние расширения.  
>  
> **Ответственность пользователя:** Пользователи несут полную ответственность за использование приложения и любые сторонние сервисы или расширения, с которыми они взаимодействуют. Пользователи обязаны соблюдать все применимые законы, авторские права и права интеллектуальной собственности.  
>  
> **Отсутствие ответственности:** Разработчики AnymeX не несут ответственности за неправомерное использование, юридические проблемы или нарушения, возникающие в результате действий пользователей. Юридические вопросы, включая претензии DMCA, должны направляться соответствующим сторонним сервисам, а не в AnymeX. Приложение предоставляется «как есть» без гарантий.  
>  
> **Сервисы:** AnymeX интегрируется только с официальными API поддерживаемых сервисов (AniList, MyAnimeList, Simkl). Сторонние расширения — ответственность их авторов, а не разработчиков AnymeX.  
>  
> **Используя AnymeX, вы соглашаетесь соблюдать наши [Условия использования](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/./TOS.md). Пожалуйста, ознакомьтесь с Условиями, чтобы понять нашу DMCA-совместимую функциональность трекинга и отсутствие вовлеченности с любым контентом или сервисами вне AniList, MyAnimeList и Simkl.**
