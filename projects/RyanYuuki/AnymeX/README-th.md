...
**AnymeX** เป็นโปรแกรมติดตามหลายบริการที่ออกแบบมาโดยเฉพาะเพื่อจัดการและติดตามความคืบหน้าของอนิเมะและมังงะผ่าน [**AniList**](https://anilist.co/), [**MyAnimeList**](https://myanimelist.net/), และ [**Simkl**](https://simkl.com/)

> [!สำคัญ]  
> **AnymeX เป็นเครื่องมือสำหรับติดตามเท่านั้น** ไม่ได้โฮสต์ ให้บริการ แจกจ่าย หรือสนับสนุนเนื้อหาสตรีมมิ่ง สื่อ หรือส่วนขยายของบุคคลที่สาม  
>  
> **ความรับผิดชอบของผู้ใช้:** ผู้ใช้มีความรับผิดชอบแต่เพียงผู้เดียวในการใช้งานแอปและบริการหรือส่วนขยายของบุคคลที่สามที่เลือกใช้งาน ผู้ใช้ต้องปฏิบัติตามกฎหมาย ลิขสิทธิ์ และสิทธิ์ในทรัพย์สินทางปัญญาทั้งหมดที่เกี่ยวข้อง  
>  
> **ไม่มีความรับผิดชอบ:** นักพัฒนา AnymeX ปฏิเสธความรับผิดชอบทั้งหมดต่อการใช้งานผิดกฎหมาย ปัญหาทางกฎหมาย หรือการละเมิดที่เกิดจากการกระทำของผู้ใช้ ข้อกังวลทางกฎหมาย รวมถึงคำร้อง DMCA ต้องติดต่อไปยังบริการของบุคคลที่สาม ไม่ใช่ AnymeX แอปนี้ให้บริการ “ตามสภาพ” โดยไม่มีการรับประกันใด ๆ  
>  
> **บริการ:** AnymeX เชื่อมต่อกับ API อย่างเป็นทางการของบริการที่รองรับเท่านั้น (AniList, MyAnimeList, Simkl) ส่วนขยายของบุคคลที่สามเป็นความรับผิดชอบของผู้สร้าง ไม่ใช่นักพัฒนา AnymeX  
>  
> **การใช้ AnymeX ถือว่าคุณยอมรับ [ข้อกำหนดการให้บริการ](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/./TOS.md) ของเรา กรุณาตรวจสอบข้อกำหนดเพื่อเข้าใจการทำงานที่สอดคล้องกับ DMCA และการไม่เกี่ยวข้องกับเนื้อหาหรือบริการใด ๆ นอกจาก AniList, MyAnimeList และ Simkl**
