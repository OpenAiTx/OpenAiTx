...
**AnymeX** คือไคลเอนต์ติดตามแบบหลายบริการที่ออกแบบมาโดยเฉพาะสำหรับจัดการและติดตามความคืบหน้าของอนิเมะและมังงะผ่าน [**AniList**](https://anilist.co/), [**MyAnimeList**](https://myanimelist.net/), และ [**Simkl**](https://simkl.com/)

> [!IMPORTANT]  
> **AnymeX เป็นเพียงเครื่องมือสำหรับติดตามเท่านั้น** ไม่มีการโฮสต์, ให้บริการ, แจกจ่าย หรือสนับสนุนเนื้อหาสตรีมมิ่ง, สื่อ หรือส่วนขยายจากบุคคลที่สามใด ๆ  
>  
> **ความรับผิดชอบของผู้ใช้:** ผู้ใช้เป็นผู้รับผิดชอบแต่เพียงผู้เดียวในการใช้งานแอปและบริการหรือส่วนขยายจากบุคคลที่สามที่เลือกใช้ ผู้ใช้ต้องปฏิบัติตามกฎหมายที่เกี่ยวข้อง ลิขสิทธิ์ และสิทธิ์ในทรัพย์สินทางปัญญาทั้งหมด  
>  
> **ไม่มีความรับผิดชอบ:** นักพัฒนา AnymeX ปฏิเสธความรับผิดชอบต่อการใช้งานผิดวัตถุประสงค์ ปัญหาทางกฎหมาย หรือการละเมิดที่เกิดจากการกระทำของผู้ใช้ ข้อกังวลทางกฎหมายรวมถึงการร้องเรียน DMCA ควรติดต่อไปยังบริการของบุคคลที่สาม ไม่ใช่ AnymeX แอปนี้ให้บริการ "ตามสภาพ" โดยไม่มีการรับประกันใด ๆ  
>  
> **บริการ:** AnymeX ผสานรวมกับ API อย่างเป็นทางการของบริการที่รองรับเท่านั้น (AniList, MyAnimeList, Simkl) ส่วนขยายจากบุคคลที่สามเป็นความรับผิดชอบของผู้สร้าง ไม่ใช่นักพัฒนา AnymeX  
>  
> **โดยการใช้ AnymeX ถือว่าคุณยอมรับ [ข้อกำหนดการให้บริการ](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/./TOS.md) ของเรา โปรดอ่านข้อกำหนดฯ เพื่อเข้าใจการปฏิบัติตาม DMCA, ฟังก์ชันติดตาม และการไม่เกี่ยวข้องกับเนื้อหาหรือบริการนอกเหนือจาก AniList, MyAnimeList และ Simkl**
