...
<div align="center">
<img src="https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/assets/images/logo.png" alt='Icône AnymeX' style="border-radius: 50px; height: 150px; width: 150px;">
...
<p align="center">
  ...
  <a href="https://github.com/RyanYuuki/AnymeX/releases"><img src="https://img.shields.io/github/downloads/RyanYuuki/AnymeX/total?color=white&labelColor=black&label=Downloads&style=for-the-badge" alt="Téléchargements GitHub"></a>
</p>
<p align="center">
...
# AnymeX : Client de suivi multiservices

**AnymeX** est un client de suivi multiservices conçu exclusivement pour gérer et suivre la progression de vos animés et mangas sur [**AniList**](https://anilist.co/), [**MyAnimeList**](https://myanimelist.net/) et [**Simkl**](https://simkl.com/).

> [!IMPORTANT]  
> **AnymeX est uniquement un outil de suivi.** Il n’héberge, ne fournit, ne distribue, ni ne cautionne aucun contenu en streaming, média ou extensions tierces.  
>  
> **Responsabilité de l’utilisateur :** Les utilisateurs sont seuls responsables de l’utilisation de l’application et des services ou extensions tiers avec lesquels ils choisissent d’interagir. Ils doivent respecter toutes les lois, droits d’auteur et droits de propriété intellectuelle applicables.  
>  
> **Aucune responsabilité :** Les développeurs d’AnymeX déclinent toute responsabilité en cas de mauvaise utilisation, de problèmes juridiques ou de violations résultant des actions des utilisateurs. Les préoccupations légales, y compris les réclamations DMCA, doivent être adressées aux services tiers concernés, et non à AnymeX. L’application est fournie « telle quelle » sans garantie.  
>  
> **Services :** AnymeX s’intègre uniquement avec les API officielles des services pris en charge (AniList, MyAnimeList, Simkl). Les extensions tierces relèvent de la responsabilité de leurs créateurs, non des développeurs d’AnymeX.  
>  
> **En utilisant AnymeX, vous acceptez de respecter nos [Conditions d’Utilisation](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/./TOS.md). Veuillez lire ces conditions pour comprendre notre conformité DMCA, notre fonctionnement de suivi et notre non-implication concernant tout contenu ou service autre qu’AniList, MyAnimeList et Simkl.**

## Téléchargements

<div align="center">
  <p>
    <a href="https://github.com/RyanYuuki/AnymeX/releases/latest"><img src="https://img.shields.io/github/v/release/RyanYuuki/AnymeX?color=white&labelColor=black&display_name=tag&style=for-the-badge&label=Stable" alt="Dernière version stable"/></a>
  </p>
...
### Sources de Sideloading iOS
  <p>
    <a href="https://intradeus.github.io/http-protocol-redirector?r=altstore://source?url=https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="Source AltStore" src="https://img.shields.io/badge/open_in_app-_?style=for-the-badge&label=AltStore&labelColor=black&color=white"></a>
    <a href="https://intradeus.github.io/http-protocol-redirector?r=feather://source/https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="Source Feather" src="https://img.shields.io/badge/open_in_app-_?style=for-the-badge&label=Feather&labelColor=black&color=white"></a>
    <a href="https://intradeus.github.io/http-protocol-redirector?r=sidestore://source?url=https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="Source SideStore" src="https://img.shields.io/badge/open_in_app-_?style=for-the-badge&label=SideStore&labelColor=black&color=white"></a>
    <a href="https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="URL Source Directe" src="https://img.shields.io/badge/copy_%2F_paste-_?style=for-the-badge&label=Direct%20Source%20URL&labelColor=black&color=white"></a>
  </p>
</div>
...
| ---------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
|![La page d'accueil contenant plusieurs sections d’éléments que vous avez lus ou regardés.](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Home-portrait.png) | ![La page de recherche affichant plusieurs résultats pour JoJo’s Bizarre Adventure.](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Search-portrait.png) | ![La page de détails de Re:Zero Kara Hajimeru Isekai Seikatsu.](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Details-portrait.png) | ![La page de bibliothèque affichant la liste de visionnage de l’utilisateur.](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Library-portrait.png) |

<!-- Une fois les captures d’écran réalisées, je les ajouterai de nouveau
### 💻 Bureau
