...
<div align="center">
<img src="https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/assets/images/logo.png" alt='Icono de AnymeX' style="border-radius: 50px; height: 150px; width: 150px;">
...
<p align="center">
  ...
  <a href="https://github.com/RyanYuuki/AnymeX/releases"><img src="https://img.shields.io/github/downloads/RyanYuuki/AnymeX/total?color=white&labelColor=black&label=Downloads&style=for-the-badge" alt="Descargas en GitHub"></a>
</p>
<p align="center">
...
<!-- <a href="https://github.com/RyanYuuki/AnymeX/commits/main">
    <img src="https://img.shields.io/github/last-commit/RyanYuuki/AnymeX?color=white&labelColor=black&label=Último Commit&style=for-the-badge" alt="GitHub Último Commit">
</a> -->
<a href="https://github.com/RyanYuuki/AnymeX/stargazers">
      <img src="https://img.shields.io/github/stars/RyanYuuki/AnymeX?color=white&labelColor=black&style=for-the-badge" alt="Estrellas" /></a>
</p>
...
> [!IMPORTANTE]  
> **AnymeX es solo una herramienta de seguimiento.** No aloja, provee, distribuye ni respalda ningún contenido de streaming, medios ni extensiones de terceros.  
>  
> **Responsabilidad del Usuario:** Los usuarios son los únicos responsables de cómo utilizan la aplicación y los servicios o extensiones de terceros con los que decidan interactuar. Los usuarios deben cumplir con todas las leyes aplicables, derechos de autor y de propiedad intelectual.  
>  
> **Sin Responsabilidad:** Los desarrolladores de AnymeX rechazan toda responsabilidad por mal uso, problemas legales o violaciones derivadas de las acciones del usuario. Las preocupaciones legales, incluidas reclamaciones DMCA, deben dirigirse a los servicios de terceros correspondientes, no a AnymeX. La aplicación se proporciona "tal cual" sin garantías.  
>  
> **Servicios:** AnymeX se integra solo con las APIs oficiales de los servicios compatibles (AniList, MyAnimeList, Simkl). Las extensiones de terceros son responsabilidad de sus creadores, no de los desarrolladores de AnymeX.  
>  
> **Al usar AnymeX, aceptas cumplir con nuestros [Términos de Servicio](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/./TOS.md). Por favor, revisa los ToS para entender nuestra funcionalidad de seguimiento compatible con DMCA y nuestra no participación con contenido o servicios más allá de AniList, MyAnimeList y Simkl.**

## Descargas

<div align="center">
  <p>
    <a href="https://github.com/RyanYuuki/AnymeX/releases/latest"><img src="https://img.shields.io/github/v/release/RyanYuuki/AnymeX?color=white&labelColor=black&display_name=tag&style=for-the-badge&label=Estable" alt="Última Versión Estable"/></a> <a href="https://github.com/Shebyyy/AnymeX/releases/latest"><img src="https://img.shields.io/github/v/release/Shebyyy/AnymeX?color=white&labelColor=black&display_name=tag&style=for-the-badge&label=Beta" alt="Última Versión Beta"/></a>
  </p>
...
### Fuentes de Sideloading para iOS
  <p>
    <a href="https://intradeus.github.io/http-protocol-redirector?r=altstore://source?url=https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="Fuente AltStore" src="https://img.shields.io/badge/open_in_app-_?style=for-the-badge&label=AltStore&labelColor=black&color=white"></a>
    <a href="https://intradeus.github.io/http-protocol-redirector?r=feather://source/https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="Fuente Feather" src="https://img.shields.io/badge/open_in_app-_?style=for-the-badge&label=Feather&labelColor=black&color=white"></a>
    <a href="https://intradeus.github.io/http-protocol-redirector?r=sidestore://source?url=https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="Fuente SideStore" src="https://img.shields.io/badge/open_in_app-_?style=for-the-badge&label=SideStore&labelColor=black&color=white"></a>
    <a href="https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="URL Directa de la Fuente" src="https://img.shields.io/badge/copy_%2F_paste-_?style=for-the-badge&label=Direct%20Source%20URL&labelColor=black&color=white"></a>
  </p>
</div>

<!--## Capturas de pantalla

| Inicio                                                                                                                                           | Buscar                                                                                                                                          | Detalles                                                                                                                      | Biblioteca                                                                                                              |
| ---------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
|![La página principal contiene varias secciones de cosas que has leído o visto.](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Home-portrait.png) | ![La página de búsqueda muestra varios resultados para JoJo’s Bizarre Adventure.](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Search-portrait.png) | ![La página de detalles de Re:Zero Kara Hajimeru Isekai Seikatsu.](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Details-portrait.png) | ![La página de biblioteca muestra la lista de seguimiento del usuario.](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Library-portrait.png) |

<!-- Una vez que tenga las capturas de pantalla, las agregaré nuevamente
### 💻 Escritorio
...
<a href='https://ko-fi.com/ryanyuuki7' target='_blank'><img height='36' style='border:0px;height:36px;' src='https://storage.ko-fi.com/cdn/kofi1.png?v=3' border='0' alt='Cómprame un café en ko-fi.com' /></a>

> [!TIP]
> ⭐ **¡Dale estrella a este repositorio para apoyar al desarrollador y animar el desarrollo de la app!**

<details>
  <summary>Historial de Estrellas</summary>
  <a href="https://github.com/RyanYuuki/AnymeX/stargazers">
      <img alt="Gráfico de Historial de Estrellas" src="https://starchart.cc/RyanYuuki/AnymeX.svg?variant=adaptive" width="370" height="235" />
  </a>
</details>

## Comunidades Oficiales

Únete a nuestras comunidades para mantenerte informado y contribuir a la discusión:
...
Damos la bienvenida a contribuciones, desde traducciones hasta nuevas funciones.  
Nuestra guía de configuración del entorno de desarrollo está disponible [aquí](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/./DEVELOPMENT.md).  
Para consultas, únete a nuestro [servidor de Discord](https://discord.gg/5gAHhMvTcx) o [grupo de Telegram](https://t.me/AnymeX_Discussion).  
Las solicitudes de extracción son bienvenidas; revisa los [issues abiertos](https://github.com/RyanYuuki/AnymeX/issues) para orientación sobre cambios importantes.
...
Un sincero agradecimiento a todos los que han contribuido al desarrollo de AnymeX.
Sus esfuerzos son invaluables.

<a href="https://github.com/RyanYuuki/AnymeX/graphs/contributors">
  <img alt="GitHub contributors" src="https://img.shields.io/github/contributors/RyanYuuki/AnymeX?style=flat-square&label=Contribuidores%20%3A&labelColor=%230f1318&color=%230f1318" align="left">
</a>
<br>
<a href="https://github.com/RyanYuuki/AnymeX/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=RyanYuuki/AnymeX" alt="Contribuidores">
</a>
...
AnymeX está licenciado bajo la Licencia MIT. Se puede encontrar más información [aquí](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/LICENSE.md).
