...
# AnymeX: マルチサービス追跡クライアント

**AnymeX** は、[**AniList**](https://anilist.co/)、[**MyAnimeList**](https://myanimelist.net/)、[**Simkl**](https://simkl.com/) でのアニメ・マンガの進捗管理・追跡のためだけに設計されたマルチサービス追跡クライアントです。

> [!IMPORTANT]  
> **AnymeX は追跡ツールのみです。** ストリーミングコンテンツ、メディア、またはサードパーティ製拡張機能のホスティング、提供、配布、推奨は行いません。  
>  
> **ユーザー責任:** アプリおよびサードパーティサービスや拡張機能の利用については、ユーザー自身の責任です。利用者は適用されるすべての法律、著作権、知的財産権を順守する必要があります。  
>  
> **免責事項:** AnymeX 開発者は、ユーザーの行動による誤用、法的問題、違反について一切の責任を負いません。法的懸念（DMCA請求を含む）は、AnymeX ではなく各サードパーティサービスへご連絡ください。本アプリは「現状のまま」無保証で提供されます。  
>  
> **サービス:** AnymeX は公式API（AniList、MyAnimeList、Simkl）のみと連携します。サードパーティ製拡張機能はその作成者の責任であり、AnymeX開発者の責任ではありません。  
>  
> **AnymeXを利用することで、[利用規約](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/./TOS.md)に同意したものとみなします。DMCA準拠の追跡機能、AniList・MyAnimeList・Simkl以外のサービスやコンテンツへの非関与についてご確認ください。**
