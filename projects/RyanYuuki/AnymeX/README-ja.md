...
# AnymeX: マルチサービス トラッキングクライアント

**AnymeX** は、[**AniList**](https://anilist.co/)、[**MyAnimeList**](https://myanimelist.net/)、[**Simkl**](https://simkl.com/) の進捗管理・追跡のために設計された、マルチサービス対応のトラッキングクライアントです。

> [!IMPORTANT]  
> **AnymeX は追跡ツールのみです。** ストリーミングコンテンツ、メディア、またはサードパーティ拡張機能のホスティング、提供、配布、推奨は一切行いません。  
>  
> **利用者の責任:** 本アプリの利用方法や、利用者が選択するサードパーティサービス・拡張機能の利用に関しては、すべて利用者自身の責任となります。適用されるすべての法律・著作権・知的財産権を順守する必要があります。  
>  
> **免責事項:** AnymeX開発者は、ユーザーの行動に起因する誤用、法的問題、違反について一切責任を負いません。DMCA請求を含む法的懸念は、AnymeXではなく各サードパーティサービスにお問い合わせください。本アプリは「現状有姿」で提供され、いかなる保証もありません。  
>  
> **サービス:** AnymeXは、対応する公式API（AniList, MyAnimeList, Simkl）のみと連携します。サードパーティ拡張の責任は各制作者にあり、AnymeX開発者は関与しません。  
>  
> **AnymeXを利用することで、[利用規約](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/./TOS.md) に同意したものとみなされます。DMCA準拠の追跡機能と、AniList・MyAnimeList・Simkl以外のコンテンツやサービスには一切関与しない点をご確認ください。**
...
### iOS サイドローディングソース
  <p>
    <a href="https://intradeus.github.io/http-protocol-redirector?r=altstore://source?url=https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="AltStore ソース" src="https://img.shields.io/badge/open_in_app-_?style=for-the-badge&label=AltStore&labelColor=black&color=white"></a>
    <a href="https://intradeus.github.io/http-protocol-redirector?r=feather://source/https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="Feather ソース" src="https://img.shields.io/badge/open_in_app-_?style=for-the-badge&label=Feather&labelColor=black&color=white"></a>
    <a href="https://intradeus.github.io/http-protocol-redirector?r=sidestore://source?url=https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="SideStore ソース" src="https://img.shields.io/badge/open_in_app-_?style=for-the-badge&label=SideStore&labelColor=black&color=white"></a>
    <a href="https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/heads/main/repo/source.json"><img alt="直接ソースURL" src="https://img.shields.io/badge/copy_%2F_paste-_?style=for-the-badge&label=Direct%20Source%20URL&labelColor=black&color=white"></a>
  </p>
</div>
...
| ホーム                                                                                                                                        | 検索                                                                                                                                           | 詳細                                                                                                                     | ライブラリ                                                                                                         |
| ---------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
|![ホームページには、あなたが読んだり見たりした複数のセクションが表示されます。](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Home-portrait.png) | ![ジョジョの奇妙な冒険の検索結果が複数表示された検索ページ。](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Search-portrait.png) | ![Re:ゼロから始める異世界生活の詳細ページ。](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Details-portrait.png) | ![ユーザーの視聴リストが表示されたライブラリページ。](https://raw.githubusercontent.com/RyanYuuki/AnymeX/main/github_assets/android/Library-portrait.png) |

<!-- スクリーンショットが完成したら、これを戻します
### 💻 デスクトップ
...
<a href='https://ko-fi.com/ryanyuuki7' target='_blank'><img height='36' style='border:0px;height:36px;' src='https://storage.ko-fi.com/cdn/kofi1.png?v=3' border='0' alt='ko-fi.comでコーヒーを買う' /></a>

> [!TIP]
> ⭐ **このリポジトリにスターを付けて、開発者を応援し、アプリの開発を促進しましょう！**

<details>
  <summary>スター履歴</summary>
  <a href="https://github.com/RyanYuuki/AnymeX/stargazers">
      <img alt="スター履歴チャート" src="https://starchart.cc/RyanYuuki/AnymeX.svg?variant=adaptive" width="370" height="235" />
  </a>
</details>
