...
## **Roadmap**
We have a project [**roadmap**](https://raw.githubusercontent.com/ZupIT/horusec/main/ROADMAP.md), you can contribute with us!
...
Check out our [**contributing guide**](https://raw.githubusercontent.com/ZupIT/horusec/main/CONTRIBUTING.md) to learn about our development process, how to suggest bugfixes and improvements. 
...
**1. Command line**  
Follow the steps:  
**Step 1:** Configure your local git environment by adding the same name and e-mail configured on your GitHub account. It helps to sign commits manually during reviews and suggestions.
