...
# Dokumentacja i użycie

Aby uzyskać więcej szczegółów oraz definicje typów, zobacz:
...
## Stronicowanie 100 wierszy

```js
// w bazie danych = [ { id: 1 }, { id: 2 }, {...}, { id: 100 } ]
xprisma.model1
	.paginate(
		{
			where: {
