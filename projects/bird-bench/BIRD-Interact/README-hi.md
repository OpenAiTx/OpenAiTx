...
└── requirements.txt
```
**a-interact** चलाने के विवरण `./bird_interact_agent/README.md` में पाए जा सकते हैं; और **c-interact** के विवरण `./bird_interact_conv/README.md` में हैं।

## 📰 समाचार

🚀 हम **[BIRD-Interact-Full (600)](https://huggingface.co/datasets/birdsql/bird-interact-full)** सेट जारी करने की घोषणा करते हुए उत्साहित हैं!  
यह एक कठिन सेट है — सर्वोत्तम LLMs केवल **16.33%** सफलता दर प्राप्त कर रहे हैं, जिसमें `c-interact` और `a-interact` हिस्सों पर केवल **10.0%** सफलता दर है।  
👉 अधिक जानकारी के लिए, कृपया हमारे [प्रोजेक्ट वेबसाइट](https://bird-interact.github.io/) पर जाएं।

📬 हम इस सप्ताह **ग्राउंड ट्रुथ और टेस्ट केस** अपनी मेलिंग सूची में भेजेंगे।  
यदि आप जल्दी पहुंच चाहते हैं, तो साइट पर दिए गए निर्देशानुसार ईमेल भेजें ताकि **स्वचालित डाउनलोड** प्राप्त किया जा सके।  

💾 एक अन्य नोट पर, हमने स्थानीय शोध को आसान बनाने के लिए **[LiveSQLBench-Lite](https://huggingface.co/datasets/birdsql/livesqlbench-base-lite-sqlite)** का SQLite संस्करण भी जारी किया है।  
पूरा **LiveSQLBench-Base** और **-Large** संस्करण जल्द ही आ रहे हैं!
