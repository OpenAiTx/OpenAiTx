...
└── requirements.txt
```
جزئیات مربوط به اجرای **a-interact** را می‌توانید در `./bird_interact_agent/README.md` پیدا کنید؛ و اطلاعات **c-interact** را در `./bird_interact_conv/README.md` بیابید.
