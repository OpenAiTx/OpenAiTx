...
└── requirements.txt
```
Детали о запуске **a-interact** можно найти в `./bird_interact_agent/README.md`; а **c-interact** — в `./bird_interact_conv/README.md`.

## 📋 Список задач

- [x] Выпустить легкую версию, bird-interact-lite (270).
- [x] Выпустить разговорную версию, bird-interact-conv.
- [x] Выпустить агентскую версию, bird-interact-agent.
