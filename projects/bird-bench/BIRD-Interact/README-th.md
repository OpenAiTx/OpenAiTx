...
🚀 เรารู้สึกตื่นเต้นที่จะประกาศเปิดตัวชุดข้อมูล **[BIRD-Interact-Full (600)](https://huggingface.co/datasets/birdsql/bird-interact-full)**!  
นี่เป็นชุดที่ท้าทาย — LLMs ที่ดีที่สุดทำได้เพียง **16.33%** ในอัตราความสำเร็จ โดยมีเพียง **10.0%** ในส่วนของ `c-interact` และ `a-interact`  
👉 ดูรายละเอียดเพิ่มเติมได้ที่ [เว็บไซต์โปรเจกต์ของเรา](https://bird-interact.github.io/)

📬 เราจะส่ง **Ground Truth & Test cases** ไปยังรายชื่ออีเมลของเราภายในสัปดาห์นี้  
หากคุณต้องการเข้าถึงก่อน กรุณาส่งอีเมลตามคำแนะนำในเว็บไซต์เพื่อ **ดาวน์โหลดอัตโนมัติ**  

💾 ในอีกข่าวหนึ่ง เราได้ปล่อยเวอร์ชัน SQLite ของ **[LiveSQLBench-Lite](https://huggingface.co/datasets/birdsql/livesqlbench-base-lite-sqlite)** เพื่อให้การวิจัยในเครื่องง่ายขึ้น  
เวอร์ชันเต็มของ **LiveSQLBench-Base** และ **-Large** จะเปิดตัวเร็วๆ นี้!
