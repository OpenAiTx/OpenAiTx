...
└── requirements.txt
```
**a-interact** চলোৱাৰ সম্পূৰ্ণ তথ্য `./bird_interact_agent/README.md`-ত পোৱা যাব; আৰু **c-interact**-ৰ তথ্য `./bird_interact_conv/README.md`-ত পোৱা যাব।
...
- [x] সম্পূৰ্ণ সংস্কৰণ মুক্তি, bird-interact-full (600)।
- [ ] SFT / RL এটা ব্যৱহাৰকাৰী সিমুলেটৰ
