...
Zig용 크로스플랫폼 TUI 라이브러리, [Ratatui](https://github.com/ratatui/ratatui)에서 영감을 받았습니다.

![ZigTUI 대시보드](https://raw.githubusercontent.com/adxdits/zigtui/master/dashboard.gif)
