...
Biblioteca TUI multiplataforma para Zig, inspirada na [Ratatui](https://github.com/ratatui/ratatui).

![Painel ZigTUI](https://raw.githubusercontent.com/adxdits/zigtui/master/dashboard.gif)

## Funcionalidades

- **Multiplataforma** — Windows, Linux, macOS
- **Renderização eficiente** — Diferenças baseadas em células, apenas redesenha o que mudou
- **Widgets** — Bloco, Parágrafo, Lista, Medidor, Tabela
- **15 temas embutidos** — Nord, Dracula, Gruvbox, Catppuccin, Tokyo Night...
- **Kitty Graphics Protocol** — Exibe imagens (com fallback para Unicode)
- **Sem alocações ocultas** — Gerenciamento de memória explícito
...
<details>
<summary>Alternativa: Submódulo Git</summary>
...
**Disponíveis:** `default`, `nord`, `dracula`, `monokai`, `gruvbox_dark`, `gruvbox_light`, `solarized_dark`, `solarized_light`, `tokyo_night`, `catppuccin_mocha`, `catppuccin_latte`, `one_dark`, `cyberpunk`, `matrix`, `high_contrast`

Execute `zig build run-themes` para visualizar todos os temas.
...
Exibe imagens em terminais que suportam o [Protocolo de Gráficos Kitty](https://sw.kovidgoyal.net/kitty/graphics-protocol/). Alterna automaticamente para blocos Unicode como fallback.
...
**Suportado:** Kitty, WezTerm, foot, Konsole (parcial)  
**Alternativa:** Windows Terminal, iTerm2, Terminal.app

## Suporte a Plataformas

| Plataforma | Terminal | Observações |
|------------|----------|-------------|
| Windows 10+ | Windows Terminal, WezTerm | API de Console Nativa |
| Linux | Qualquer compatível com ANSI | POSIX termios |
