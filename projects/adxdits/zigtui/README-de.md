...
Plattformübergreifende TUI-Bibliothek für Zig, inspiriert von [Ratatui](https://github.com/ratatui/ratatui).
...
- **Effizientes Rendering** — Zellbasierter Vergleich, zeichnet nur Änderungen neu
- **Widgets** — Block, Absatz, Liste, Anzeige, Tabelle
- **15 eingebaute Themes** — Nord, Dracula, Gruvbox, Catppuccin, Tokyo Night...
- **Kitty Graphics Protocol** — Bilder anzeigen (mit Unicode-Backup)
- **Keine versteckten Zuweisungen** — Explizites Speichermanagement
...
<details>
<summary>Alternative: Git-Submodul</summary>
...
**Verfügbar:** `default`, `nord`, `dracula`, `monokai`, `gruvbox_dark`, `gruvbox_light`, `solarized_dark`, `solarized_light`, `tokyo_night`, `catppuccin_mocha`, `catppuccin_latte`, `one_dark`, `cyberpunk`, `matrix`, `high_contrast`

Führen Sie `zig build run-themes` aus, um alle Themes anzusehen.
...
Zeigt Bilder in Terminals an, die das [Kitty Graphics Protocol](https://sw.kovidgoyal.net/kitty/graphics-protocol/) unterstützen. Fällt automatisch auf Unicode-Blöcke zurück.
...
**Unterstützt:** Kitty, WezTerm, foot, Konsole (teilweise)  
**Fallback:** Windows Terminal, iTerm2, Terminal.app

## Plattformunterstützung

| Plattform | Terminal | Hinweise |
|-----------|----------|----------|
| Windows 10+ | Windows Terminal, WezTerm | Native Console API |
| Linux | Jeder ANSI-kompatible | POSIX termios |
