...
跨平台的 Zig TUI 库，灵感来自 [Ratatui](https://github.com/ratatui/ratatui)。
...
- **高效渲染** — 基于单元格的差异比较，只重绘变更部分
- **组件** — 块、段落、列表、进度条、表格
- **15 种内置主题** — Nord、Dracula、Gruvbox、Catppuccin、Tokyo Night...
- **Kitty 图形协议** — 显示图像（支持 Unicode 回退）
- **无隐藏分配** — 显式内存管理
