...
### गुणवत्ता और सुरक्षा
- **[code-reviewer](https://raw.githubusercontent.com/wshobson/agents/main/code-reviewer.md)** - गहन कॉन्फ़िगरेशन सुरक्षा फोकस और प्रोडक्शन विश्वसनीयता के साथ विशेषज्ञ कोड समीक्षा
...
- **[performance-engineer](https://raw.githubusercontent.com/wshobson/agents/main/performance-engineer.md)** - एप्लिकेशन प्रोफाइल करें, बोतलनेक्स का अनुकूलन करें, और कैशिंग रणनीतियाँ लागू करें
...
- **[error-detective](https://raw.githubusercontent.com/wshobson/agents/main/error-detective.md)** - लॉग्स और कोडबेस में त्रुटि पैटर्न, स्टैक ट्रेस, और विसंगतियों की खोज करें
...
- **[mlops-engineer](https://raw.githubusercontent.com/wshobson/agents/main/mlops-engineer.md)** - ML पाइपलाइन, एक्सपेरिमेंट ट्रैकिंग, और मॉडल रजिस्ट्रियाँ बनाएं
...
- **[payment-integration](https://raw.githubusercontent.com/wshobson/agents/main/payment-integration.md)** - Stripe, PayPal, और भुगतान प्रोसेसर को इंटीग्रेट करें
- **[quant-analyst](https://raw.githubusercontent.com/wshobson/agents/main/quant-analyst.md)** - वित्तीय मॉडल बनाएं, ट्रेडिंग रणनीतियों का बैकटेस्ट करें, और बाजार डेटा विश्लेषण करें
...
- **[legacy-modernizer](https://raw.githubusercontent.com/wshobson/agents/main/legacy-modernizer.md)** - लेगेसी कोडबेस को रिफैक्टर करें और क्रमिक आधुनिकता लागू करें
- **[context-manager](https://raw.githubusercontent.com/wshobson/agents/main/context-manager.md)** - कई एजेंट्स और लंबी चलने वाली कार्यों में संदर्भ का प्रबंधन करता है
...
- **[mermaid-expert](https://raw.githubusercontent.com/wshobson/agents/main/mermaid-expert.md)** - फ्लोचार्ट, सीक्वेंस, ERD और आर्किटेक्चर के लिए Mermaid डायग्राम बनाएं
- **[reference-builder](https://raw.githubusercontent.com/wshobson/agents/main/reference-builder.md)** - व्यापक तकनीकी रेफरेंस और API डोक्युमेंटेशन बनाता है
...
### व्यवसाय और विपणन
- **[business-analyst](https://raw.githubusercontent.com/wshobson/agents/main/business-analyst.md)** - मैट्रिक्स का विश्लेषण करें, रिपोर्ट बनाएं, और KPIs ट्रैक करें
...
- **[hp-pro](https://raw.githubusercontent.com/wshobson/agents/main/hp-pro.md)** - भर्ती, ऑनबोर्डिंग/ऑफबोर्डिंग, PTO और छुट्टी, प्रदर्शन, अनुपालन नीतियाँ, और कर्मचारी संबंधों के लिए पार्टनर।
- **[sales-automator](https://raw.githubusercontent.com/wshobson/agents/main/sales-automator.md)** - कोल्ड ईमेल, फॉलो-अप, और प्रस्ताव टेम्पलेट्स का ड्राफ्ट करें
...
- **[legal-advisor](https://raw.githubusercontent.com/wshobson/agents/main/legal-advisor.md)** - गोपनीयता नीति, सेवा की शर्तें, अस्वीकरण, और कानूनी नोटिस का ड्राफ्ट करें

### SEO और कंटेंट ऑप्टिमाइज़ेशन
- **[seo-content-auditor](https://raw.githubusercontent.com/wshobson/agents/main/seo-content-auditor.md)** - प्रदान की गई सामग्री का गुणवत्ता, E-E-A-T संकेतों और SEO सर्वोत्तम प्रथाओं के लिए विश्लेषण करता है
...
- **[seo-keyword-strategist](https://raw.githubusercontent.com/wshobson/agents/main/seo-keyword-strategist.md)** - कीवर्ड उपयोग का विश्लेषण करता है, घनत्व की गणना करता है, और अर्थगत विविधताएं सुझाता है
- **[seo-structure-architect](https://raw.githubusercontent.com/wshobson/agents/main/seo-structure-architect.md)** - सामग्री संरचना, शीर्षक पदानुक्रम, और स्कीमा मार्कअप का अनुकूलन करता है
- **[seo-snippet-hunter](https://raw.githubusercontent.com/wshobson/agents/main/seo-snippet-hunter.md)** - विशेष स्निपेट्स और SERP फीचर्स के लिए सामग्री का स्वरूपण करता है
- **[seo-content-refresher](https://raw.githubusercontent.com/wshobson/agents/main/seo-content-refresher.md)** - पुरानी वस्तुओं की पहचान करता है और सामग्री अपडेट सुझाता है
- **[seo-cannibalization-detector](https://raw.githubusercontent.com/wshobson/agents/main/seo-cannibalization-detector.md)** - कई पृष्ठों पर कीवर्ड ओवरलैप और संघर्ष का विश्लेषण करता है
- **[seo-authority-builder](https://raw.githubusercontent.com/wshobson/agents/main/seo-authority-builder.md)** - E-E-A-T संकेतों और विश्वास संकेतकों के लिए सामग्री का विश्लेषण करता है
- **[seo-content-writer](https://raw.githubusercontent.com/wshobson/agents/main/seo-content-writer.md)** - कीवर्ड्स और ब्रीफ्स के आधार पर SEO-अनुकूलित सामग्री लिखता है
- **[seo-content-planner](https://raw.githubusercontent.com/wshobson/agents/main/seo-content-planner.md)** - सामग्री रूपरेखाएँ, विषय क्लस्टर, और कैलेंडर बनाता है

## मॉडल असाइनमेंट्स

सभी 75 उपएजेंट्स को कार्य की जटिलता के आधार पर विशिष्ट Claude मॉडलों के साथ कॉन्फ़िगर किया गया है:

### 🚀 Haiku (तेज़ और लागत-कुशल) - 15 एजेंट्स
**मॉडल:** `haiku`
...
- `business-analyst` - मैट्रिक्स और KPI ट्रैकिंग
- `content-marketer` - ब्लॉग पोस्ट और सोशल मीडिया
- `customer-support` - समर्थन टिकट और FAQs
- `sales-automator` - ठंडे ईमेल और प्रस्ताव
...
- `seo-keyword-strategist` - कीवर्ड घनत्व और अर्थगत विश्लेषण
- `seo-structure-architect` - सामग्री संरचना और स्कीमा मार्कअप
- `seo-snippet-hunter` - विशेष स्निपेट स्वरूपण
- `seo-content-refresher` - सामग्री ताजगी अपडेट्स
- `seo-cannibalization-detector` - कीवर्ड ओवरलैप डिटेक्शन
- `seo-content-planner` - सामग्री कैलेंडर और रूपरेखाएँ

### ⚡ Sonnet (संतुलित प्रदर्शन) - 44 एजेंट्स
**मॉडल:** `sonnet`

**डेवलपमेंट और भाषाएँ:**
- `python-pro` - उन्नत सुविधाओं के साथ पायथन विकास
- `ruby-pro` - रूपी विकास, मेटाप्रोग्रामिंग, Rails पैटर्न और जेम विकास
...
- `cpp-pro` - आधुनिक सी++ एसटीएल और टेम्पलेट्स के साथ
- `php-pro` - उन्नत फीचर्स के साथ आधुनिक पीएचपी
- `java-pro` - स्ट्रीम्स और कंकरेंसी के साथ आधुनिक जावा
- `elixir-pro` - ओटीपी पैटर्न और फीनिक्स के साथ एलिक्सिर
- `csharp-pro` - .NET फ्रेमवर्क्स और पैटर्न्स के साथ आधुनिक सी#
- `scala-pro` - एंटरप्राइज स्काला Apache Pekko, Akka, Spark, और ZIO/Cats Effect के साथ
- `flutter-expert` - स्टेट मैनेजमेंट और एनिमेशन के साथ Flutter डेवलपमेंट
- `unity-developer` - Unity गेम डेवलपमेंट और ऑप्टिमाइजेशन
...
- `backend-architect` - एपीआई डिजाइन और माइक्रोसर्विसेज
- `mobile-developer` - React Native/Flutter ऐप्स
- `sql-pro` - जटिल SQL ऑप्टिमाइजेशन
- `graphql-architect` - GraphQL स्कीमा और रिजोल्वर्स
...
- `ml-engineer` - एमएल मॉडल डिप्लॉयमेंट
- `legacy-modernizer` - फ्रेमवर्क माइग्रेशन
- `payment-integration` - भुगतान प्रोसेसिंग
- `mermaid-expert` - मर्मेड डायग्राम और दृश्य दस्तावेज़ीकरण
- `flutter-expert` - फ्लटर विकास
- `seo-content-auditor` - सामग्री गुणवत्ता और E-E-A-T विश्लेषण
- `seo-authority-builder` - प्राधिकरण संकेत अनुकूलन
- `seo-content-writer` - SEO-अनुकूलित सामग्री निर्माण

### 🧠 Opus (अधिकतम क्षमता) - 15 एजेंट्स
**मॉडल:** `opus`
- `ai-engineer` - LLM अनुप्रयोग और RAG सिस्टम
- `security-auditor` - भेद्यता विश्लेषण
- `performance-engineer` - अनुप्रयोग अनुकूलन
- `incident-responder` - उत्पादन घटना प्रबंधन
- `mlops-engineer` - एमएल अवसंरचना
- `architect-reviewer` - वास्तुकला संगति
- `cloud-architect` - क्लाउड अवसंरचना डिजाइन
...
ये सबएजेंट्स अपने आप उपलब्ध हो जाते हैं जब इन्हें `~/.claude/agents/` निर्देशिका में रखा जाता है।
