...
# 示例
语法灵感来源于 [requests](https://github.com/psf/requests)，因此非常相似，只有极少数不同之处。
...
# Pyinstaller / Pyarmor
**如果您想使用 Pyinstaller 或 Pyarmor 打包库，请确保在命令中添加以下内容：**
...
# 致谢
特别感谢 [Bogdanfinn](https://github.com/bogdanfinn) 开源他的 Golang 版本的 [tls-client](https://github.com/bogdanfinn/tls-client)。
另外，我希望语法尽可能与 [requests](https://github.com/psf/requests) 保持相似，因为大多数人使用并熟悉它！
