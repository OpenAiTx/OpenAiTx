# Python-TLS-Client
Python-TLS-Client est une bibliothèque HTTP avancée basée sur requests et tls-client.
...
# Exemples
La syntaxe est inspirée de [requests](https://github.com/psf/requests), donc elle est très similaire et il y a très peu de différences.

Exemple 1 - Préréglage :
```python
import tls_client
...
# Pyinstaller / Pyarmor
**Si vous souhaitez empaqueter la bibliothèque avec Pyinstaller ou Pyarmor, assurez-vous d'ajouter ceci à votre commande :**
...
```
MacOS M1 et versions antérieures :
...
# Remerciements
Un grand merci à [Bogdanfinn](https://github.com/bogdanfinn) pour avoir rendu open source son [tls-client](https://github.com/bogdanfinn/tls-client) en Golang.
Je voulais aussi garder une syntaxe aussi similaire que possible à [requests](https://github.com/psf/requests), car la plupart des gens l’utilisent et la connaissent bien !
