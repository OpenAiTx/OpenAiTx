...
1. XCode -> 메뉴 라인 -> 패키지 의존성 추가 -> `https://github.com/ukushu/Ifrit.git`

2. 소스 파일에 `import Ifrit` 추가.

## 문서 / 사용법 / 예제 프로젝트

Ifrit 저장소에는 예제 프로젝트가 없습니다. 아래 지침을 사용하세요:

[Ifrit의 Fuse 사용법](https://github.com/ukushu/Ifrit/blob/main/Documentation/FuseInstructions.md)

[Ifrit의 Levenstain 사용법](https://github.com/ukushu/Ifrit/blob/main/Documentation/LevenstainInstructions.md)

[검색 결과를 UI에 표시하는 방법](https://github.com/ukushu/Ifrit/blob/main/Documentation/HowToUseSrchResult.md)
