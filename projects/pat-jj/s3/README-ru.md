...
Если вы хотите протестировать s3 на собственном корпусе/датасете, вы можете ознакомиться с этим коммитом, чтобы узнать, что нужно сделать для построения собственного конвейера: [commit 8420538](https://github.com/pat-jj/s3/commit/8420538836febbe59d5bcbe41187f16908c9c36c)

### Воспроизведение результатов?
Несколько разработчиков уже успешно воспроизвели наши результаты. Если у вас возникнут вопросы или проблемы, не стесняйтесь [открыть issue](https://github.com/pat-jj/s3/issues) — мы рады предоставить практическую помощь (см. [этот пример](https://github.com/pat-jj/s3/issues/20)).

Хотя воспроизведение модели самостоятельно достаточно просто — и мы действительно **рекомендуем обучение с нуля**, поскольку оценка часто занимает гораздо больше времени, чем обучение — мы также предоставляем эталонный чекпойнт: [s3-8-3-3-20steps](https://huggingface.co/pat-jj/s3-8-3-3-20steps), обученный примерно за один час.
