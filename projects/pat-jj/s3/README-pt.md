...
***Pré-computar Inicialização Ingênua do RAG*** (ou você pode baixar nossos dados processados aqui: [huggingface](https://huggingface.co/datasets/pat-jj/s3_processed_data))
