...
要啟動 Annotator，請執行 `io.github.phase1geo.annotator`。

### Ubuntu（PPA）

你可以使用由 @PandaJim 維護的 [PPA](https://launchpad.net/~ubuntuhandbook1/+archive/ubuntu/annotator/)。此 PPA 支援 Ubuntu 20.04+。請依序輸入以下指令
