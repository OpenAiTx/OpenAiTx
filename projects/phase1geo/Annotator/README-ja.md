...
Annotatorを実行するには、`io.github.phase1geo.annotator`を実行してください。

### Ubuntu（PPA）

@PandaJimが管理する[PPA](https://launchpad.net/~ubuntuhandbook1/+archive/ubuntu/annotator/)を利用できます。このPPAはUbuntu 20.04以降をサポートしています。以下のコマンドを一つずつ入力してください。
