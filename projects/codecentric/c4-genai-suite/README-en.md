...
The c4 GenAI Suite already supports many models directly. And if your preferred model is not supported yet, it should be easy to write an extension to support it.
