...
[ouch](https://github.com/ouch-org/ouch) wtyczka dla [Yazi](https://github.com/sxyazi/yazi).
...
Upewnij się, że masz zainstalowany [ouch](https://github.com/ouch-org/ouch) i że znajduje się w Twoim `PATH`.
...
### Dekompresja
Ta wtyczka nie oferuje funkcji dekompresji, ponieważ jest ona już obsługiwana przez Yazi.
Aby zdekompresować za pomocą `ouch`, skonfiguruj otwieracz w `yazi.toml`.
