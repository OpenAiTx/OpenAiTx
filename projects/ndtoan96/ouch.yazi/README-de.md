...
[ouch](https://github.com/ouch-org/ouch) Plugin für [Yazi](https://github.com/sxyazi/yazi).
...
Stellen Sie sicher, dass [ouch](https://github.com/ouch-org/ouch) installiert ist und sich in Ihrem `PATH` befindet.
...
### Dekomprimierung
Dieses Plugin bietet keine Dekomprimierungsfunktion, da diese bereits von Yazi unterstützt wird.
Um mit `ouch` zu dekomprimieren, konfigurieren Sie den Opener in `yazi.toml`.
