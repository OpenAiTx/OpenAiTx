...
[ouch](https://github.com/ouch-org/ouch) plugin per [Yazi](https://github.com/sxyazi/yazi).
...
Assicurati di avere [ouch](https://github.com/ouch-org/ouch) installato e nel tuo `PATH`.
...
### Decompressione
Questo plugin non fornisce una funzionalità di decompressione perché è già supportata da Yazi.
Per decomprimere con `ouch`, configura l'opener in `yazi.toml`.
