...
<div align="center">
 การ <a href="https://github.com/mini-software/MiniWord">ให้ดาว (Star)</a> และ <a href="https://miniexcel.github.io">บริจาค (dotnate)</a> ของคุณสามารถทำให้ MiniWord ดีขึ้นได้
</div>
...
MiniWord คือไลบรารี .NET Word Template ที่ใช้งานง่ายและมีประสิทธิภาพ
...
- ลิงก์ nuget : https://www.nuget.org/packages/MiniWord

### เริ่มต้นอย่างรวดเร็ว

การออกแบบแม่แบบ (Template) ตามหลัก "เห็นอะไร ได้อย่างนั้น" (WHAT you see is what you get) และสไตล์ของแท็กในแม่แบบจะถูกรักษาไว้อย่างสมบูรณ์
...
- อินพุต รองรับทั้ง path ของไฟล์, byte[]
- เอาต์พุต รองรับทั้ง path ของไฟล์, byte[], stream
...
รูปแบบ string ของแม่แบบ MiniWord เหมือนกับ Vue, React `{{tag}}` ผู้ใช้เพียงแค่ต้องให้ key ของแท็กและ value ตรงกัน ระบบจะทำการแทนที่โดยอัตโนมัติ
...
ชนิดของ value ต้องเป็น `MiniWordPicture`
...
ค่า tag เป็นชนิด `string[]` หรือ `IList<string>`
...
ค่า tag เป็นชนิด `IEmerable<Dictionary<string,object>>`
...
### รายการซ้อนรายการ (List inside list)

ค่า tag เป็นชนิด `IEnumerable<MiniWordForeach>` ต้องเพิ่มแท็ก `{{foreach` และ `endforeach}}` ลงในแม่แบบด้วย
...
### คำสั่ง If ภายในเทมเพลต

สำหรับหลายย่อหน้า ให้ใช้แท็ก @if และ @endif  
สำหรับย่อหน้าเดียวและภายใน foreach ให้ใช้แท็ก `{{if` และ `endif}}` ตามที่เทมเพลตกำหนด
...
### พารามิเตอร์แบบ POCO หรือ dynamic

v0.5.0 รองรับ POCO หรือ dynamic parameter
...
หาก value เป็นชนิด `MiniWordHyperLink` ระบบจะนำค่าไปแทนสตริงในเทมเพลตเป็นลิงก์

* Url: เส้นทางปลายทางของ HyperLink URI
* Text: คำอธิบาย
...
## สนับสนุน : [ลิงก์บริจาค](https://miniexcel.github.io/)
