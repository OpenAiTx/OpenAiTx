...
<div align="center">
 การ <a href="https://github.com/mini-software/MiniWord">กดดาว</a> และ <a href="https://miniexcel.github.io">สนับสนุน</a> ของคุณจะทำให้ MiniWord ดียิ่งขึ้น
</div>
...
MiniWord เป็นไลบรารีเทมเพลต Word สำหรับ .NET ที่ง่ายและมีประสิทธิภาพ
...
เทมเพลตจะยึดหลัก “WHAT you see is what you get” และรูปแบบแท็กในเทมเพลตจะถูกเก็บรักษาไว้อย่างครบถ้วน
...
- อินพุตรองรับทั้ง path ไฟล์, byte[]
- เอาต์พุตรองรับทั้ง path ไฟล์, byte[], stream
...
รูปแบบสตริงเทมเพลตของ MiniWord จะเหมือนกับ Vue, React `{{tag}}` ผู้ใช้เพียงแค่ต้องตรวจสอบให้แน่ใจว่าแท็กและ key ของ value parameter ตรงกัน ระบบจะทำการแทนที่ให้อัตโนมัติ
...
Value type คือ `MiniWordPicture`
...
### รายการซ้อนในรายการ (List inside list)

ค่า tag เป็นชนิด `IEnumerable<MiniWordForeach>` จำเป็นต้องเพิ่ม tag `{{foreach` และ `endforeach}}` ในเทมเพลต
...
### คำสั่ง If statement ในเทมเพลต

สำหรับหลายย่อหน้า ให้ใช้แท็ก @if และ @endif  
สำหรับย่อหน้าเดียวและใช้ภายใน foreach ให้ใช้แท็ก `{{if` และ `endif}}` โดยเทมเพลตจะต้องระบุไว้
...
### พารามิเตอร์ POCO หรือ dynamic

v0.5.0 รองรับพารามิเตอร์ POCO หรือ dynamic
...
ถ้าประเภทของ value เป็น `MiniWordHyperLink` ระบบจะทำการแทนที่สตริงในเทมเพลตด้วยไฮเปอร์ลิงก์

* Url: เส้นทางเป้าหมายของ HyperLink URI
* Text: คำอธิบาย
...
## สนับสนุน : [Donate Link](https://miniexcel.github.io/)
