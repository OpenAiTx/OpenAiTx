...
<div align="center">
 การ <a href="https://github.com/mini-software/MiniWord">Star</a> และ <a href="https://miniexcel.github.io">dotnate</a> ของคุณ สามารถทำให้ MiniWord ดียิ่งขึ้น
</div>
...
เทมเพลตใช้การออกแบบ "WHAT you see is what you get" และรูปแบบของแท็กเทมเพลตจะถูกเก็บรักษาไว้อย่างสมบูรณ์
...
- อินพุตรองรับเส้นทางไฟล์, byte[]
- เอาต์พุตรองรับเส้นทางไฟล์, byte[], stream
...
รูปแบบสตริงเทมเพลต MiniWord เช่นเดียวกับ Vue, React `{{tag}}`，ผู้ใช้เพียงแค่ต้องให้แท็กและคีย์ของพารามิเตอร์ value เหมือนกัน จากนั้นระบบจะทำการแทนที่โดยอัตโนมัติ
...
ชนิดของค่าเป็น `MiniWordPicture`
...
ค่า tag เป็นประเภท `string[]` หรือ `IList<string>`
...
ค่าของแท็กเป็นชนิด `IEmerable<Dictionary<string,object>>`
...
ค่าของแท็กคือชนิด `IEnumerable<MiniWordForeach>` จำเป็นต้องเพิ่มแท็ก `{{foreach` และ `endforeach}}` ในเทมเพลต
...
### คำสั่ง if ภายในแม่แบบ

สำหรับหลายย่อหน้า ให้ใช้แท็ก @if และ @endif
สำหรับย่อหน้าเดียวและภายใน foreach ให้ใช้แท็ก `{{if` และ `endif}}` ตามที่แม่แบบต้องการ
...
### POCO หรือพารามิเตอร์แบบไดนามิก

v0.5.0 รองรับ POCO หรือพารามิเตอร์แบบไดนามิก
...
หากชนิดของค่าคือ `MiniWordHyperLink` ระบบจะทำการแทนที่สตริงเทมเพลตด้วยไฮเปอร์ลิงก์

* Url： เส้นทางปลายทาง URI ของไฮเปอร์ลิงก์
* Text：คำอธิบาย
...
## สนับสนุน : [ลิงก์สำหรับบริจาค](https://miniexcel.github.io/)
</translate-content>
