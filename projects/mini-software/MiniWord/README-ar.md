...
<div align="center">
 نجمتك على <a href="https://github.com/mini-software/MiniWord">المستودع</a> و <a href="https://miniexcel.github.io">تبرعك</a> يمكن أن يجعلا MiniWord أفضل
</div>
...
MiniWord هي مكتبة قوالب Word لـ .NET سهلة وفعّالة.
...
- رابط النوجيت : https://www.nuget.org/packages/MiniWord

### بداية سريعة

يتبع القالب تصميم "ما تراه هو ما تحصل عليه"، ويتم الحفاظ على أنماط علامات القالب بالكامل.
...
- يدعم الإدخال مسار الملف، byte[]
- يدعم الإخراج مسار الملف، byte[]، stream
...
سلسلة تنسيق قالب MiniWord مشابهة لـ Vue و React `{{tag}}`، يحتاج المستخدمون فقط إلى التأكد من أن اسم العلامة ومفتاح معامل القيمة متطابقان، ثم سيقوم النظام باستبدالهما تلقائيًا.
...
![صورة](https://user-images.githubusercontent.com/12729184/190834360-39b4b799-d523-4b7e-9331-047a61fd5eb9.png)

##### النتيجة

![صورة](https://user-images.githubusercontent.com/12729184/190834455-ba065211-0f9d-41d1-9b7a-5d9e96ac2eff.png)
...
![صورة](https://user-images.githubusercontent.com/12729184/190647953-6f9da393-e666-4658-a56d-b3a7f13c0ea1.png)

##### النتيجة

![صورة](https://user-images.githubusercontent.com/12729184/190648179-30258d82-723d-4266-b711-43f132d1842d.png)
...
![صورة](https://user-images.githubusercontent.com/12729184/190645513-230c54f3-d38f-47af-b844-0c8c1eff2f52.png)

##### النتيجة

![صورة](https://user-images.githubusercontent.com/12729184/190645704-1f6405e9-71e3-45b9-aa99-2ba52e5e1519.png)
...
![صورة](https://user-images.githubusercontent.com/12729184/190843632-05bb6459-f1c1-4bdc-a79b-54889afdfeea.png)


##### النتيجة

![صورة](https://user-images.githubusercontent.com/12729184/190843663-c00baf16-21f2-4579-9d08-996a2c8c549b.png)

### قائمة داخل قائمة

قيمة الوسم هي من النوع `IEnumerable<MiniWordForeach>`. من الضروري إضافة وسمي `{{foreach` و `endforeach}}` إلى القالب.
...
للفقرات المتعددة، استخدم الوسوم @if و @endif.
للفقرة الواحدة وداخل foreach، استخدم الوسوم `{{if` و `endif}}` إذا كان القالب يتطلب ذلك.
...
الإصدار 0.5.0 يدعم معلمة POCO أو dynamic
...
* عنوان الرابط: مسار هدف URI للارتباط التشعبي
* النص: الوصف
...
#### تصدير واجهة برمجة التطبيقات ASP.NET Core 3.1
