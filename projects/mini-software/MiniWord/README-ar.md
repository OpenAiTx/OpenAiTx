...
<div align="center">
 إن دعمك عبر <a href="https://github.com/mini-software/MiniWord">Star</a> و <a href="https://miniexcel.github.io">dotnate</a> يمكن أن يجعل MiniWord أفضل
</div>
...
MiniWord هي مكتبة قوالب Word لـ .NET سهلة وفعالة.
...
يتبع القالب تصميم "ما تراه هو ما تحصل عليه"، ويتم الحفاظ على أنماط وسوم القالب بالكامل.
...
تنسيق وسوم القالب في MiniWord يشبه Vue وReact `{{tag}}`، يحتاج المستخدم فقط إلى التأكد من تطابق اسم الوسم مع مفتاح القيمة في المعامل وسيتم استبدالها تلقائياً.
...
var value = new Dictionary<string, object>()
{
    ...
    ["Purpose"] = "موقع شنغهاي يحتاج إلى نظام جديد للتحكم في نظام الموارد البشرية.",
...
var value = new Dictionary<string, object>()
{
    ["TripHs"] = new List<Dictionary<string, object>>
    {
        new Dictionary<string, object>
        {
            ...
            { "How","مناقشة المتطلبات الجزء الأول"},
        ...
        new Dictionary<string, object>
        {
            ...
            { "How","مناقشة المتطلبات الجزء الثاني والتطوير"},
...
قيمة الوسم هي من نوع `IEnumerable<MiniWordForeach>`. يجب إضافة وسومي `{{foreach` و `endforeach}}` إلى القالب.
...
### جملة الشرط داخل القالب

للفقرات المتعددة، استخدم وسوم @if و @endif.
لفقرة واحدة وداخل الحلقة foreach، استخدم وسوم `{{if` و `endif}}` حيث تكون القالب مطلوبة.
...
### معاملات POCO أو ديناميكية

بدءًا من الإصدار v0.5.0 يدعم معاملات POCO أو ديناميكية
...
* Url: مسار هدف الرابط التشعبي URI
* Text: الوصف
...
#### تصدير API باستخدام ASP.NET Core 3.1
