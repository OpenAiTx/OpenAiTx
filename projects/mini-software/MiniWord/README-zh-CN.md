...
<div align="center">
 您的<a href="https://github.com/mini-software/MiniWord">Star</a>和<a href="https://miniexcel.github.io">捐赠</a>可以让 MiniWord 变得更好
</div>
...
tag 值为 `string[]` 或 `IList<string>` 类型
...
Tag值为 `IEmerable<Dictionary<string,object>>` 类型
