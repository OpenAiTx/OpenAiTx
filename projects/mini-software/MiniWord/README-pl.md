...
<div align="center">
 Twoja <a href="https://github.com/mini-software/MiniWord">gwiazdka</a> i <a href="https://miniexcel.github.io">dotacja</a> mogą uczynić MiniWord lepszym
</div>
...
- link do nugeta: https://www.nuget.org/packages/MiniWord
...
- Wejście obsługuje ścieżkę do pliku, byte[]
- Wyjście obsługuje ścieżkę do pliku, byte[], strumień
...
![obraz](https://user-images.githubusercontent.com/12729184/190834360-39b4b799-d523-4b7e-9331-047a61fd5eb9.png)

##### Wynik

![obraz](https://user-images.githubusercontent.com/12729184/190834455-ba065211-0f9d-41d1-9b7a-5d9e96ac2eff.png)
...
Wartość tagu ma typ `IEnumerable<MiniWordForeach>`. W szablonie należy dodać tagi `{{foreach` oraz `endforeach}}`.
...
Dla wielu akapitów użyj znaczników @if i @endif.
Dla pojedynczego akapitu i wewnątrz foreach, użyj znaczników `{{if` i `endif}}`, aby szablon był wymagany.
