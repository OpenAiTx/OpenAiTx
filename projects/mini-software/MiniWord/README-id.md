...
<div align="center">
 Bintang <a href="https://github.com/mini-software/MiniWord">Anda</a> dan <a href="https://miniexcel.github.io">donasi</a> Anda dapat membuat MiniWord menjadi lebih baik
</div>
...
Template mengikuti desain "APA yang Anda lihat adalah yang Anda dapatkan", dan gaya tag template sepenuhnya dipertahankan.
...
- Input mendukung jalur file, byte[]
- Output mendukung jalur file, byte[], stream
...
Tipe nilai adalah `MiniWordPicture`
...
nilai tag adalah tipe `string[]` atau `IList<string>`
...
### Parameter POCO atau dinamis

v0.5.0 mendukung parameter POCO atau dinamis
...
Jika tipe nilai adalah `MiniWordHyperLink`, sistem akan menggantikan string template dengan hyperlink.
