...
Puoi installare il pacchetto [da NuGet](https://www.nuget.org/packages/HtmlTableHelper) utilizzando il Visual Studio Package Manager o l'interfaccia utente di NuGet:
...
##### Esempio List/Array/Set/Enumerable non Key/Value Type
```C#
...
<!--
**Ma** per un altro tipo Key/Value utilizza `ToHtmlTableByDictionary`
```C#
var sourceData = new[] {
...
**Attributi personalizzati Table/TR/TD/TH (Tipo Dinamico)**
...
{
    [TableColumn(DisplayName = "Column1")] //La proprietà MyProperty1 renderizzerà il testo interno thead-td: "Column1"
    public string MyProperty1 { get; set; }
    [TableColumn(DisplayName = "Column2")] //La proprietà MyProperty2 renderizzerà il testo interno thead-td: "Column2"
...
public class ModelClassWithSkipAttr
{
    ...
    public string MyProperty1 { get; set; } //MyProperty1 non verrà renderizzata in html
    public string MyProperty2 { get; set; }
}
```
...
var html = soucreData.CreateBuilder()
    ...
    .ToHtmlTable();
//Risultato : <table><caption id=\"CaptionId\" >This is Caption</caption><thead><tr><th>MyProperty1</th><th>MyProperty2</th></tr></thead><tbody><tr><td>test</td><td>123</td></tr></tbody></table>
```

##### HTMLTableSetting

InnerHtml Encoding configurabile (Si raccomanda di non farlo senza una ragione specifica, a causa di attacchi XSS)
```C#
...
- [ ] Supporto .NET 4.0
- [ ] Supporto modello EF
- [ ] Supporto proprietà con attributo html personalizzato
...
- [ ] Supporto Paginazione
    ...
    sembra che devo convertire datatable in enumrable
--->
```
