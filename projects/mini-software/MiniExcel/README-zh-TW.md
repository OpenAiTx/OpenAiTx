...
<div align="center">
<p>本專案是 <a href="https://www.dotnetfoundation.org/">.NET 基金會</a> 的一部分，並遵守其 <a href="https://www.dotnetfoundation.org/code-of-conduct">行為準則</a> 運作。</p>
</div>
...
<div align="center">
 您的 <a href="https://github.com/mini-software/MiniExcel">Stars</a> 或 <a href="https://miniexcel.github.io">捐款</a> 可以讓 MiniExcel 更加完善
</div>
...
如果有興趣，請同時參閱[新文件](https://raw.githubusercontent.com/mini-software/MiniExcel/master/README-V2.md)及[升級說明](https://raw.githubusercontent.com/mini-software/MiniExcel/master/V2-Upgrade-Notes.md)。
...
請檢查 [TODO](https://github.com/mini-software/MiniExcel/projects/1?fullscreen=true)

### 效能

基準測試的程式碼可在 [MiniExcel.Benchmarks](https://raw.githubusercontent.com/mini-software/MiniExcel/master/benchmarks/MiniExcel.Benchmarks/Program.cs) 找到。

用於效能測試的檔案是 [**Test1,000,000x10.xlsx**](https://raw.githubusercontent.com/mini-software/MiniExcel/master/benchmarks/MiniExcel.Benchmarks/Test1%2C000%2C000x10.xlsx)，這是一份 32MB 的文件，包含 1,000,000 行 * 10 列，所有儲存格皆填入字串 "HelloWorld"。
...
自從 1.24.0 版本開始，系統支援 System.ComponentModel.DisplayNameAttribute = ExcelColumnName.excelColumnNameAttribute
...
如果您需要將 Excel 檔案轉換為 PDF，可以使用 [MiniPdf](https://github.com/mini-software/MiniPdf)。
...
#### 7. 批量新增圖片（MiniExcel.AddPicture）

請在批量生成列數據之前新增圖片，否則在呼叫 AddPicture 時系統會消耗大量記憶體。
...
#### 問：如何使用範本將資料水平（由左至右）填充？

答：MiniExcel 範本集合渲染是垂直展開（由上到下）。目前尚未支援水平（由左至右）填充（請參見 https://github.com/mini-software/MiniExcel/issues/619）。

如果您只需要最終的版面配置，請將您的資料轉置為矩陣，並使用 `printHeader: false` 進行匯出：
...
```
如果你必須使用範本來進行樣式設計，一個選擇是使用純量佔位符（例如 `{{Name_1}}`、`{{Name_2}}` ...），並填充一個字典（需要固定最大欄位數）。

#### 問：Count 是否會將所有資料載入記憶體？

不會，影像測試有 100 萬列*10 欄的資料，最大記憶體使用量 <60MB，耗時 13.65 秒

![image](https://user-images.githubusercontent.com/12729184/117118518-70586000-adc3-11eb-9ce3-2ba76cf8b5e5.png)

#### 問：Query 如何使用整數索引？

Query 的預設索引是字串 Key：A,B,C.... 若要改為數字索引，請建立以下方法進行轉換
