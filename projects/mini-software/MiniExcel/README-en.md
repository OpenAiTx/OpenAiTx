...
2. MiniExcel supports IEnumerable parameter deferred execution. If you want to use the least memory, please do not call methods such as ToList.
...
You can use @mergelimit to limit the boundaries of vertically merged cells.
