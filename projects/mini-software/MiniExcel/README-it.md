...
#### 3. Converti Excel in PDF

Se hai bisogno di convertire file Excel in PDF, puoi utilizzare [MiniPdf](https://github.com/mini-software/MiniPdf).

#### 4. Cultura personalizzata (CultureInfo)

Dalla versione 1.22.0, puoi personalizzare la CultureInfo come sotto, predefinito di sistema `CultureInfo.InvariantCulture`.
...
#### 5. Dimensione Personalizzata del Buffer
```csharp
...
Il sistema non controllerà la memoria, ma potrai ottenere una velocità di salvataggio più rapida.
...
#### 7. Aggiunta Immagine in Lotto (MiniExcel.AddPicture)
