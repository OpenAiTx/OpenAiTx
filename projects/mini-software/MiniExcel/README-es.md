...
Si lo haces, asegúrate también de revisar la [nueva documentación](https://raw.githubusercontent.com/mini-software/MiniExcel/master/README-V2.md) y las [notas de actualización](https://raw.githubusercontent.com/mini-software/MiniExcel/master/V2-Upgrade-Notes.md).
...
- [Nombre de columna de Excel/Índice/Atributo de ignorar](#getstart4)
...
Por favor, consulte [TODO](https://github.com/mini-software/MiniExcel/projects/1?fullscreen=true)
...
El archivo utilizado para probar el rendimiento es [**Test1,000,000x10.xlsx**](https://raw.githubusercontent.com/mini-software/MiniExcel/master/benchmarks/MiniExcel.Benchmarks/Test1%2C000%2C000x10.xlsx), un documento de 32 MB que contiene 1,000,000 filas * 10 columnas cuyas celdas están llenas con la cadena "HelloWorld".
...
#### 3. Convertir Excel a PDF

Si necesitas convertir archivos de Excel a PDF, puedes usar [MiniPdf](https://github.com/mini-software/MiniPdf).

#### 4. Personalizar CultureInfo

Desde la versión 1.22.0, puedes personalizar CultureInfo como se muestra a continuación, el sistema utiliza por defecto `CultureInfo.InvariantCulture`.
...
#### 5. Tamaño de búfer personalizado
```csharp
...
#### 7. Añadir imágenes en lote (MiniExcel.AddPicture)

Por favor, añada las imágenes antes de generar los datos de filas en lote, o el sistema utilizará mucha memoria al llamar a AddPicture.
...
#### P. ¿Cómo llenar datos horizontalmente (de izquierda a derecha) con plantillas?

R. El renderizado de la colección de plantillas de MiniExcel se expande verticalmente (de arriba a abajo). El llenado horizontal (de izquierda a derecha) aún no está soportado (ver https://github.com/mini-software/MiniExcel/issues/619).

Si solo necesitas el diseño final, transpón tus datos en una matriz y expórtala con `printHeader: false`:
...
Si debe usar una plantilla para el estilo, una opción es usar marcadores de posición escalares (por ejemplo, `{{Name_1}}`, `{{Name_2}}` ...) y llenar un diccionario (requiere un número máximo fijo de columnas).


#### P. ¿El uso de Count cargará todos los datos en la memoria?
...
El índice predeterminado de Query es la clave de cadena: A,B,C.... Si desea cambiar a índices numéricos, cree el siguiente método para convertir
