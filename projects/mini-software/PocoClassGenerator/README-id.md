...
- Mendukung beberapa RDBMS: `sqlserver,oracle,mysql,postgresql`
- Mini dan cepat (hanya dalam 5 detik menghasilkan kode 100 tabel)
...
👇Pertama :  Copy&Paste kode [PocoClassGenerator.cs](https://raw.githubusercontent.com/mini-software/PocoClassGenerator/master/PocoClassGenerator/PocoClassGenerator/PocoClassGenerator.cs) ke proyek Anda atau ke LINQPad.  
atau Instal dari [NuGet](https://www.nuget.org/packages/PocoClassGenerator/)
```cmd
...
#### Menghasilkan satu kelas dengan sql
...
#### DataTablePocoClass
Kode ada di [DataTablePocoClassGenerator.cs](https://github.com/shps951023/PocoClassGenerator/blob/master/PocoClassGenerator/PocoClassGenerator/DataTablePocoClassGenerator.cs)
