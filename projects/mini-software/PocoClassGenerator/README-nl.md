...
PocoClassGenerator is gestart met `Necroskillz`'s POCO Generator [Genereer C# POCO's van SQL-statement in LINQPad ](http://www.necronet.org/archive/2012/10/09/generate-c-pocos-from-sql-statement-in-linqpad.aspx)
...
### DEMO
- [POCOGenerator Genereer Klasse met Dynamische SQL | .NET Fiddle](https://dotnetfiddle.net/bDdSCA)
...
👇Eerst :  Kopieer & Plak [PocoClassGenerator.cs](https://raw.githubusercontent.com/mini-software/PocoClassGenerator/master/PocoClassGenerator/PocoClassGenerator/PocoClassGenerator.cs) Code in je project of LINQPad.  
of installeer via [NuGet](https://www.nuget.org/packages/PocoClassGenerator/)
```cmd
PM> install-package PocoClassGenerator
```

👇Ten tweede :  Gebruik een connectie om `GenerateAllTables` aan te roepen en print het resultaat.
```C#
...
#### DataTablePocoClass
Code bij [DataTablePocoClassGenerator.cs](https://github.com/shps951023/PocoClassGenerator/blob/master/PocoClassGenerator/PocoClassGenerator/DataTablePocoClassGenerator.cs)
