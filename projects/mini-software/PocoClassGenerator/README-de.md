...
- Unterstützt [Dapper.Contrib](https://github.com/StackExchange/Dapper/tree/master/Dapper.Contrib)
- Unterstützt mehrere RDBMS: `sqlserver,oracle,mysql,postgresql`
- Klein und schnell (generiert Code für 100 Tabellen in nur 5 Sekunden)
...
👇Erster Schritt:  Kopiere & füge den [PocoClassGenerator.cs](https://raw.githubusercontent.com/mini-software/PocoClassGenerator/master/PocoClassGenerator/PocoClassGenerator/PocoClassGenerator.cs) Code in dein Projekt oder LINQPad ein.  
oder Installation über [NuGet](https://www.nuget.org/packages/PocoClassGenerator/)
```cmd
PM> install-package PocoClassGenerator
```

👇Zweiter Schritt:  Verwende eine Verbindung, um `GenerateAllTables` aufzurufen und das Ergebnis auszugeben.
```C#
