...
1. Download pdf2zh-version-win64.zip from the [release page](https://github.com/Byaidu/PDFMathTranslate/releases)
...
3. Start using in browser:
   ...
   pdf2zh -i
   ```
4. If your browser has not been started automatically, go to
...
See [documentation for GUI](https://raw.githubusercontent.com/Byaidu/PDFMathTranslate/main/./docs/README_GUI.md) for more details.
...
For detailed explanations, please refer to our document about [Advanced Usage](https://raw.githubusercontent.com/Byaidu/PDFMathTranslate/main/./docs/ADVANCED.md) for a full list of each option.


<h2 id="downstream">Secondary Development (APIs)</h2>

For downstream applications, please refer to our document about [API Details](https://raw.githubusercontent.com/Byaidu/PDFMathTranslate/main/./docs/APIS.md) for further information about:

- [Python API](https://raw.githubusercontent.com/Byaidu/PDFMathTranslate/main/./docs/APIS.md#api-python), how to use the program in other Python programs
- [HTTP API](https://raw.githubusercontent.com/Byaidu/PDFMathTranslate/main/./docs/APIS.md#api-http), how to communicate with a server with the program installed
