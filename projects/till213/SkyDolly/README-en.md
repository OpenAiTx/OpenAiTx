  ...
  <details>
    ...
    <div>
      <div align="center">
        ...
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=zh-CN">Simplified Chinese</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=zh-TW">Traditional Chinese</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=ja">Japanese</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=ko">Korean</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=hi">Hindi</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=th">Thai</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=fr">French</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=de">German</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=es">Spanish</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=it">Italian</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=ru">Russian</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=pt">Portuguese</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=nl">Dutch</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=pl">Polish</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=ar">Arabic</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=fa">Persian</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=tr">Turkish</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=vi">Vietnamese</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=id">Indonesian</a>
        | <a href="https://openaitx.github.io/view.html?user=till213&project=SkyDolly&lang=as">Assamese</
      </div>
    </div>
  </details>
...
The connection is established via SimConnect, a standard API introduced with Flight Simulator X to connect to the flight simulator.

Also refer to the [ABOUT.md](https://raw.githubusercontent.com/till213/SkyDolly/main/ABOUT.md).

## Features
- Record / Pause / Play
- Formation flights (multiple aircraft, replay during recording, "fly with formation", time offset)
- Configurable recording sample rate: fixed or variable ("auto")
...
- Location module with over 100 default locations and import/export capability
...
For more videos created with Sky Dolly, also refer to [SHOWCASE](https://raw.githubusercontent.com/till213/SkyDolly/main/SHOWCASE.md). New and upcoming features can be found in the [CHANGELOG](https://raw.githubusercontent.com/till213/SkyDolly/main/CHANGELOG.md).
...
- Stop recording (key R) and click "Play" (spacebar)
- Adjust replay speed and seek the play position, even during replay
- Recorded flights are automatically saved to the "logbook"
- Select a flight in the logbook and press "Load" (or double-click the row) to load the saved flight
...
- https://github.com/saltysimulations/saltyreplay/ - A recording & replay application with a web user interface
- https://github.com/SAHorowitz/MSFS2020-PilotPathRecorder - Records flights and generates Google Earth (KML format) "replays"
- https://github.com/Elephant42/FS_Tool - A simple tool that allows setting the aircraft location and simulation rate
...
- https://joinfs.net/ - Allows synchronization of multiplayer flights across different flight simulators (MSFS, Prepar3D/FSX, XPlane). Also provides a flight recorder with formation flight recording ("overdub").
...
- https://flightloganalyzer.com/ - FlightLog Analyzer analyzes the MSFS logbook and has a CSV export readable by Sky Dolly
- https://github.com/BojoteX/FSAutoSave/ - FSAutoSave automatically (or on demand) saves flight plans
- https://github.com/mracko/MSFS-Landing-Inspector - Analyzes your landing performance
...
- https://obsproject.com/ - Screen capture / broadcasting application
