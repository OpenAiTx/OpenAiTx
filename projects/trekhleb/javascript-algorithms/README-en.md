...
Remember that each data structure has its own trade-offs. And you need to pay more attention to why you're choosing a certain data structure than to how to implement it.
