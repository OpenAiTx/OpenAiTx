...
```
## 🪄 Interactive Demo
To eliminate the preparation for the segmentation mask, we have prepared a gradio demo on [hugging face](https://huggingface.co/spaces/jixin0101/ObjectClear) and it can also be [launched locally](./hugging_face). Just drop your image, assign the target masks with a few clicks, and get the object removal results!
