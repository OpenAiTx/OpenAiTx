...
<p align="center">English | <a href="./docs/README.zh.md">中文</a> | <a href="https://cherry-ai.com">官方網站</a> | <a href="https://docs.cherry-ai.com/cherry-studio-wen-dang/en-us">文件</a> | <a href="./docs/dev.md">開發</a> | <a href="https://github.com/CherryHQ/cherry-studio/issues">反饋</a><br></p>
...
Cherry Studio 是一款支援多種 LLM 供應商的桌面端客戶端，適用於 Windows、Mac 和 Linux。
...
❤️ 喜歡 Cherry Studio？給我們一個星星 🌟 或 [贊助](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/docs/sponsor.md) 支持開發！
...
- ☁️ 主流 LLM 雲端服務：OpenAI、Gemini、Anthropic 等
...
歡迎在我們的 [專案看板](https://github.com/orgs/CherryHQ/projects/7) 跟蹤進度與貢獻。

想影響我們的路線圖？歡迎加入 [GitHub 討論區](https://github.com/CherryHQ/cherry-studio/discussions) 分享你的想法與建議！

# 🌈 主題

- 主題展示館：<https://cherrycss.com>
...
我們歡迎你對 Cherry Studio 做出貢獻！你可以這樣協助：
...
5. **撰寫文件**：改進使用手冊與指南。
6. **社群互動**：參與討論並協助用戶。
7. **推廣應用**：宣傳 Cherry Studio。

請參考 [分支策略](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/docs/branching-strategy-en.md) 以了解貢獻規範

## 快速開始

1. **Fork 倉庫**：Fork 並複製到本地。
2. **建立分支**：為你的更動建立分支。
3. **提交更動**：提交並推送你的更動。
4. **發起 Pull Request**：描述你的更動與原因。

更詳細規範請參考我們的 [貢獻指南](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/CONTRIBUTING.md)。

感謝你的支持與貢獻！

# 🔧 開發者共創計畫

我們正在啟動 Cherry Studio 開發者共創計畫，促進開源生態健康與正向反饋循環。我們相信偉大的軟體來自協作，每一次合併的 pull request 都為專案注入新活力。

誠摯邀請你加入我們的貢獻者行列，與我們共同塑造 Cherry Studio 的未來。
