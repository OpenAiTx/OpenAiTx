...
<div align="center">
 ...
 <a href="https://www.producthunt.com/posts/cherry-studio?embed=true&utm_source=badge-featured&utm_medium=badge&utm_souce=badge-cherry&#0045;studio" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=496640&theme=light" alt="Cherry&#0032;Studio - Chatbots&#0032;AI&#0044;&#0032;Cliente&#0032;de&#0032;Escritorio&#0032;AI | Product Hunt" width="220" height="55" /></a>
</div>
...
1. **Soporte de Diversos Proveedores de LLM**:

- ☁️ Principales Servicios Cloud LLM: OpenAI, Gemini, Anthropic y más
- 🔗 Integración con Servicios Web de IA: Claude, Peplexity, Poe y otros
...
- 💬 Conversaciones Simultáneas Multi-modelo
...
Actualmente estamos trabajando en las siguientes funciones y mejoras:

1. 🎯 **Funciones Principales**

- Asistente de Selección con mejora inteligente de selección de contenido
- Investigación Profunda con capacidades avanzadas de análisis
- Sistema de Memoria con conciencia de contexto global
- Preprocesamiento de Documentos con manejo mejorado de archivos
- Mercado MCP para el ecosistema del Modelo Context Protocol

2. 🗂 **Gestión del Conocimiento**

- Notas y Colecciones
- Visualización de Lienzo Dinámico
- Capacidades OCR
...
- Funcionalidad de anclar ventana
...
- Claude estilo dinámico: <https://github.com/bjl101501/CherryStudio-Claudestyle-dynamic>
...
¡Damos la bienvenida a contribuciones para Cherry Studio! Aquí hay algunas formas en que puedes ayudar:
...
3. **Gestionar Issues**: Ayuda a manejar los issues de GitHub.
4. **Diseño de Producto**: Participa en discusiones de diseño.
5. **Redactar Documentación**: Mejora los manuales y guías de usuario.
6. **Participación Comunitaria**: Únete a discusiones y ayuda a los usuarios.
7. **Promover el Uso**: Difunde Cherry Studio.
...
1. **Haz Fork al Repositorio**: Haz fork y clónalo en tu máquina local.
2. **Crea una Rama**: Para tus cambios.
3. **Envía tus Cambios**: Haz commit y push de tus cambios.
4. **Abre un Pull Request**: Describe tus cambios y motivos.

Para pautas más detalladas, consulta nuestra [Guía de Contribución](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/CONTRIBUTING.md).

¡Gracias por tu apoyo y contribuciones!

# 🔧 Programa de Co-creación para Desarrolladores

Estamos lanzando el Programa de Co-creación para Desarrolladores de Cherry Studio para fomentar un ciclo saludable y de retroalimentación positiva dentro del ecosistema open-source. Creemos que el gran software se construye colaborativamente, y cada pull request fusionado da nueva vida al proyecto.

Te invitamos sinceramente a unirte a nuestras filas de contribuidores y construir juntos el futuro de Cherry Studio.
