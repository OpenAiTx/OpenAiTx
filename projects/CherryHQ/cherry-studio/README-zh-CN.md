...
<p align="center">English | <a href="./docs/README.zh.md">中文</a> | <a href="https://cherry-ai.com">官方网站</a> | <a href="https://docs.cherry-ai.com/cherry-studio-wen-dang/en-us">文档</a> | <a href="./docs/dev.md">开发</a> | <a href="https://github.com/CherryHQ/cherry-studio/issues">反馈</a><br></p>
...
❤️ 喜欢 Cherry Studio？请为它点亮一颗星🌟或[赞助](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/docs/sponsor.md)以支持开发！
...
- 🔗 AI 网络服务集成：Claude、Peplexity、Poe 等
...
在我们的 [项目看板](https://github.com/orgs/CherryHQ/projects/7) 跟踪进度并参与贡献。

想影响我们的路线图？欢迎加入 [GitHub 讨论区](https://github.com/CherryHQ/cherry-studio/discussions) 分享您的想法和反馈！

# 🌈 主题

- 主题展示库: <https://cherrycss.com>
...
请参考 [分支策略](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/docs/branching-strategy-en.md) 了解贡献规范

## 快速开始

1. **Fork 仓库**：Fork 并克隆至本地。
2. **创建分支**：为你的更改新建分支。
3. **提交更改**：提交并推送你的更改。
4. **发起 Pull Request**：描述你的更改和理由。

详细规范请参阅我们的 [贡献指南](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/CONTRIBUTING.md)。

感谢您的支持与贡献！

# 🔧 开发者共创计划

我们发起 Cherry Studio 开发者共创计划，旨在促进开源生态的健康正向循环。我们相信优秀的软件源于协作，每一次合并的 Pull Request 都为项目注入新活力。

我们诚挚邀请您加入贡献者行列，与我们共塑 Cherry Studio 的未来。
