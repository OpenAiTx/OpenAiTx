...
<h1 align="center">
  <a href="https://github.com/CherryHQ/cherry-studio/releases">
    <img src="https://github.com/CherryHQ/cherry-studio/blob/main/build/icon.png?raw=true" width="150" height="150" alt="배너" /><br>
  </a>
</h1>

<p align="center">English | <a href="./docs/zh/README.md">中文</a> | <a href="https://cherry-ai.com">공식 사이트</a> | <a href="https://docs.cherry-ai.com/docs/en-us">문서</a> | <a href="./docs/en/guides/development.md">개발</a> | <a href="https://github.com/CherryHQ/cherry-studio/issues">피드백</a><br></p>
...
체리 스튜디오는 다양한 LLM 공급자를 지원하는 데스크탑 클라이언트로, Windows, Mac, Linux에서 사용할 수 있습니다.

👏 [텔레그램 그룹](https://t.me/CherryStudioAI)｜[디스코드](https://discord.gg/wez8HtpxqQ) | [QQ 그룹(575014769)](https://qm.qq.com/q/lo0D4qVZKi)에 참여하세요

❤️ 체리 스튜디오가 마음에 드시나요? 별점 🌟을 주거나 [스폰서](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/docs/zh/guides/sponsor.md)로 개발을 후원해 주세요!
...
- 🔗 AI 웹 서비스 연동: Claude, Perplexity, [Poe](https://poe.com/) 등
...
다음 기능과 개선 사항을 적극적으로 개발 중입니다:


1. 🎯 **핵심 기능**

- 스마트 콘텐츠 선택 강화가 적용된 선택 어시스턴트
- 고급 연구 기능을 갖춘 딥 리서치
- 글로벌 컨텍스트 인식 메모리 시스템
- 향상된 문서 처리를 위한 문서 전처리
- 모델 컨텍스트 프로토콜 생태계를 위한 MCP 마켓플레이스
...
진행 상황을 확인하고 [프로젝트 보드](https://github.com/orgs/CherryHQ/projects/7)에서 기여해 주세요.

로드맵에 영향을 주고 싶으신가요? 아이디어와 의견을 공유하려면 [GitHub Discussions](https://github.com/CherryHQ/cherry-studio/discussions)에 참여해 주세요!
...
Cherry Studio에 대한 기여를 환영합니다! 기여할 수 있는 방법은 다음과 같습니다:

1. **코드 기여**: 새로운 기능을 개발하거나 기존 코드를 최적화합니다.
2. **버그 수정**: 발견한 버그에 대한 수정 사항을 제출합니다.
3. **이슈 관리**: GitHub 이슈 관리에 도움을 줍니다.
4. **제품 디자인**: 디자인 논의에 참여합니다.
5. **문서 작성**: 사용자 매뉴얼 및 가이드를 개선합니다.
6. **커뮤니티 참여**: 토론에 참여하고 사용자들을 돕습니다.
7. **사용 촉진**: Cherry Studio를 널리 알립니다.

기여 가이드라인은 [Branching Strategy](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/docs/en/guides/branching-strategy.md)를 참고하세요.

## 시작하기

1. **저장소 포크**: 저장소를 포크하고 로컬에 복제합니다.
2. **브랜치 생성**: 변경 사항을 위한 브랜치를 만듭니다.
3. **변경 사항 제출**: 변경 사항을 커밋하고 푸시합니다.
4. **풀 리퀘스트 오픈**: 변경 사항과 이유를 설명합니다.

더 자세한 가이드라인은 [Contributing Guide](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/CONTRIBUTING.md)를 참고하세요.

여러분의 지원과 기여에 감사드립니다!

# 🔧 개발자 공동창작 프로그램

Cherry Studio 개발자 공동창작 프로그램을 시작하여 오픈소스 생태계 내에서 건강하고 긍정적인 피드백 루프를 조성하고자 합니다. 우리는 훌륭한 소프트웨어가 협업을 통해 만들어진다고 믿으며, 병합된 모든 풀 리퀘스트가 프로젝트에 새로운 생명을 불어넣는다고 생각합니다.

기여자 여러분을 진심으로 초대하며, 저희와 함께 Cherry Studio의 미래를 만들어가길 바랍니다.

## 기여자 보상 프로그램

핵심 기여자들에게 보답하고 선순환 구조를 만들기 위해 다음과 같은 장기 인센티브 플랜을 마련했습니다.

**이 프로그램의 첫 추적 기간은 2025년 3분기(7월, 8월, 9월)입니다. 이번 사이클의 보상은 10월 1일에 분배됩니다.**

각 추적 기간(예: 첫 번째 사이클의 경우 7월 1일부터 9월 30일까지) 동안, GitHub에 있는 Cherry Studio의 오픈소스 프로젝트에 **의미 있는 커밋 30회 이상** 기여한 개발자는 다음과 같은 혜택을 받을 수 있습니다:

- **Cursor 구독 지원**: [Cursor](https://cursor.sh/) 구독을 위해 **70달러(USD)** 크레딧 또는 환급을 받아 AI를 가장 효율적인 코딩 파트너로 만드세요.
- **무제한 모델 사용**: **DeepSeek** 및 **Qwen** 모델에 대해 **무제한** API 호출이 가능합니다.
- **최신 기술 접근**: **Claude**, **Gemini**, **OpenAI** 등과 같은 모델의 API 접근 등 최신 기술을 경험할 수 있는 특별 혜택이 제공됩니다.

## 함께 성장 & 미래 계획

활기찬 커뮤니티는 모든 지속가능한 오픈소스 프로젝트의 원동력입니다. Cherry Studio가 성장함에 따라 보상 프로그램도 확장됩니다. 업계 최고 수준의 도구와 리소스에 혜택을 지속적으로 맞추겠습니다. 이를 통해 핵심 기여자들에게 의미 있는 지원을 제공하고, 개발자·커뮤니티·프로젝트가 함께 성장하는 선순환을 만듭니다.

**앞으로 프로젝트는 전체 오픈소스 커뮤니티에 환원하는 점점 더 개방적인 방침을 채택할 것입니다.**

## 어떻게 시작하나요?

여러분의 첫 Pull Request를 기대합니다!

저희 저장소를 탐색하고, `good first issue`를 선택하거나 직접 개선안을 제안하며 시작할 수 있습니다. 모든 커밋은 오픈소스 정신의 증거입니다.
...
커뮤니티 에디션을 기반으로, 저희는 현대적 팀과 기업을 위한 사내 배포형 AI 생산성 및 관리 플랫폼인 **Cherry Studio 엔터프라이즈 에디션**을 소개합니다.

엔터프라이즈 에디션은 AI 리소스, 지식, 데이터를 중앙에서 관리하여 팀 협업의 핵심 문제를 해결합니다. 조직이 효율성을 높이고, 혁신을 촉진하며, 컴플라이언스를 확보하면서도 데이터를 100% 안전하게 직접 통제할 수 있게 돕습니다.

## 핵심 장점

- **통합 모델 관리**: 다양한 클라우드 기반 LLM(OpenAI, Anthropic, Google Gemini 등)과 로컬 프라이빗 모델을 중앙에서 통합·관리합니다. 직원들은 별도 설정 없이 즉시 사용할 수 있습니다.
- **엔터프라이즈급 지식베이스**: 팀 전체의 지식베이스를 구축, 관리, 공유할 수 있습니다. 지식의 보존과 일관성을 보장하며, 팀원들은 통합된 정확한 정보를 기반으로 AI와 상호작용할 수 있습니다.
- **세분화된 접근 제어**: 단일 관리자 백엔드에서 직원 계정 관리 및 모델, 지식베이스, 기능별 역할 기반 권한 할당이 쉽습니다.
- **완전 사내 배포**: 전체 백엔드 서비스를 사내 서버 또는 프라이빗 클라우드에 배포하여, 데이터가 100% 개인 소유 및 통제 하에 보관되고, 최고 수준의 보안 및 컴플라이언스 기준을 충족합니다.
...
| :----------------- | :------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------- |
| **오픈소스**        | ✅ 예                                                                                   | ⭕️ 고객에게 부분 공개                                                                                                               |
| **비용**            | [AGPL-3.0 라이선스](https://github.com/CherryHQ/cherry-studio?tab=AGPL-3.0-1-ov-file) | 일시불 구매 / 구독료                                                                                                                |
| **관리자 백엔드**   | —                                                                                      | ● 중앙화된 **모델** 접근<br>● **직원** 관리<br>● 공유 **지식베이스**<br>● **접근** 제어<br>● **데이터** 백업                        |
| **서버**            | —                                                                                      | ✅ 전용 프라이빗 배포                                                                                                               |

## 엔터프라이즈 에디션 받기

엔터프라이즈 에디션이 귀하 팀의 AI 생산성 엔진이 될 것이라 믿습니다. Cherry Studio 엔터프라이즈 에디션에 관심이 있으시거나 자세한 내용을 알고 싶으시거나, 견적 요청 또는 데모 일정을 원하시면 언제든지 문의해 주세요.
...
- [new-api](https://github.com/QuantumNous/new-api): 차세대 LLM 게이트웨이 및 AI 자산 관리 시스템, 다국어 지원.
...
- [Poe](https://poe.com/): Poe는 최고의 AI를 한곳에서 제공합니다. GPT-5, Claude Opus 4.1, DeepSeek-R1, Veo 3, ElevenLabs 등 수백만 가지 탐색.

- [ublacklist](https://github.com/iorate/ublacklist): 구글 검색 결과에 특정 사이트가 표시되지 않도록 차단
...
Cherry Studio 커뮤니티 에디션은 표준 GNU Affero General Public License v3.0 (AGPL-3.0)에 따라 운영되며, https://www.gnu.org/licenses/agpl-3.0.html 에서 확인하실 수 있습니다.

Cherry Studio 커뮤니티 에디션의 상업적 사용은 AGPL-3.0 라이선스의 조건을 완전히 준수하는 한 허용됩니다.

AGPL-3.0 요구사항에서 면제되는 상업적 라이선스가 필요하신 경우, bd@cherry-ai.com 으로 문의해주시기 바랍니다.
