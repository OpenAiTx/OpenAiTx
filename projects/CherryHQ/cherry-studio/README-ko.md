...
Cherry Studio는 여러 LLM 공급자를 지원하는 데스크톱 클라이언트로, Windows, Mac, Linux에서 사용할 수 있습니다.
...
❤️ Cherry Studio가 마음에 드시나요? 별점을 남기거나 🌟 [스폰서](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/docs/sponsor.md)로 개발을 지원해주세요!
...
현재 다음 기능 및 개선 사항을 적극적으로 개발 중입니다:

1. 🎯 **핵심 기능**

- 스마트한 콘텐츠 선택 향상 기능의 선택 도우미
- 고급 연구 기능의 딥 리서치
- 전역 컨텍스트 인식 메모리 시스템
- 문서 처리 개선 문서 전처리
- MCP 마켓플레이스(Model Context Protocol 생태계)
...
[프로젝트 보드](https://github.com/orgs/CherryHQ/projects/7)에서 진행 상황을 추적하고 기여해 주세요.

로드맵에 영향을 미치고 싶으신가요? [GitHub Discussions](https://github.com/CherryHQ/cherry-studio/discussions)에 참여해 아이디어와 피드백을 공유하세요!
...
- Claude 동적 스타일: <https://github.com/bjl101501/CherryStudio-Claudestyle-dynamic>
...
Cherry Studio에 대한 기여를 환영합니다! 다음과 같은 방법으로 참여할 수 있습니다:

1. **코드 기여**: 새로운 기능 개발 또는 기존 코드 최적화.
2. **버그 수정**: 발견한 버그에 대한 수정 제출.
3. **이슈 관리**: GitHub 이슈 관리에 도움.
4. **제품 디자인**: 디자인 논의에 참여.
5. **문서 작성**: 사용자 매뉴얼 및 가이드 개선.
6. **커뮤니티 참여**: 토론에 참여하고 사용자 지원.
7. **사용 촉진**: Cherry Studio 알리기.

기여 지침은 [브랜치 전략](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/docs/branching-strategy-en.md)을 참조하세요.

## 시작하기

1. **저장소 포크**: 포크 후 로컬로 클론.
2. **브랜치 생성**: 변경 사항용 브랜치 생성.
3. **변경사항 제출**: 커밋 및 푸시.
4. **풀 리퀘스트 생성**: 변경 내용과 이유 설명.

더 자세한 지침은 [기여 가이드](https://raw.githubusercontent.com/CherryHQ/cherry-studio/main/CONTRIBUTING.md)를 참고하세요.

여러분의 지원과 기여에 감사드립니다!

# 🔧 개발자 공동 창작 프로그램

Cherry Studio 개발자 공동 창작 프로그램을 시작하여 오픈소스 생태계 내에서 건강하고 긍정적인 피드백 루프를 촉진하고자 합니다. 훌륭한 소프트웨어는 협업으로 만들어진다고 믿으며, 모든 머지된 풀 리퀘스트는 프로젝트에 새로운 생명을 불어넣습니다.

진심으로 여러분을 기여자 대열에 초대하며, 함께 Cherry Studio의 미래를 만들어가길 바랍니다.
