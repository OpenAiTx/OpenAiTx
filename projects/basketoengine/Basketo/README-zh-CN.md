...
<h2 align="center">创造、畅玩、启发。让游戏焕发生命。 ✨</h2>

<h1 align="center">Basketo 游戏引擎</h1>

<div align="center">

[![Discord](https://img.shields.io/discord/1373185493742911609?logo=discord&label=Discord&color=5B5BD6&logoColor=white)](https://discord.gg/F3DswRMW) <!-- 用实际服务器ID替换your_discord_server_id -->
...
<p align="center">
欢迎来到 Basketo 引擎 —— 这是一个充满激情的项目，我们正全力以赴打造一个出色且高性能的引擎，并计划将其打造成原生 AI 游戏引擎。引擎拥有类 Unity 的编辑器界面、Gemini AI 集成、先进的多音效系统以及强大的 ECS 架构。无论你是来贡献代码、提出建议，还是只是想见证它的成长，你都是这段旅程的一部分！🚀
</p>
## 🚀 引擎当前状态
<p align="center">
...
### 🤖 **原生 AI 开发**
- **Gemini AI 集成**：用自然语言指令开发游戏
- **智能脚本生成**：AI 驱动的 Lua 脚本创建
- **实体修改**：用英语描述即可更改实体
- **便捷 API 配置**：内置 Gemini API 密钥设置
### 🔊 **高级音频系统**
- **多音效**：每个实体可拥有多个命名音效（行走、跳跃、攻击等）
- **传统音频**：背景音乐和环境音效
- **Lua 集成**：通过脚本使用 `PlaySound(entity, "action")` 触发音效
- **可视化编辑器**：通过检查器管理音效

### 🎯 **实体-组件-系统（ECS）**
- **高性能**：针对大量实体进行了优化
- **模块化设计**：按需组合组件
- **脚本集成**：Lua 脚本可完全访问 ECS
- **实时更新**：实时组件编辑
...
### 1. **获取你的 Gemini API Key**（可选，但推荐）
- 访问 [Google AI Studio](https://aistudio.google.com/app/apikey)
- 登录并创建一个免费的 API 密钥
- 这将启用 AI 驱动的功能，如自然语言指令
...
2. **CMake**（可通过 Visual Studio 安装，或从 https://cmake.org/download/ 下载）
...
### 核心功能
- **[音效系统](https://raw.githubusercontent.com/basketoengine/Basketo/main/docs/SoundEffectsSystem.md)**：多音效系统的完整指南
- **[Gemini API 设置](https://raw.githubusercontent.com/basketoengine/Basketo/main/docs/GeminiAPIKeySetup.md)**：AI 配置分步指南
...
我们非常欢迎来自社区的贡献 ❤️。有关贡献或以开发方式运行项目的详细信息，请查阅我们的[贡献指南](https://raw.githubusercontent.com/basketoengine/Basketo/main/ContributionGuidline.md)。<!-- 假设您有此文件 -->

- 🐛 发现了漏洞？请提交 Issue！
- ✨ 有很棒的新功能想法？欢迎分享！
- 💻 想要贡献代码？请 Fork、编码并创建 Pull Request！

让我们一起构建这个引擎，让游戏开发变得有趣且简单，人人可参与。🌍

## 👥 社区
热烈欢迎您的加入 🤗。我们非常期待各种形式的社区贡献——无论是代码改进 📝、文档更新 📚、问题报告 🐞、功能请求 💡，还是在我们的 Discord 中参与讨论 🗣️。
...
## 🙏 支持我们：
我们正在不断改进，将很快带来更多功能和示例 🌟。如果您喜欢这个项目，请在 GitHub 仓库为我们加星 ⭐ [![GitHub](https://img.shields.io/github/stars/basketoengine/Basketo?color=5B5BD6)](https://github.com/basketoengine/Basketo)，以便及时获取更新并帮助我们成长。🌱
