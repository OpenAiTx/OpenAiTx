...
Uibook is a tool for visual testing of React components. It lets you quickly
check both desktop and mobile views of your components with real media queries
...
We’ve designed Uibook for seamless integration into your project.
...
[Read more about installation →](https://raw.githubusercontent.com/vrizo/uibook/master/docs/install.md)
[Install in Create React App using CRACO →](https://raw.githubusercontent.com/vrizo/uibook/master/docs/install_craco.md)
...
[Read more about configuration →](https://raw.githubusercontent.com/vrizo/uibook/master/docs/configure.md)

### Pass Pages to the Controller :baby_chick:

As soon as you finish your first Uibook Page, you’re ready
to write the Uibook Controller. This is where all
Pages are included and passed to UibookStarter :sparkles:
...
[Read more about Controller →](https://raw.githubusercontent.com/vrizo/uibook/master/docs/controller.md)

### Launch :rocket:

There is no need for any additional servers or webpack instances.
...
- **[Troubleshooting](https://raw.githubusercontent.com/vrizo/uibook/master/docs/troubleshooting.md)**
- [Examples](https://raw.githubusercontent.com/vrizo/uibook/master/docs/examples.md)
...
Anyone is welcome to contribute, you can check current tasks
in [PLAN.md](https://raw.githubusercontent.com/vrizo/uibook/master/PLAN.md). I would be glad to answer your questions
about the project.
