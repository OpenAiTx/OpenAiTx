...
Gapless (AKA: G4Music) is a lightweight music player written in GTK4, focused on large music collections.

## Features  
- Supports most music file types, Samba, and any other remote protocols (depends on GIO and GStreamer).  
- Fast loading and parsing of thousands of music files in just a few seconds, monitors local changes.  
...
- Fluent adaptive user interface for different screens (Desktop, Tablet, Mobile).  
