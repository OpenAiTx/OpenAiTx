...
- [Forensic Practical](http://www.forensickb.com/2008/01/forensic-practical.html) - To hone your forensic skills and run malware found on the honeypots by installing it on clean computer systems and watching its behavior.
...
- [PentestIT](https://lab.pentestit.ru/) - Penetration testing laboratories "Test lab" emulate an IT infrastructure of real companies and are created for legal pen testing and improving penetration testing skills.
- [CSC Play on Demand](https://pod.cybersecuritychallenge.org.uk/) - The aim of this challenge is to identify the means by which an insider may accidentally or maliciously leak organizational secrets via seemingly innocent files.
...
- [OWASP MSTG Hacking Playground](https://github.com/OWASP/MSTG-Hacking-Playground) - A set of mobile vulnerable apps which you can exploit the vulnerabilities in using techniques from the OWASP MSTG.
- [OWASP MSTG Crackmes](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) - A set of mobile apps that help you improve your reverse engineering skills based on the [OWASP MSTG](https://github.com/OWASP/owasp-mstg).
