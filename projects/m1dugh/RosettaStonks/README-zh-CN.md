...
```
- 在浏览器中进入 `about:debugging#/runtime/this-firefox`
- 点击设置按钮并进入 `Debug addons`。
...
📸 更喜欢可视化操作？请查看[带图片的 Chrome 安装指南](https://raw.githubusercontent.com/m1dugh/RosettaStonks/master/INSTALL_GUI.md)
