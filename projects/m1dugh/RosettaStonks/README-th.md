...
```
- ไปที่ `about:debugging#/runtime/this-firefox` ในเบราว์เซอร์ของคุณ
- คลิกปุ่มการตั้งค่าและไปที่ `Debug addons`
- คลิก `Load Temporary Add-On`
- เลือกไฟล์ `/tmp/rosettastonks.xpi` ในตัวเลือกไฟล์

_คำเตือน: วิธีนี้จะติดตั้งส่วนขยายแบบชั่วคราวเท่านั้น หมายความว่าหากคุณปิดเบราว์เซอร์ ส่วนเสริมจะถูกถอนการติดตั้ง เนื่องจากนโยบายของ firefox ไม่อนุญาตให้ใช้ส่วนขยายที่ไม่ได้รับการตรวจสอบ_
...
หากต้องการเพิ่มเวลาในผลิตภัณฑ์ `foundations` คุณต้องไปที่แบบฝึกหัดของคุณ และ
คลิกละเว้นหรือแก้ไขคำถามอย่างน้อยหนึ่งข้อ เมื่อดำเนินการเสร็จแล้ว จะมีช่องเวลา
ปรากฏขึ้นในหน้าส่วนขยายที่คุณสามารถเพิ่มเวลาได้

#### การเพิ่มเวลาใน Fluency builder

หากต้องการเพิ่มเวลาในผลิตภัณฑ์ `fluency builder` คุณต้องไปที่แบบฝึกหัดของคุณ และ
ตอบแบบฝึกหัดอย่างน้อยหนึ่งข้อ หากไม่ปรากฏช่องเพิ่มเวลา หมายความว่าไม่มีการร้องขอเวลาเกิดขึ้น คุณต้องรีเฟรชคำถามและตอบอีกครั้ง หากต้องการให้เวลาถูกเพิ่ม คุณต้องจบบทเรียนที่ใช้ในการเพิ่มเวลา

_หมายเหตุ: หากคุณไม่เห็นช่องเพิ่มเวลา หมายความว่าการดำเนินการของคุณบนเว็บไซต์ Rosetta stone ไม่ได้นำไปสู่การเพิ่มเวลาที่ถูกต้อง คุณจึงต้องตอบคำถามอื่นๆ_

### การตรวจสอบบทเรียน

#### การตรวจสอบบทเรียนใน Foundations

หากต้องการตรวจสอบบทเรียน คุณต้องเริ่มบทเรียนและผ่านทุกคำถามโดยใช้ปุ่ม `ignore` ที่มุมขวาล่าง เมื่อดูครบทุกคำถามแล้ว ให้คลิกปุ่ม `validate lesson` เพื่อยืนยันบทเรียน หากไม่สำเร็จ ให้กลับไปที่หน้าแรกของคุณ แล้วคลิกบทเรียนเดิม
...
$ make firefox
```
ซึ่งจะสร้างไฟล์ `rosettastonks.xpi` ซึ่งเป็นไฟล์สำหรับส่วนขยายที่สามารถ
โหลดใน Firefox ได้

📸 ชอบภาพประกอบมากกว่าใช่ไหม? ดู [คู่มือติดตั้ง Chrome พร้อมรูปภาพ](https://raw.githubusercontent.com/m1dugh/RosettaStonks/master/INSTALL_GUI.md)
