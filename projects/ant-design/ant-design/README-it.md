...
Un linguaggio di design UI di livello enterprise e una libreria di componenti React.
...
[Changelog](./CHANGELOG.en-US.md) · [Segnala un Bug][github-issues-url] · [Richiedi una Funzionalità][github-issues-url] · English · [中文](./README-zh_CN.md)

## ❤️ Sponsor e Sostenitori [![](https://opencollective.com/ant-design/tiers/sponsors/badge.svg?label=Sponsors&color=brightgreen)](https://opencollective.com/ant-design#support) [![](https://opencollective.com/ant-design/tiers/backers/badge.svg?label=Backers&color=brightgreen)](https://opencollective.com/ant-design#support)
...
- 🌈 UI di livello enterprise progettata per applicazioni web.
- 📦 Un set di componenti React di alta qualità pronti all’uso.
- 🛡 Scritto in TypeScript con tipi statici prevedibili.
- ⚙️ Pacchetto completo di risorse di design e strumenti di sviluppo.
- 🌍 Supporto internazionalizzazione per decine di lingue.
- 🎨 Potente personalizzazione del tema basata su CSS-in-JS.
...
| --- | --- | --- | --- | --- |
| Edge | ultime 2 versioni | ultime 2 versioni | ultime 2 versioni | ultime 2 versioni |
...
export default () => (
  <>
    <Button type="primary">PREMI QUI</Button>
...
- [Panoramica Componenti](https://ant.design/components/overview)
...
- [Istruzioni per Sviluppatori](https://github.com/ant-design/ant-design/wiki/Development)
- [Note di Versionamento](https://github.com/ant-design/ant-design/wiki/%E8%BD%AE%E5%80%BC%E8%A7%84%E5%88%99%E5%92%8C%E7%89%88%E6%9C%AC%E5%8F%91%E5%B8%83%E6%B5%81%E7%A8%8B)
- [FAQ](https://ant.design/docs/react/faq)
- [Online Playground](https://u.ant.design/reproduce) per segnalazione bug
- [Personalizzazione Tema](https://ant.design/docs/react/customize-theme)
- [Come Diventare Collaboratore](https://github.com/ant-design/ant-design/wiki/Collaborators#how-to-apply-for-being-a-collaborator)

## ⌨️ Sviluppo

Usa [opensumi.run](https://opensumi.run), un ambiente di sviluppo front-end puro online e gratuito.
...
Apri il tuo browser e visita http://127.0.0.1:8001, vedi di più su [Sviluppo](https://github.com/ant-design/ant-design/wiki/Development).

## 🤝 Contribuire [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](https://makeapullrequest.com)
...
Costruiamo insieme un antd migliore.

Invitiamo calorosamente tutti a contribuire. Prima di iniziare, ti chiediamo di prendere visione della nostra [Guida al Contributo](https://ant.design/docs/react/contributing). Sentiti libero di condividere le tue idee tramite [Pull Request](https://github.com/ant-design/ant-design/pulls) o [GitHub Issues](https://github.com/ant-design/ant-design/issues). Se vuoi migliorare la nostra base di codice, esplora le [Istruzioni per lo Sviluppo](https://github.com/ant-design/ant-design/wiki/Development) e buon divertimento nella programmazione! :)

Per i collaboratori, attenersi al nostro [Principio delle Pull Request](https://github.com/ant-design/ant-design/wiki/PR-principle) e utilizzare il nostro [Template per Pull Request](https://github.com/ant-design/ant-design/wiki/PR-principle#pull-request-template) quando ne crei una.

## Finanziamento delle Issue

Utilizziamo [Issuehunt](https://issuehunt.io/repos/3452688) per votare e promuovere funzionalità specifiche che vorresti vedere realizzate e implementate. Consulta il nostro backlog e aiutaci:
