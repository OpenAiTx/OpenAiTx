...
Sebuah bahasa desain UI kelas enterprise dan pustaka UI React.
...
[Changelog](./CHANGELOG.en-US.md) · [Laporkan Bug][github-issues-url] · [Ajukan Fitur][github-issues-url] · English · [中文](./README-zh_CN.md)

## ❤️ Sponsor dan Pendukung [![](https://opencollective.com/ant-design/tiers/sponsors/badge.svg?label=Sponsors&color=brightgreen)](https://opencollective.com/ant-design#support) [![](https://opencollective.com/ant-design/tiers/backers/badge.svg?label=Backers&color=brightgreen)](https://opencollective.com/ant-design#support)
...
- 🌈 UI kelas enterprise yang dirancang untuk aplikasi web.
- 📦 Satu set komponen React berkualitas tinggi siap pakai.
- 🛡 Ditulis dalam TypeScript dengan tipe statis yang dapat diprediksi.
- ⚙️ Paket lengkap sumber daya desain dan alat pengembangan.
- 🌍 Dukungan internasionalisasi untuk puluhan bahasa.
- 🎨 Kustomisasi tema yang kuat berbasis CSS-in-JS.
...
| --- | --- | --- | --- | --- |
| Edge | 2 versi terakhir | 2 versi terakhir | 2 versi terakhir | 2 versi terakhir |
...
export default () => (
  <>
    <Button type="primary">TEKAN SAYA</Button>
...
- [Beranda](https://ant.design/)
- [Ringkasan Komponen](https://ant.design/components/overview)
- [Catatan Perubahan](CHANGELOG.en-US.md)
...
- [Instruksi Pengembang](https://github.com/ant-design/ant-design/wiki/Development)
- [Catatan Rilis Versi](https://github.com/ant-design/ant-design/wiki/%E8%BD%AE%E5%80%BC%E8%A7%84%E5%88%99%E5%92%8C%E7%89%88%E6%9C%AC%E5%8F%91%E5%B8%83%E6%B5%81%E7%A8%8B)
- [FAQ](https://ant.design/docs/react/faq)
- [Playground Online](https://u.ant.design/reproduce) untuk pelaporan bug
- [Kustomisasi Tema](https://ant.design/docs/react/customize-theme)
- [Cara Mengajukan Sebagai Kolaborator](https://github.com/ant-design/ant-design/wiki/Collaborators#how-to-apply-for-being-a-collaborator)

## ⌨️ Pengembangan

Gunakan [opensumi.run](https://opensumi.run), lingkungan pengembangan front-end murni gratis secara online.
...
Buka browser Anda dan kunjungi http://127.0.0.1:8001, selengkapnya lihat di [Pengembangan](https://github.com/ant-design/ant-design/wiki/Development).

## 🤝 Kontribusi [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](https://makeapullrequest.com)
...
Mari membangun antd yang lebih baik bersama-sama.

Kami sangat mengundang kontribusi dari semua orang. Sebelum memulai, silakan luangkan waktu untuk membaca [Panduan Kontribusi](https://ant.design/docs/react/contributing). Jangan ragu untuk berbagi ide Anda melalui [Pull Request](https://github.com/ant-design/ant-design/pulls) atau [GitHub Issues](https://github.com/ant-design/ant-design/issues). Jika Anda tertarik meningkatkan basis kode kami, jelajahi [Instruksi Pengembangan](https://github.com/ant-design/ant-design/wiki/Development) dan nikmati perjalanan coding Anda! :)

Untuk kolaborator, patuhi [Prinsip Pull Request](https://github.com/ant-design/ant-design/wiki/PR-principle) kami dan gunakan [Template Pull Request](https://github.com/ant-design/ant-design/wiki/PR-principle#pull-request-template) saat membuat Pull Request.

## Pendanaan Issue

Kami menggunakan [Issuehunt](https://issuehunt.io/repos/3452688) untuk memberikan suara dan mempromosikan fitur spesifik yang ingin Anda lihat dan implementasikan. Lihat backlog kami dan bantu kami:
