...
* Update scour (svg optimizer to its latest version)
...
* Fix bug when saving multiple formats at the same time, no more duplication of texts [issue #13](https://github.com/hchauvet/beampy/issues/13)
...
* Fix bug with dvisvgm output for tikz dvi (function latex2svg now has
  an option to write the svg produced by dvisvgm).
* Add tableofcontents module [See documentation](https://hchauvet.github.io/beampy/auto_examples/plot_TOC.html).
...
* Extra latex packages can be added to text module with the
...
* module position (x,y) operation now accepts Length objects (width/height):
...
* First draft of [Beampy documentation](https://hchauvet.github.io/beampy/)
