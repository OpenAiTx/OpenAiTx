...
<div align="center">
  <a href="https://shipwrecked.hackclub.com/?t=ghrm" target="_blank">
    <img src="https://github.com/neon443/AirAP/blob/main/Icon/shipwrecked.png?raw=true" 
         alt="Questo progetto fa parte di Shipwrecked, il primo hackathon su un'isola al mondo!" 
         style="width: 25%;">
  </a>
</div>
...
<a href="https://www.star-history.com/?repos=neon443%2FAirAP&type=date&legend=top-left">
 <picture>
   ...
   <img alt="Grafico storico delle stelle" src="https://api.star-history.com/image?repos=neon443/AirAP&type=date&legend=top-left" />
 </picture>
</a>
</div>
...
AirAP è un server AirPlay completamente nativo, scritto in Swift, per iOS. In sostanza, AirAP ti permette di usare il tuo iPhone come ricevitore AirPlay in iTunes o sul tuo Mac, il che significa che puoi usare l’iPhone per riprodurre l’audio del tuo dispositivo.

## Cos’è AirAP?

Hai mai desiderato trasmettere l’audio dal tuo Mac, Apple TV o un altro dispositivo iOS al tuo iPhone? AirAP lo rende possibile implementando un server AirPlay completo che funziona nativamente su iOS. Una volta installato, il tuo iPhone apparirà come destinazione AirPlay disponibile nel pannello Audio delle Preferenze di Sistema, in Music.app o in qualsiasi altra app compatibile con AirPlay.

Il concetto potrebbe sembrare al contrario all’inizio: dopotutto, siamo abituati a trasmettere dal nostro iPhone ad altri dispositivi. Ma ci sono sorprendentemente molti scenari in cui vorresti fare l’opposto. Magari stai lavorando sul Mac a tarda notte e vuoi indirizzare l’audio all’iPhone con le cuffie per non disturbare nessuno (ciao 👋). Forse sei uno sviluppatore che testa applicazioni audio e hai bisogno di cambiare rapidamente tra diversi dispositivi di output. Oppure vuoi semplicemente riutilizzare quel vecchio altoparlante cablato.

## Installazione di AirAP

Per provarlo, [apri questo link TestFlight](https://testflight.apple.com/join/8aeqD8Q2), installa AirAP e segui le istruzioni. Dopo l'installazione, avvia semplicemente AirAP e assicurati che il tuo iPhone sia connesso alla stessa rete Wi-Fi del dispositivo da cui vuoi trasmettere. Il tuo iPhone apparirà automaticamente negli elenchi dei dispositivi AirPlay, pronto a ricevere l'audio - se non appare, prova a riavviare l'app.
