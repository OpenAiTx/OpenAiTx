...
Хотите сделать игру уникальной? Измените `styles.css` для нового внешнего вида или поработайте с `script.js`, чтобы изменить геймплей. Весь код хорошо прокомментирован для легкого редактирования!
...
Все еще обновляем! Приветствуются вопросы и Pull Request — давайте вместе сделаем эту игру ещё круче!
