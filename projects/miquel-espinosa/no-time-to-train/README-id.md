...
- [🛠️ Instruksi instalasi](#️-installation-instructions)
  - [1. Klon repositori](#1-clone-the-repository)
...
- [📊 Kode inferensi: Reproduksi hasil SOTA 30-shot pada Few-shot COCO](#-inference-code)
  ...
  - [2. Pasca-proses bank memori](#2-post-process-memory-bank)
...
- [🔍 Dataset kustom](#-custom-dataset)
  ...
  - [1. Isi memori dengan referensi](#1-fill-memory-with-references)
  - [2. Proses lanjutan bank memori](#2-post-process-memory-bank)
- [📚 Sitasi](#-citation)
...
(Catat, bagaimanapun, bahwa checkpoint SAM2.1 sudah tersedia dan mungkin memberikan performa yang lebih baik.)
...
Untuk mengevaluasi transferabilitas metode kami di berbagai foundation model, kami mengganti baik
encoder semantik (DINOv2) maupun segmenter berbasis SAM dengan beberapa alternatif.
...
### Evaluasi VLM pada dataset few-shot COCO
...
Kami mempelajari tiga karakteristik anotasi: (1) luas mask (ukuran objek),
(2) lokasi pusat mask, dan (3) jarak ke tepi gambar.

<details>
<summary><b>Instruksi:</b></summary>
...
<details>
<summary><b>[OUTPUT] Distribusi area mask</b></summary>
...
<details>
<summary><b>[OUTPUT] Densitas pusat Bbox</b></summary>
...
<details>
<summary><b>[OUTPUT] Histogram jarak tepi Bbox</b></summary>
...
Kami mengambil sampel 100 gambar referensi yang beragam per kelas, secara eksplisit
mencakup berbagai ukuran mask, pusat, dan jarak tepi. Setiap
referensi dievaluasi pada subset validasi yang telah dikurangi secara tetap.

<details>
<summary><b>Instruksi:</b></summary>

**Script setup:** `scripts/1shot_ref_ablation/setup.sh`:
1. Membuat file json per kelas
2. Menganalisis kelas tertentu
3. Membuat set referensi dengan berbagai heuristik
...
**Jalankan skrip:** `scripts/1shot_ref_ablation/gpu*.sh`:

4. Jalankan pipeline untuk setiap set referensi
```bash
...
Kami menganalisis bagaimana skor deteksi berkorelasi dengan karakteristik gambar referensi
(ukuran masker, posisi tengah, jarak tepi).
...
<details>
<summary><b>[OUTPUT] Barplot. Efek luas masker (kiri) dan keterpusatan (kanan) terhadap performa</b></summary>
<img width="1190" height="846" alt="barplot" src="https://github.com/user-attachments/assets/e900aff5-523d-4563-aebc-0135dcbb5eb6" />

</details>

<details>
<summary><b>[OUTPUT] Heatmap. Peta skor 2D performa sebagai fungsi lokasi pusat masker</b></summary>
<img width="1250" height="545" alt="heatmap" src="https://github.com/user-attachments/assets/c2c59ffe-b19e-4907-b0be-68249cf5db51" />

</details>

<details>
<summary><b>[OUTPUT] Performa gambar referensi vs. luas masker untuk semua kelas baru COCO</b></summary>
...
- Lihat `no_time_to_train/models/Sam2MatchingBaseline_noAMG_model_and_memory.py` untuk perhitungan ukuran model dan memori.
(Paling mudah: sementara ganti dengan Sam2MatchingBaseline_noAMG.py, lalu ubah nama kembali.)
</details>
...
- Visualisasi prediksi pada set pengujian (folder `results_analysis`).
- Visualisasi memori (folder `memory_vis`).
- File pickle anotasi few-shot.
- Checkpoint model (jika tidak dibersihkan).


### Gambar dan tabel
Skrip tambahan untuk membuat gambar dan tabel.

<details>
<summary><b>Tabel latex ringkasan dataset EO:</b></summary>
...
<details>
<summary><b>Hasilkan tabel LaTeX dari dataset EO:</b></summary>
...
<details>
<summary><b>Plot akurasi dari dataset EO:</b></summary>
...
<details>
<summary><b>Ringkasan efek heuristik pada dataset EO:</b></summary>
...
<details>
<summary><b>Plot runtime dari dataset EO:</b></summary>
...
<details>
<summary><b>Hasilkan visualisasi grid EO untuk gambar pada makalah:</b></summary>
...
<details>
<summary><b>Visualisasi fitur PCA DINOv2:</b></summary>
...
<details>
<summary><b>Visualisasi fitur SAM2 AMG:</b></summary>
...
<a href="https://www.star-history.com/?repos=miquel-espinosa%2Fno-time-to-train&type=date&legend=top-left">
 <picture>
   ...
   <img alt="Grafik Riwayat Bintang" src="https://api.star-history.com/image?repos=miquel-espinosa/no-time-to-train&type=date&legend=top-left" />
 </picture>
</a>
...
Jika Anda menggunakan karya ini, mohon sitasi kami:
