...
- [🛠️ Instrukcje instalacji](#️-installation-instructions)
  - [1. Sklonuj repozytorium](#1-clone-the-repository)
  - [2. Utwórz środowisko conda](#2-create-conda-environment)
  - [3. Zainstaluj SAM2 i DINOv2](#3-install-sam2-and-dinov2)
  - [4. Pobierz zbiory danych](#4-download-datasets)
  - [5. Pobierz checkpointy SAM2 i DINOv2](#5-download-sam2-and-dinov2-checkpoints)
- [📊 Kod wnioskowania: Reprodukuj wyniki SOTA 30-shot w Few-shot COCO](#-inference-code)
  - [0. Utwórz zbiór referencyjny](#0-create-reference-set)
  - [1. Wypełnij pamięć referencjami](#1-fill-memory-with)
  - [2. Przetwarzanie banku pamięci](#2-post-process-memory-bank)
  - [3. Wnioskowanie na obrazach docelowych](#3-inference-on-target-images)

  - [Wyniki](#wyniki)
- [🔍 Niestandardowy zbiór danych](#-niestandardowy-zbiór-danych)
  ...
  - [2. Przetwórz bank pamięci](#2-przetwórz-bank-pamięci)
- [📚 Cytowanie](#-cytowanie)
...
Pobierzemy dokładnie te punkty kontrolne SAM2, które były użyte w artykule.
(Należy jednak zauważyć, że punkty kontrolne SAM2.1 są już dostępne i mogą działać lepiej.)
...
Badamy trzy cechy adnotacji: (1) powierzchnia maski (rozmiar obiektu),
(2) położenie środka maski oraz (3) odległość od krawędzi obrazu.

<details>
<summary><b>Instrukcje:</b></summary>
...
<details>
<summary><b>[WYJŚCIE] Rozkład powierzchni maski</b></summary>
...
<details>
<summary><b>[WYJŚCIE] Gęstość środków obwiedni (bbox)</b></summary>
...
<details>
<summary><b>[WYJŚCIE] Histogramy odległości od krawędzi obwiedni (bbox)</b></summary>
...
Próbkujemy 100 zróżnicowanych obrazów referencyjnych na klasę, w sposób jawny
obejmujący zakres rozmiarów masek, środków i odległości od krawędzi. Każda
referencja jest oceniana na ustalonym, zredukowanym podzestawie walidacyjnym.

<details>
<summary><b>Instrukcje:</b></summary>

**Skrypt przygotowujący:** `scripts/1shot_ref_ablation/setup.sh`:
1. Utwórz plik json dla każdej klasy
2. Analizuj konkretną klasę
3. Utwórz zbiór referencyjny z różnymi heurystykami
...
4. Uruchom pipeline dla każdego zestawu referencyjnego
```bash
...
Analizujemy, jak wyniki detekcji korelują z cechami obrazu referencyjnego
(wielkość maski, pozycja środka, odległość od krawędzi).
...
<details>
<summary><b>[OUTPUT] Wykresy słupkowe. Wpływ powierzchni maski (lewo) i wycentrowania (prawo) na wydajność</b></summary>
<img width="1190" height="846" alt="barplot" src="https://github.com/user-attachments/assets/e900aff5-523d-4563-aebc-0135dcbb5eb6" />

</details>

<details>
<summary><b>[OUTPUT] Mapy cieplne. Dwuwymiarowe mapy wyników wydajności w funkcji położenia środka maski</b></summary>
<img width="1250" height="545" alt="heatmap" src="https://github.com/user-attachments/assets/c2c59ffe-b19e-4907-b0be-68249cf5db51" />

</details>

<details>
<summary><b>[OUTPUT] Wydajność obrazu referencyjnego vs. powierzchnia maski dla wszystkich nowych klas COCO</b></summary>
...
- Wizualizacje predykcji na zbiorze testowym (folder `results_analysis`).
- Wizualizacje pamięci (folder `memory_vis`).
- Plik pickle z kilka-przykładową adnotacją.
...
<details>
<summary><b>Podsumowująca tabela latex zbiorów EO:</b></summary>
...
<details>
<summary><b>Wygeneruj tabelę LaTeX zestawów danych EO:</b></summary>
...
<details>
<summary><b>Wykres dokładności zbiorów danych EO:</b></summary>
...
<details>
<summary><b>Podsumowanie wpływu heurystyk na zbiory danych EO:</b></summary>
...
<details>
<summary><b>Wykres czasu wykonania zbiorów danych EO:</b></summary>
...
<details>
<summary><b>Generuj wizualizacje siatki EO do ilustracji w artykule:</b></summary>
