...
**Dartotsu**는 Flutter로 완전히 새로 작성한 [Dantotsu](https://github.com/rebelonion/Dantotsu/)입니다. 이것은 [**AniList**](https://anilist.co/)와 [**MyAnimeList**](https://myanimelist.net/)를 혼합한 트래킹 클라이언트이며, [**Simkl**](https://simkl.com/)도 지원합니다!  
> [!WARNING]
> Dartotsu는 트래킹 및 관리용입니다.
>
> 스트리밍 콘텐츠나 확장 기능을 호스팅, 제공 또는 유지하지 않습니다.
>
> 사용자는 자신의 행동에 대해 전적으로 책임을 집니다. 개발자는 오용이나 법적 문제에 대해 모든 책임을 부인합니다. 법적 문제는 Dartotsu가 아닌 제3자에게 문의해야 합니다.
...
> [!NOTE]
> <a href="https://t.me/Dartotsu" target="_blank">텔레그램</a> 또는 <a href="https://discord.gg/eyQdCpdubF" target="_blank">디스코드</a>에서 다운로드, 테스트 및 피드백이나 문제를 공유하세요.
</p>
...
> [!TIP]
> ⭐ **이 저장소에 별을 눌러 개발자를 응원하고 애플리케이션 개발을 격려하세요!**
<details>
  <summary>별 누적 기록</summary>
...
## 기여하기
번역에서 새로운 기능까지 기여를 환영합니다. 문의사항은 [디스코드 서버](https://discord.gg/eyQdCpdubF) 또는 [텔레그램 그룹](https://t.me/Dartotsu)에 참여하세요. 풀 리퀘스트도 환영합니다; 주요 변경사항은 [열린 이슈](https://github.com/aayush2622/Dartotsu/issues)를 참고하세요.

### 번역
앱을 여러분의 언어로 번역하여 도와주세요
...
## 라이선스
Dartotsu는 Unabandon Public License(UPL) 하에 라이선스가 부여되어 있습니다.  
자세한 내용은 [여기](https://raw.githubusercontent.com/aayush2622/Dartotsu/main/LICENSE.md)에서 확인할 수 있습니다.
