...
**Dartotsu** は [Dantotsu](https://github.com/rebelonion/Dantotsu/) をFlutterで完全に書き直したものです。これは [**AniList**](https://anilist.co/) および [**MyAnimeList**](https://myanimelist.net/) のハイブリッド型追跡クライアントであり、[**Simkl**](https://simkl.com/) にも対応しています！  
> [!WARNING]
> Dartotsuは追跡と管理専用です。
>
> ストリーミングコンテンツや拡張機能のホスティング、提供、管理は**行っていません**。
>
> 利用者は自身の行動に全責任を負います。開発者は不正利用や法的問題について一切の責任を負いません。法的懸念はDartotsuではなく第三者にお問い合わせください。
...
> [!NOTE]
> ダウンロードしてテストし、ご意見や問題は <a href="https://t.me/Dartotsu" target="_blank">Telegram</a> または <a href="https://discord.gg/eyQdCpdubF" target="_blank">Discord</a> で共有してください。
</p>
...
> [!TIP]
> ⭐ **リポジトリにスターを付けて、開発者を支援しアプリの開発を応援してください！**
<details>
...
## 公式コミュニティ
最新情報を得たり、議論に参加したりするためにコミュニティに参加しましょう 
...
## コントリビュート
翻訳から新機能の追加まで、あらゆる貢献を歓迎しています。問い合わせは [Discord サーバー](https://discord.gg/eyQdCpdubF) や [Telegram グループ](https://t.me/Dartotsu) へ。プルリクエストも歓迎します。主要な変更点については [open issues](https://github.com/aayush2622/Dartotsu/issues) をご確認ください。

### 翻訳
アプリをあなたの言語に翻訳して支援いただけます
...
## 謝辞
Dartotsu の開発にご協力いただいたすべての方々に心より感謝申し上げます。
皆様のご尽力はかけがえのないものです。
...
## ライセンス
Dartotsu は Unabandon Public License (UPL) の下でライセンスされています。詳しくは [こちら](https://raw.githubusercontent.com/aayush2622/Dartotsu/main/LICENSE.md) をご覧ください。
