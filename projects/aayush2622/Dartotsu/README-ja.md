...
**Dartotsu** は [Dantotsu](https://github.com/rebelonion/Dantotsu/) を Flutter で完全に書き直したものです。これは [**AniList**](https://anilist.co/) と [**MyAnimeList**](https://myanimelist.net/) のハイブリッド追跡クライアントであり、[**Simkl**](https://simkl.com/) のサポートも備えています！  
> [!WARNING]
> Dartotsu は追跡および管理のみを目的としています。
>
> ストリーミングコンテンツや拡張機能のホスティング、提供、管理は**一切行いません**。
>
> 利用者の行動はすべて自己責任です。開発者は誤用または法的問題に対して一切の責任を負いません。法的な懸念がある場合は第三者へお問い合わせください。Dartotsu では対応いたしません。

## ダウンロード
<p align="center">

   <a href="https://github.com/aayush2622/Dartotsu/releases/latest"><img src="https://img.shields.io/github/v/release/aayush2622/Dartotsu?style=for-the-badge&logoColor=168b94&label=Stable&labelColor=06599d&color=043b69" alt="最新安定版リリース"/></a>
   <a href="https://github.com/aayush2622/Dartotsu/releases/"><img src="https://img.shields.io/github/v/release/aayush2622/Dartotsu?style=for-the-badge&include_prereleases&logoColor=087a87&label=Beta&color=818cf8" alt="最新プレリリース"/></a>
   <!--<a  href="https://github.com/aayush2622/Dartotsu/releases/latest"><img src="https://img.shields.io/github/v/release/aayush2622/Dartotsu?style=for-the-badge&display_name=tag&label=Alpha&labelColor=087a87&color=168b94" alt="最新アルファリリース"/></a>-->
   
> [!NOTE]
> ダウンロード・テスト・フィードバックや不具合報告は <a href="https://t.me/Dartotsu" target="_blank">Telegram</a> または <a href="https://discord.gg/eyQdCpdubF" target="_blank">Discord</a> でどうぞ。
</p>

## サポート
<a href='https://buymeacoffee.com/aayush262' target='_blank'><img height='36' style='border:0px;height:36px;' src='https://storage.ko-fi.com/cdn/kofi1.png?v=3' border='0' alt='ko-fi.comでコーヒーをおごる' /></a>
> [!TIP]
> ⭐ **このリポジトリにスターを付けて、開発者を応援し、アプリの開発を後押ししましょう！**
<details>
  <summary>スター履歴</summary>
  <a href="https://github.com/aayush2622/Dartotsu/stargazers">
      <img alt="スター履歴チャート" src="https://starchart.cc/aayush2622/Dartotsu.svg?variant=adaptive" width="370" height="235" />
  </a>
</details>

## 公式コミュニティ
最新情報を受け取り、議論に参加するにはコミュニティに参加してください
...
## 貢献方法
翻訳から新機能追加まで、あらゆる貢献を歓迎します。質問は [Discordサーバー](https://discord.gg/eyQdCpdubF) または [Telegramグループ](https://t.me/Dartotsu) へどうぞ。プルリクエストも歓迎です。大きな変更の際は [open issues](https://github.com/aayush2622/Dartotsu/issues) をご確認ください。

**構造を理解したい、より効率的に貢献したい方へ**  
**DeepWiki** のプロジェクトドキュメントにガイドや技術的な情報をまとめています。
...
<details>
<summary>Weblate 翻訳グラフ</summary>
<a href="https://hosted.weblate.org/projects/dartotsu/dartotsu/#languages"><img src="https://hosted.weblate.org/widget/dartotsu/dartotsu/multi-auto.svg" alt="翻訳状況" /></a>
</details>
...
## 謝辞
Dartotsu の開発に貢献してくださったすべての方々に心より感謝申し上げます。
皆様のご尽力はかけがえのないものです。
...
## ライセンス
Dartotsu は Unabandon Public License（UPL）でライセンスされています。詳細は[こちら](https://raw.githubusercontent.com/aayush2622/Dartotsu/main/LICENSE.md)をご覧ください。
