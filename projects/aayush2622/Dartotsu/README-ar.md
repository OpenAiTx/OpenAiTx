...
<p align="center">
   <img src="https://files.catbox.moe/mdn05t.png" alt="لافتة دارتوتسو" width="100%">
</p>
...
**دارطوتسو** هو إعادة كتابة كاملة لمشروع [Dantotsu](https://github.com/rebelonion/Dantotsu/) باستخدام فلاتر. إنه عميل تتبع هجين لـ [**AniList**](https://anilist.co/) و [**MyAnimeList**](https://myanimelist.net/) مع دعم [**Simkl**](https://simkl.com/)!  
> [!تحذير]
> دارطوتسو مخصص للتتبع والإدارة فقط.
>
> هو لا يستضيف أو يوفر أو يحافظ على محتوى البث أو الإضافات.
>
> المستخدمون مسؤولون بالكامل عن تصرفاتهم. المطور يخلي مسؤوليته من أي سوء استخدام أو مشاكل قانونية. يجب معالجة القضايا القانونية مع المصادر الخارجية وليس دارطوتسو.
...
> [!ملاحظة]
> قم بالتنزيل، جرب، وشارك ملاحظاتك أو مشاكلك على <a href="https://t.me/Dartotsu" target="_blank">تيليجرام</a> أو <a href="https://discord.gg/eyQdCpdubF" target="_blank">ديسكورد</a>.
</p>
...
## المساهمة
نرحب بالمساهمات، من الترجمات إلى الميزات الجديدة. للاستفسارات، انضم إلى [خادم Discord](https://discord.gg/eyQdCpdubF) أو [مجموعة Telegram](https://t.me/Dartotsu). طلبات السحب مرحب بها؛ راجع [المشكلات المفتوحة](https://github.com/aayush2622/Dartotsu/issues) للإرشاد حول التغييرات الرئيسية.

**هل تريد فهم الهيكل أو المساهمة بكفاءة أكبر؟**  
راجع وثائق المشروع الكاملة على **DeepWiki** للحصول على أدلة مفيدة ورؤى تقنية.
...
### الترجمة
يمكنك مساعدتنا بترجمة التطبيق إلى لغتك هنا
...
## الشكر والتقدير
شكرًا جزيلًا لكل من ساهم في تطوير Dartotsu.
جهودكم لا تقدر بثمن.
...
## الرخصة
تم ترخيص Dartotsu بموجب رخصة Unabandon العامة (UPL). يمكن العثور على مزيد من المعلومات [هنا](https://raw.githubusercontent.com/aayush2622/Dartotsu/main/LICENSE.md).
