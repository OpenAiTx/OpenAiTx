...
**دارتوتسو** هو إعادة كتابة كاملة لـ [Dantotsu](https://github.com/rebelonion/Dantotsu/) باستخدام فلاتر. إنه عميل تتبع هجين لـ [**AniList**](https://anilist.co/) و [**MyAnimeList**](https://myanimelist.net/) مع دعم [**Simkl**](https://simkl.com/) أيضًا!  
> [!تحذير]
> دارتوتسو مخصص فقط للتتبع والإدارة.
>
> لا يقوم **بتوفير** أو استضافة أو صيانة أي محتوى بث أو إضافات.
>
> المستخدمون مسؤولون بالكامل عن تصرفاتهم. المطوّر يخلي مسؤوليته من أي استخدام خاطئ أو مسائل قانونية. يجب توجيه الاستفسارات القانونية إلى المصادر الخارجية وليس إلى دارتوتسو.
...
> [!ملاحظة]
> قم بالتحميل، جرب، وشارك ملاحظاتك أو مشاكل التطبيق على <a href="https://t.me/Dartotsu" target="_blank">تلغرام</a> أو <a href="https://discord.gg/eyQdCpdubF" target="_blank">ديسكورد</a>.
</p>
...
> [!نصيحة]
> ⭐ **ضع نجمة لهذا المستودع لدعم المطور وتشجيع تطوير التطبيق!**
<details>
...
## المساهمة
نرحب بمساهماتكم، سواء في الترجمات أو الميزات الجديدة. للاستفسارات، انضم إلى [خادم الديسكورد](https://discord.gg/eyQdCpdubF) أو [مجموعة التلغرام](https://t.me/Dartotsu). الطلبات مرحب بها؛ راجع [المشكلات المفتوحة](https://github.com/aayush2622/Dartotsu/issues) للحصول على إرشادات حول التغييرات الكبيرة.

**هل تريد فهم الهيكل أو المساهمة بشكل أكثر فعالية؟**  
راجع التوثيق الكامل للمشروع على **DeepWiki** للحصول على أدلة مفيدة ورؤى تقنية.
...
### الترجمة
يمكنك مساعدتنا في ترجمة التطبيق إلى لغتك من هنا
...
<a href="https://hosted.weblate.org/projects/dartotsu/dartotsu/#languages"><img src="https://hosted.weblate.org/widget/dartotsu/dartotsu/multi-auto.svg" alt="حالة الترجمة" /></a>
</details>
...
## الشكر والتقدير
شكر جزيل من القلب لكل من ساهم في تطوير Dartotsu.
جهودكم لا تقدر بثمن.

<a href="https://github.com/aayush2622/Dartotsu/graphs/contributors">
  <img alt="مساهمو GitHub" src="https://img.shields.io/github/contributors/aayush2622/Dartotsu?style=flat-square&label=Contributors%20%3A&labelColor=%230f1318&color=%230f1318" align="left">
</a>
<br>
<a href="https://github.com/aayush2622/Dartotsu/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=aayush2622/Dartotsu" alt="المساهمون">
</a>

## الرخصة
Dartotsu مرخص بموجب رخصة Unabandon العامة (UPL). يمكن العثور على مزيد من المعلومات [هنا](https://raw.githubusercontent.com/aayush2622/Dartotsu/main/LICENSE.md).
