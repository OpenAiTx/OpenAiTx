...
**Dartotsu** — это полная переработка [Dantotsu](https://github.com/rebelonion/Dantotsu/) на Flutter. Это гибридный клиент для отслеживания [**AniList**](https://anilist.co/) и [**MyAnimeList**](https://myanimelist.net/), а также поддержка [**Simkl**](https://simkl.com/)!  
> [!ПРЕДУПРЕЖДЕНИЕ]
...
>
> Пользователи полностью ответственны за свои действия. Разработчик отказывается от любой ответственности за неправильное использование или юридические проблемы. Юридические вопросы следует адресовать сторонним источникам, а не Dartotsu.
...
> [!ПРИМЕЧАНИЕ]
> Загружайте, тестируйте и делитесь отзывами или проблемами в <a href="https://t.me/Dartotsu" target="_blank">Telegram</a> или <a href="https://discord.gg/eyQdCpdubF" target="_blank">Discord</a>.
</p>
...
> [!СОВЕТ]
> ⭐ **Добавьте звезду этому репозиторию, чтобы поддержать разработчика и вдохновить на развитие приложения!**
<details>
...
## Вклад
Мы приветствуем любые вклады — от переводов до новых функций. По вопросам присоединяйтесь к нашему [серверу Discord](https://discord.gg/eyQdCpdubF) или [группе Telegram](https://t.me/Dartotsu). Пул-реквесты приветствуются; ознакомьтесь с [открытыми задачами](https://github.com/aayush2622/Dartotsu/issues) для рекомендаций по крупным изменениям.

**Хотите понять структуру или внести вклад эффективнее?**  
Полная документация проекта доступна на **DeepWiki** с полезными руководствами и технической информацией.
...
## Благодарности
От всей души благодарим всех, кто внес вклад в разработку Dartotsu.
...
## Лицензия
Dartotsu лицензируется по публичной лицензии Unabandon Public License (UPL). Подробнее можно узнать [здесь](https://raw.githubusercontent.com/aayush2622/Dartotsu/main/LICENSE.md).
