...
**Dartotsu**, [Dantotsu](https://github.com/rebelonion/Dantotsu/) projesinin Flutter ile tamamen yeniden yazılmış halidir. Hem [**AniList**](https://anilist.co/) hem de [**MyAnimeList**](https://myanimelist.net/) takip istemcisidir ve ayrıca [**Simkl**](https://simkl.com/) desteği de sunar!  
> [!UYARI]
> Dartotsu yalnızca takip ve yönetim amaçlıdır.
>
> Kesinlikle akış içeriği veya eklenti barındırmaz, sağlamaz veya sürdürmez.
>
> Kullanıcılar tüm eylemlerinden tamamen sorumludur. Geliştirici, yanlış kullanım veya hukuki sorunlardan hiçbir şekilde sorumlu değildir. Yasal endişeler üçüncü taraf kaynaklara iletilmelidir, Dartotsu'ya değil.
...
> [!NOT]
> İndirip test edin, geri bildirim ya da sorunlarınızı <a href="https://t.me/Dartotsu" target="_blank">Telegram</a> veya <a href="https://discord.gg/eyQdCpdubF" target="_blank">Discord</a> üzerinden paylaşın.
</p>
...
## Resmi Topluluklar
Güncel kalmak ve tartışmalara katkı sağlamak için topluluklarımıza katılın 
...
## Katkı Sağlayın
Çevirilerden yeni özelliklere kadar tüm katkılara açığız. Sorularınız için [Discord sunucumuza](https://discord.gg/eyQdCpdubF) veya [Telegram grubumuza](https://t.me/Dartotsu) katılabilirsiniz. Pull request göndermekten çekinmeyin; büyük değişiklikler için [açık sorunlara](https://github.com/aayush2622/Dartotsu/issues) göz atabilirsiniz.

### Çeviri
Uygulamayı kendi dilinize çevirmek için bize buradan yardımcı olabilirsiniz
...
## Teşekkürler
Dartotsu'nun geliştirilmesine katkıda bulunan herkese içten teşekkürlerimizi sunarız.
Çabalarınız paha biçilmezdir.
...
<br>
<a href="https://github.com/aayush2622/Dartotsu/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=aayush2622/Dartotsu" alt="Katkıda Bulunanlar">
</a>

## Lisans
Dartotsu, Unabandon Public License (UPL) lisansı ile lisanslanmıştır. Daha fazla bilgiye [buradan](https://raw.githubusercontent.com/aayush2622/Dartotsu/main/LICENSE.md) ulaşabilirsiniz.
