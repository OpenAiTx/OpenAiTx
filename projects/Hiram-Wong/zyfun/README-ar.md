<div align="right">
  <details>
    ...
    <div>
      <div align="center">
        <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=en">الإنجليزية</a>
        ...
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=ja">اليابانية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=ko">الكورية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=hi">الهندية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=th">التايلاندية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=fr">الفرنسية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=de">الألمانية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=es">الإسبانية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=it">الإيطالية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=ru">الروسية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=pt">البرتغالية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=nl">الهولندية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=pl">البولندية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=ar">العربية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=fa">الفارسية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=tr">التركية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=vi">الفيتنامية</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=id">الإندونيسية</a>
...
zyfun هو مدير وسائط متعدد المنصات مجاني وبسيط وشامل، يتيح إدارة جميع أنواع الموارد T1-T4 في مكان واحد، مع مشغل متعدد النواة مدمج للتبديل بحرية. مفتاح رئيسي حصري لإخفاء البرنامج بضغطة واحدة دون قلق أثناء العمل. اكتشف العالم من خلال مشاهدة الأفلام!

<details>
<summary>انقر لعرض لقطات البرنامج</summary>

|                    الأفلام                     |                   البث المباشر                   |
| :-----------------------------------------: | :--------------------------------------: |
|  ![الأفلام](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-film.png)   | ![البث المباشر](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-live.png) |
|                  **التاريخ**                   |                 **التشغيل**                 |
| ![التاريخ](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-history.png) | ![التشغيل](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-play.png) |

</details>

## 🌴 ملاحظات هامة

- الإصدار الرسمي متاح فقط عبر Github، يرجى عدم الوقوع ضحية للاحتيال؛ يُرجى من جميع المسؤولين عدم الترويج أو جذب المستخدمين لهذا البرنامج.
- نشجع بشدة على المشاهدة القانونية، هذا البرنامج هو أداة تشغيل فقط ولا يشمل تخزين أو توزيع الموارد.
- للاستخدام الشخصي والتعلم والتبادل فقط، يُرجى حذفه تلقائيًا خلال 24 ساعة، ويحظر الاستخدام التجاري.
- البرنامج مستمد من [ZY-Player](https://github.com/Hunlongyu/ZY-Player)، الأيقونة من تصميم @fourbeauty.
- قبل البدء في الاستخدام، يُرجى قراءة اتفاقية المستخدم بعناية والموافقة عليها، والالتزام بجميع القوانين ذات الصلة.

## 💻 شرح التوافق عبر الأنظمة

- **MacOS**:
  - مسار قاعدة البيانات/الملفات/الإضافات/السجلات: `~/Library/Application Support/zyfun/`
  - مسار الملفات التنفيذية: `~/.zy/bin/`
- **Linux**:
  - مسار قاعدة البيانات/الملفات/الإضافات/السجلات: `~/.config/zyfun/`
  - مسار الملفات التنفيذية: `~/.zy/bin/`
- **Windows**:
  - مسار قاعدة البيانات/الملفات/الإضافات/السجلات: `%USERPROFILE%\AppData\Roaming\zyfun\`
  - مسار الملفات التنفيذية: `%USERPROFILE%\.zy\bin\`
  <!-- - **OpenHarmony**:
  - مسار قاعدة البيانات/الملفات/الإضافات/السجلات: `/data/storage/zyfun/base/files/log`
  - مسار الملفات التنفيذية: `~/.zy/bin/`-->

## 🛠️ التثبيت والتنزيل

> **تحميل النسخة التطويرية**: يتطلب تسجيل الدخول إلى حساب Github

> **الحد الأدنى للمتطلبات**: متوافق مع متطلبات نواة chromium

| نظام التشغيل | x64 | arm64 | loong64 | الإصدار                                                                                                                                                                                                                      | نسخة التطوير                                                                            | الحد الأدنى   |
| :----------: | :-: | :---: | :-----: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | ------------- |
...
|  Linux       | ✅  |  ✅   |   ❌    | [GitHub](https://github.com/Hiram-Wong/zyfun/releases) <br/> [متجر تطبيقات RuYiLingLong](https://store.linyaps.org.cn/) <br/> [حزمة AUR](https://aur.archlinux.org/packages?O=0&SeB=nd&K=zyfun&outdated=&SB=p&SO=d&PP=50&submit=Go) | [GitHub](https://github.com/Hiram-Wong/zyfun/actions/workflows/nightly-build.yml)       |               |
| Harmony      | ❌  |  ❌   |   ➖    |                                                                                                                                                                                                                             |                                                                                         |

<details>
<summary>انقر هنا لعرض مشاكل التثبيت</summary>

#### بعد تثبيت MacOS تظهر رسالة "الملف تالف"
...
#### فشل تشغيل Appimage على لينكس

> التشغيل كمستخدم root بدون --no-sandbox غير مدعوم
...
> إنهاء عملية وحدة معالجة الرسومات بسبب أخطاء أثناء التهيئة

```bash
xhost +
```

#### فشل تثبيت حزمة deb على لينكس

> الحزمة libnss3-1d غير مثبتة

```bash
sudo apt-get install libnss3-1d
```

> الحزمة libxss1 غير مثبتة

```bash
sudo apt-get install libxss1
```

#### فشل تثبيت حزمة rpm في لينكس

> فشل التحقق من الاعتماديات، مطلوب libXScrnSaver
...
> فشل التحقق من الاعتماد، xdg-utils مطلوب
...
> يرجى استيراد البيانات بدقة وفقًا لهياكل البيانات لتجنب الأخطاء غير الضرورية (مثل عدم تطابق نوع حقل البيانات)

<details>
<summary>انقر لعرض شرح الواجهة</summary>
...
فيما يلي بعض الطرق التي يمكنك من خلالها المساهمة:

- **المساهمة بالكود**: تطوير ميزات جديدة أو تحسين الكود الحالي <[وثائق التطوير](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Develop.md)>
- **إصلاح الأخطاء**: تقديم إصلاحات لأي أخطاء تكتشفها <[معايير الإرسال](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Conventional_Commits.md)>
- **إدارة المشكلات**: المساعدة في إدارة مشكلات GitHub
- **تصميم المنتج**: المشاركة في مناقشات التصميم
- **كتابة التوثيق**: تحسين دليل المستخدم والإرشادات
- **المشاركة المجتمعية**: الانضمام للنقاشات ومساعدة المستخدمين
- **الدعم بالحب**: دعم تطوير المشروع (بما في ذلك التمويل أو الخوادم وغيرها) <[kofi](https://ko-fi.com/hiramwong)> <[爱发电](https://ifdian.net/a/hiram)>
...
- [NodeSupport](https://github.com/NodeSeekDev/NodeSupport) قام برعاية هذا المشروع
