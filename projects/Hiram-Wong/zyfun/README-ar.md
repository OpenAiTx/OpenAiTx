...
zyfun هو مدير وسائط متعددة مجاني، بسيط للغاية، شامل، وعبر الأنظمة الأساسية، لإدارة جميع أنواع المصادر من T1-T4 في مكان واحد، مع مشغل متعدد النواة مدمج لتبديل التشغيل بحرية. زر المدير الحصري، بنقرة واحدة تخفي التطبيق وتتيح لك العمل دون قلق. اكتشف العالم من خلال المشاهدة!

<details>
<summary>انقر لعرض لقطات شاشة البرنامج</summary>
...
## 🌴 ملاحظات هامة
- الإصدار متاح فقط على Github، يرجى عدم الوقوع في الاحتيال؛ يرجى من جميع المدراء عدم الترويج أو جذب المستخدمين لهذا البرنامج.
- نحث بشدة على المشاهدة القانونية، هذا البرنامج يُستخدم فقط كأداة تشغيل، ولا يتضمن تخزين أو توزيع الموارد.
- مخصص فقط للتعلم والتبادل الشخصي، يرجى إزالته تلقائيًا خلال 24 ساعة، ولا يُستخدم للأغراض التجارية.
- المصدر الأصلي من [ZY-Player](https://github.com/Hunlongyu/ZY-Player)، الأيقونة من تصميم @fourbeauty.
- قبل البدء بالاستخدام، يرجى قراءة والموافقة على اتفاقية المستخدم بعناية، والتأكد من الالتزام باللوائح ذات الصلة.

## 💻 شرح الأنظمة المتعددة
...
> **الحد الأدنى من المتطلبات**: يجب أن يتوافق مع متطلبات نواة Chromium

| نظام التشغيل | x64 | arm64 | loong64 | الإصدارات                                                                                                                                                                                                                         | النسخة التطويرية                                                                    | الحد الأدنى    |
| :----------: | :-: | :---: | :-----: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | -------------- |
...
<details>
<summary>انقر للتوسيع لعرض مشاكل التثبيت</summary>

#### بعد التثبيت على MacOS تظهر رسالة "الملف تالف"
...
## 🤝 طرق المشاركة في المساهمة

فيما يلي بعض الطرق التي يمكنك من خلالها المساهمة:

- **المساهمة في الكود**: تطوير ميزات جديدة أو تحسين الكود الحالي <[وثائق التطوير](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Develop.md)> <[وثائق Mcp](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Mcp.md)>
- **إصلاح الأخطاء**: تقديم إصلاحات لأي أخطاء تكتشفها <[معايير التقديم](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Conventional_Commits.md)>
- **إدارة المشاكل**: المساعدة في إدارة مشاكل GitHub
- **تصميم المنتج**: المشاركة في مناقشات التصميم
- **كتابة الوثائق**: تحسين دليل المستخدم والإرشادات
