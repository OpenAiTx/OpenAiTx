...
zyfun एक निःशुल्क, अत्यंत साधारण, सर्व-शक्ति संपन्न क्रॉस-प्लेटफ़ॉर्म मीडिया प्रबंधक है, जो T1-T4 सभी प्रकार के संसाधनों का एक स्थान पर प्रबंधन करता है, और इसमें मल्टी-कोर प्लेयर अंतर्निहित है जिसे आप अपनी इच्छानुसार बदल सकते हैं। विशेष बॉस की, एक बटन दबाते ही छुप जाएं और निश्चिंत रहें। फिल्मों के माध्यम से दुनिया को जानें!

<details>
<summary>सॉफ़्टवेयर के स्क्रीनशॉट देखने के लिए विस्तार करें</summary>
...
- केवल Github पर जारी, कृपया धोखा न खाएँ; कृपया सभी व्यवस्थापक इस सॉफ़्टवेयर का प्रचार या ट्रैफिक न बढ़ाएँ।
- कानूनी रूप से देखने को प्रोत्साहित किया जाता है, यह सॉफ़्टवेयर केवल प्लेबैक टूल है, संसाधन संग्रहण या वितरण में शामिल नहीं है।
- केवल व्यक्तिगत अध्ययन और交流 के लिए, 24 घंटे के भीतर स्वयं हटाएँ, व्यावसायिक उपयोग न करें।
- इसका पूर्वज [ZY-Player](https://github.com/Hunlongyu/ZY-Player) से आया है, आइकन @fourbeauty द्वारा डिज़ाइन किया गया है।
- उपयोग शुरू करने से पहले कृपया उपयोगकर्ता अनुबंध ध्यान से पढ़ें और सहमत हों, संबंधित नियमों का पालन सुनिश्चित करें।
...
## 🛠️ डाउनलोड और इंस्टॉल

> **डेवलपमेंट वर्शन डाउनलोड**: Github अकाउंट लॉगिन आवश्यक

> **न्यूनतम आवश्यकताएँ**: क्रोमियम कोर के अनुरूप

| ऑपरेटिंग सिस्टम | x64 | arm64 | loong64 | संस्करण                                                                                                                                                                                                                      | डेवलपमेंट वर्शन                                                                        | न्यूनतम आवश्यकताएँ   |
| :------: | :-: | :---: | :-----: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ---------- |
...
<details>
<summary>इंस्टॉल समस्या देखने के लिए विस्तार करें</summary>

#### MacOS इंस्टॉल के बाद खोलने पर "फाइल क्षतिग्रस्त है" संदेश दिखता है
...
निम्नलिखित तरीके हैं जिनसे आप योगदान कर सकते हैं:

- **कोड योगदान**: नई सुविधाएँ विकसित करें या मौजूदा कोड का अनुकूलन करें <[डेवलपमेंट डॉक्स](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Develop.md)>
- **त्रुटि सुधारें**: आपके द्वारा पाई गई किसी भी त्रुटि को सुधारें <[सबमिट गाइडलाइन](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Conventional_Commits.md)>
- **इश्यू प्रबंधन**: GitHub इश्यू को मैनेज करने में सहायता करें
- **उत्पाद डिज़ाइन**: डिज़ाइन चर्चाओं में भाग लें
- **डॉक्युमेंटेशन लिखें**: यूज़र मैनुअल और गाइड में सुधार करें
- **समुदाय में भागीदारी**: चर्चा में शामिल हों और उपयोगकर्ताओं की सहायता करें
- **प्रेम से समर्थन**: परियोजना के विकास का समर्थन करें (धन, सर्वर आदि तक सीमित नहीं) <[kofi](https://ko-fi.com/hiramwong)> <[爱发电](https://ifdian.net/a/hiram)>
