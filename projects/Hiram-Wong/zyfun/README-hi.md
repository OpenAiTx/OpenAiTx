...
zyfun एक निःशुल्क, अत्यंत सरल, सर्व-समर्थ क्रॉस-प्लेटफॉर्म मीडिया मैनेजर है, जो एक ही स्थान पर T1-T4 सभी प्रकार के संसाधनों का प्रबंधन करता है। इसमें मल्टी-कोर प्लेयर इनबिल्ट है जिसे आप मनचाहे तरीके से स्विच कर सकते हैं। अनूठा बॉस की (Boss Key) — एक क्लिक में छुपाएं, बेफिक्र काम करें। फिल्मों के माध्यम से दुनिया को जानें!

<details>
<summary>सॉफ़्टवेयर स्क्रीनशॉट देखने के लिए विस्तार करें</summary>

|                   फ़िल्में                    |                   लाइव                   |
| :-----------------------------------------: | :--------------------------------------: |
|  ![फ़िल्में](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-film.png)   | ![लाइव](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-live.png) |
|                  **इतिहास**                  |                 **प्ले**                  |
| ![इतिहास](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-history.png) | ![प्ले](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-play.png) |
...
- केवल Github पर जारी, कृपया धोखा न खाएं; सभी व्यवस्थापकों से अनुरोध है कि इस सॉफ़्टवेयर का प्रचार या ट्रैफ़िक न बढ़ाएं।
- वैध रूप से फिल्में देखने का दृढ़ समर्थन, यह सॉफ़्टवेयर केवल प्लेयर टूल है, संसाधन संग्रहण या वितरण में शामिल नहीं है।
- केवल व्यक्तिगत अध्ययन और चर्चा हेतु, कृपया 24 घंटे के भीतर स्वयं ही अनइंस्टॉल करें, व्यावसायिक उपयोग न करें।
- पूर्व में [ZY-Player](https://github.com/Hunlongyu/ZY-Player) से लिया गया, आइकन @fourbeauty द्वारा डिज़ाइन किया गया।
- उपयोग प्रारंभ करने से पूर्व कृपया उपयोगकर्ता अनुबंध को ध्यानपूर्वक पढ़ें और सहमत हों, तथा संबंधित नियमों का पालन करें।

## 💻 क्रॉस-प्लेटफॉर्म विवरण

- **MacOS**:
  - डेटाबेस/फाइल/प्लगइन/लॉग पथ: `~/Library/Application Support/zyfun/`
  - बाइनरी पथ: `~/.zy/bin/`
- **Linux**:
  - डेटाबेस/फाइल/प्लगइन/लॉग पथ: `~/.config/zyfun/`
  - बाइनरी पथ: `~/.zy/bin/`
- **Windows**:
  - डेटाबेस/फाइल/प्लगइन/लॉग पथ: `%USERPROFILE%\AppData\Roaming\zyfun\`
  - बाइनरी पथ: `%USERPROFILE%\.zy\bin\`
  <!-- - **OpenHarmony**:
  - डेटाबेस/फाइल/प्लगइन/लॉग पथ: `/data/storage/zyfun/base/files/log`
  - बाइनरी पथ: `~/.zy/bin/`-->

## 🛠️ डाउनलोड एवं इंस्टॉल करें

> **डेवलपमेंट वर्शन डाउनलोड**: Github अकाउंट से लॉगिन आवश्यक

> **न्यूनतम आवश्यकता**: क्रोमियम इंजन के अनुरूप

| ऑपरेटिंग सिस्टम | x64 | arm64 | loong64 | रिलीज़                                                                                                                                                                                                                     | डेवलपमेंट वर्शन                                                               | न्यूनतम आवश्यकता   |
| :------------: | :-: | :---: | :-----: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------- |
...
|  Linux         | ✅  |  ✅   |   ❌    | [GitHub](https://github.com/Hiram-Wong/zyfun/releases) <br/> [如意玲珑应用商店](https://store.linyaps.org.cn/) <br/> [AUR सॉफ़्टवेयर पैकेज](https://aur.archlinux.org/packages?O=0&SeB=nd&K=zyfun&outdated=&SB=p&SO=d&PP=50&submit=Go) | [GitHub](https://github.com/Hiram-Wong/zyfun/actions/workflows/nightly-build.yml) |                   |
| Harmony        | ❌  |  ❌   |   ➖    |                                                                                                                                                                                                                            |                                                                               |

<details>
<summary>इंस्टॉल करने की समस्याएँ देखने के लिए विस्तार से क्लिक करें</summary>

#### MacOS इंस्टॉल के बाद खोलने पर दिखाता है "फाइल खराब है"
...
#### Linux Appimage चलाने में विफल

> रूट के रूप में --no-sandbox के बिना चलाना समर्थित नहीं है

```bash
./zyfun.AppImage --no-sandbox
```

> dlopen() : libfuse.so.2 लोड करने में त्रुटि

```bash
sudo apt-get install libfuse2
```

> प्रारंभिकरण के दौरान त्रुटियों के कारण GPU प्रक्रिया समाप्त हो रही है

```bash
xhost +
```

#### Linux deb पैकेज इंस्टॉलेशन विफल

> पैकेज libnss3-1d इंस्टॉल नहीं है

```bash
sudo apt-get install libnss3-1d
```

> पैकेज libxss1 इंस्टॉल नहीं है

```bash
sudo apt-get install libxss1
```

#### Linux rpm पैकेज इंस्टॉल विफल

> निर्भरता जांच विफल हुई, libXScrnSaver आवश्यक है
...
> निर्भरता जांच विफल हुई xdg-utils आवश्यक है
...
> कृपया डेटा संरचना के अनुसार ही डेटा आयात करें, अनावश्यक त्रुटियों से बचें (जैसे डेटा फ़ील्ड प्रकार का मेल न होना)

<details>
<summary>इंटरफ़ेस विवरण देखने के लिए विस्तार करें</summary>
...
नीचे कुछ तरीके दिए गए हैं जिनसे आप योगदान कर सकते हैं:

- **कोड योगदान करें**: नई सुविधाएँ विकसित करें या मौजूदा कोड का अनुकूलन करें <[डेवलपमेंट दस्तावेज़](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Develop.md)> <[Mcp दस्तावेज़](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Mcp.md)>
- **बग ठीक करें**: आपके द्वारा पाए गए किसी भी बग की फिक्स सबमिट करें <[सबमिशन मानदंड](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Conventional_Commits.md)>
- **इश्यू का रखरखाव करें**: GitHub इश्यू के प्रबंधन में मदद करें
- **प्रोडक्ट डिज़ाइन**: डिज़ाइन चर्चाओं में भाग लें
- **डॉक्युमेंटेशन लिखें**: यूज़र मैनुअल और गाइड को बेहतर बनाएं
- **समुदाय में भाग लें**: चर्चाओं में शामिल हों और यूज़र्स की मदद करें
...
- [NodeSupport](https://github.com/NodeSeekDev/NodeSupport) ने इस परियोजना को प्रायोजित किया है
