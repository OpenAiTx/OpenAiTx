...
zyfun এটা বিনামূলীয়া, অতিসৰল, বহুমুখী, বহু-প্লেটফৰ্মৰ অডিঅ'ভিজুৱেল মেনেজাৰ, যি একে ঠাইৰ পৰা T1-T4 সকলো ধৰণৰ ৰিছৰ্ছ একেটা স্থানত পৰিচালনা কৰিব পাৰে, ভিতৰি সংলগ্ন বহু-কোৰ প্লেয়াৰ ইচ্ছামতে সলনি কৰিব পাৰি। একমাত্ৰ 'বস-কী' ব্যৱস্থা, এটা বুটামত অদৃশ্য হৈ নিৰ্ভয়ে কাম-নকৰা। চিনেমা চাই বিশ্ব আৱিষ্কাৰ কৰক!

<details>
<summary>ছফ্টৱেৰ স্ক্ৰীনচট চাই দেখুৱাওক</summary>

|                    চলচ্চিত্ৰ                     |                   লাইভ                   |
| :-----------------------------------------: | :--------------------------------------: |
|  ![চলচ্চিত্ৰ](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-film.png)   | ![লাইভ](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-live.png) |
|                  **ইতিহাস**                   |                 **প্লে**                 |
| ![ইতিহাস](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-history.png) | ![প্লে](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-play.png) |

</details>

## 🌴 মন দিবলগীয়া বিষয়

- কেৱল Github ত প্ৰকাশ কৰা হৈছে, অনুগ্ৰহ কৰি ধোকা নাখোৱা; সকলো পৰিচালকক অনুৰোধ, এই ছফ্টৱেৰক প্ৰচাৰ বা ডাঙৰ কৰা নকৰিব।
- বৈধভাৱে চলচ্চিত্ৰ চোৱাৰ জোৰদাৰ倡না, এই ছফ্টৱেৰ কেৱল প্লে টুল হিচাপে ব্যৱহাৰ কৰা হৈছে, উৎস সংৰক্ষণ বা বিতৰণৰ সৈতে জড়িত নহয়।
- কেৱল ব্যক্তিগত অধ্যয়ন আৰু বিনিময়ৰ বাবে, ২৪ ঘণ্টাৰ ভিতৰত স্ব-ইচ্ছাৰে আনইনষ্টল কৰক, বাণিজ্যিক উদ্দেশ্যত ব্যৱহাৰ নকৰিব।
- পূৰ্বৱৰ্তী [ZY-Player](https://github.com/Hunlongyu/ZY-Player) ৰ পৰা আহিছে, আইকন @fourbeauty দ্বাৰা ডিজাইন কৰা।
- ব্যৱহাৰ আৰম্ভ কৰাৰ আগতে, অনুগ্ৰহ কৰি ব্যৱহাৰকাৰী চুক্তি সম্পূর্ণ পঢ়ক আৰু একমত হ’ব, প্ৰাসংগিক নিয়ম মানি চলা নিশ্চিত কৰক।

## 💻 ক্ৰছ-প্লেটফর্ম ব্যাখ্যা

- **MacOS**:
  - ডাটাবেছ/ফাইল/প্লাগইন/লগ পথ: `~/Library/Application Support/zyfun/`
  - বাইনারি পথ: `~/.zy/bin/`
- **Linux**:
  - ডাটাবেছ/ফাইল/প্লাগইন/লগ পথ: `~/.config/zyfun/`
  - বাইনারি পথ: `~/.zy/bin/`
- **Windows**:
  - ডাটাবেছ/ফাইল/প্লাগইন/লগ পথ: `%USERPROFILE%\AppData\Roaming\zyfun\`
  - বাইনারি পথ: `%USERPROFILE%\.zy\bin\`
  <!-- - **OpenHarmony**:
  - ডাটাবেছ/ফাইল/প্লাগইন/লগ পথ: `/data/storage/zyfun/base/files/log`
  - বাইনারি পথ: `~/.zy/bin/`-->

## 🛠️ ডাউনলোড আৰু ইনষ্টল

> **ডেভেলপমেন্ট সংস্কৰণ ডাউনলোড**: Github একাউণ্ট লগইন কৰা প্ৰয়োজন

> **নূন্যতম প্ৰয়োজন**: chromium ইঞ্জিনৰ প্ৰয়োজনৰ সৈতে মিল থকা

| অপাৰেটিং ছিস্টেম | x64 | arm64 | loong64 | সংস্কৰণ                                                                                                                                                                                                                      | ডেভেলপমেন্ট                                                                            | নূন্যতম প্ৰয়োজন   |
| :------: | :-: | :---: | :-----: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ---------- |
...
<details>
<summary>ইনষ্টল সমস্যাবোৰ চাবলৈ বিস্তাৰিত কৰক</summary>

#### MacOS ইনষ্টল কৰাৰ পিছত খুলিলে "ফাইল ক্ষতিগ্ৰস্ত" বুলি কয়
...
#### Linux Appimage চলোৱা অসফল

> root হিচাপে --no-sandbox নোহোৱাকৈ চলোৱা সমৰ্থিত নহয়

```bash
./zyfun.AppImage --no-sandbox
```

> dlopen()ঃ libfuse.so.2 লোড কৰোঁতে ত্ৰুটি

```bash
sudo apt-get install libfuse2
```

> আৰম্ভণি সময়ত ত্ৰুটি ঘটাৰ বাবে GPU প্ৰক্ৰিয়াটোৰ পৰা বাহিৰ হৈ আছে

```bash
xhost +
```

#### Linux deb পেকেজ স্থাপনত বিফল

> Package libnss3-1d স্থাপন কৰা হোৱা নাই
...
#### Linux rpm পেকেজ স্থাপন বিফল

> নিৰ্ভৰতা পৰীক্ষা বিফল হৈছে libXScrnSaver আৱশ্যক
...
> নিৰ্ভৰশীলতা পৰীক্ষা বিফল xdg-utils আৱশ্যক
...
> অনুগ্ৰহ কৰি ডাটা গঠন অনুসৰি ডাটা প্ৰৱেশ কৰক, অপ্ৰয়োজনীয় ত্ৰুটি (যেনে ডাটা ক্ষেত্ৰৰ ধৰণ মিল নোহোৱা) এৰাই চলিবলৈ

<details>
<summary>ইন্টাৰফেচৰ বিৱৰণ চাবলৈ বিস্তৃত কৰক</summary>
...
তলত কিছু উপায় দিয়া হৈছে যাৰ জৰিয়তে আপুনি অৱদান আগবঢ়াব পাৰে:

- **কোড অৱদান**: নতুন ফিচাৰ বিকাশ কৰক বা বিদ্যমান কোড উন্নত কৰক <[উন্নয়ন নথি](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Develop.md)> <[Mcp নথি](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Mcp.md)>
- **ত্ৰুটি সমাধান**: আপুনি পোৱা যিকোনো ত্ৰুটিৰ সমাধান জমা দিয়ক <[জমা দিয়াৰ নিয়ম](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Conventional_Commits.md)>
- **সমস্যা পৰিচালনা**: GitHub সমস্যাসমূহ ব্যৱস্থাপনা কৰাত সহায় কৰক
- **উৎপাদন নক্সা**: নক্সা আলোচনা সমূহত অংশ গ্ৰহণ কৰক
- **নথিপত্ৰ লিখন**: ব্যৱহাৰকাৰী ম্যানুয়েল আৰু গাইডসমূহ উন্নত কৰক
- **সম্প্ৰদায়ৰ অংশগ্ৰহণ**: আলোচনা যোগদান কৰক আৰু ব্যৱহাৰকাৰীসকলক সহায় কৰক
...
- [NodeSupport](https://github.com/NodeSeekDev/NodeSupport) এই প্ৰকল্পটো পৃষ্ঠপোষকতা কৰিছে
