...
> Завершение процесса GPU из-за ошибок при инициализации

```bash
xhost +
```

#### Сбой установки deb-пакета в Linux
...
> Проверка зависимостей не пройдена: требуется xdg-utils
...
> Пожалуйста, строго следуйте структуре данных при импорте данных, чтобы избежать ненужных ошибок (например, несоответствие типов данных в полях)
