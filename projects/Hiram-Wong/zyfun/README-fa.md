<div align="right">
  <details>
    ...
    <div>
      <div align="center">
        <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=en">انگلیسی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=zh-CN">چینی ساده</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=zh-TW">چینی سنتی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=ja">ژاپنی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=ko">کره‌ای</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=hi">هندی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=th">تایلندی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=fr">فرانسوی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=de">آلمانی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=es">اسپانیایی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=it">ایتالیایی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=ru">روسی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=pt">پرتغالی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=nl">هلندی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=pl">لهستانی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=ar">عربی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=fa">فارسی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=tr">ترکی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=vi">ویتنامی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=id">اندونزیایی</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=zyfun&lang=as">آسامی</a>
      </div>
    </div>
  </details>
</div>
...
zyfun یک نرم‌افزار رایگان، مینیمال و همه‌کاره مدیریت رسانه بین‌پلتفرمی است که مدیریت یکپارچه منابع T1 تا T4 را ارائه می‌دهد و پخش‌کننده چند‌هسته‌ای داخلی را برای جابجایی دلخواه فراهم کرده است. کلید مخصوص مخفی‌سازی، تنها با یک کلیک برای پنهان‌کردن فوری، خیالتان را راحت می‌کند. با تماشای فیلم، دنیا را کشف کنید!

<details>
<summary>کلیک کنید تا تصاویر نرم‌افزار را ببینید</summary>

|                     فیلم                   |                  پخش زنده                |
| :-----------------------------------------: | :--------------------------------------: |
|  ![فیلم](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-film.png)   | ![پخش زنده](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-live.png) |
|                   **تاریخچه**              |                   **پخش**                |
| ![تاریخچه](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-history.png) | ![پخش](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/assets/images/app-play.png) |

</details>

## 🌴 نکات مهم
- فقط از طریق گیت‌هاب منتشر می‌شود، لطفاً فریب نخورید؛ از مدیران محترم درخواست می‌شود نرم‌افزار را تبلیغ یا جذب کاربر نکنند.
- به شدت استفاده قانونی از محتوای دیداری را توصیه می‌کنیم، این نرم‌افزار تنها به عنوان ابزار پخش مورد استفاده قرار می‌گیرد و دخالتی در ذخیره یا توزیع منابع ندارد.
- فقط برای یادگیری و تبادل شخصی ارائه شده است، لطفاً ظرف ۲۴ ساعت به طور خودجوش حذف کنید و از استفاده تجاری بپرهیزید.
- نسخه اولیه از [ZY-Player](https://github.com/Hunlongyu/ZY-Player) گرفته شده است، آیکون توسط @fourbeauty طراحی شده است.
- لطفاً پیش از شروع استفاده، حتماً توافق‌نامه کاربری را با دقت مطالعه و قبول کنید تا از رعایت مقررات مربوطه اطمینان حاصل نمایید.

## 💻 توضیحات چندسکویی

- **MacOS**:
  - مسیر پایگاه داده/فایل/افزونه/لاگ: `~/Library/Application Support/zyfun/`
  - مسیر باینری: `~/.zy/bin/`
- **Linux**:
  - مسیر پایگاه داده/فایل/افزونه/لاگ: `~/.config/zyfun/`
  - مسیر باینری: `~/.zy/bin/`
- **Windows**:
  - مسیر پایگاه داده/فایل/افزونه/لاگ: `%USERPROFILE%\AppData\Roaming\zyfun\`
  - مسیر باینری: `%USERPROFILE%\.zy\bin\`
  <!-- - **OpenHarmony**:
  - مسیر پایگاه داده/فایل/افزونه/لاگ: `/data/storage/zyfun/base/files/log`
  - مسیر باینری: `~/.zy/bin/`-->

## 🛠️ دانلود و نصب

> **دانلود نسخه توسعه‌دهنده**: نیاز به ورود به حساب گیت‌هاب دارد

> **حداقل نیازمندی‌ها**: مطابق با نیازهای هسته کرومیوم

| سیستم عامل | x64 | arm64 | loong64 | نسخه انتشار                                                                                                                                                                                                                   | نسخه توسعه‌دهنده                                                                | حداقل نیاز |
| :--------: | :-: | :---: | :-----: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | ----------- |
| ویندوز     | ✅  |  ✅   |   ➖    | [GitHub](https://github.com/Hiram-Wong/zyfun/releases)                                                                                                                                                                       | [GitHub](https://github.com/Hiram-Wong/zyfun/actions/workflows/nightly-build.yml) | >= win10    |
|  مک‌اواس   | ✅  |  ✅   |   ➖    | [GitHub](https://github.com/Hiram-Wong/zyfun/releases)                                                                                                                                                                       | [GitHub](https://github.com/Hiram-Wong/zyfun/actions/workflows/nightly-build.yml) | >= macOS12  |
|  لینوکس    | ✅  |  ✅   |   ❌    | [GitHub](https://github.com/Hiram-Wong/zyfun/releases) <br/> [فروشگاه برنامه RuiYiLingLong](https://store.linyaps.org.cn/) <br/> [بسته AUR](https://aur.archlinux.org/packages?O=0&SeB=nd&K=zyfun&outdated=&SB=p&SO=d&PP=50&submit=Go) | [GitHub](https://github.com/Hiram-Wong/zyfun/actions/workflows/nightly-build.yml) |              |
| Harmony    | ❌  |  ❌   |   ➖    |                                                                                                                                                                                                                              |                                                                                   |

<details>
<summary>برای مشاهده مشکلات نصب کلیک کنید</summary>

#### مک‌اواس پس از نصب پیام «فایل خراب است» نمایش می‌دهد
...
#### اجرای Appimage لینوکس با شکست مواجه شد

> اجرای به عنوان کاربر root بدون --no-sandbox پشتیبانی نمی‌شود

```bash
./zyfun.AppImage --no-sandbox
```

> dlopen()‎: خطا در بارگذاری ‎libfuse.so.2

```bash
sudo apt-get install libfuse2
```

> خروج از فرایند GPU به دلیل خطاها در هنگام مقداردهی اولیه

```bash
xhost +
```

#### نصب بسته deb لینوکس با شکست مواجه شد
...
> بسته libxss1 نصب نشده است

```bash
sudo apt-get install libxss1
```

#### نصب بسته rpm لینوکس با شکست مواجه شد

> بررسی وابستگی ناموفق بود، به libXScrnSaver نیاز است
...
> بررسی وابستگی ناموفق بود xdg-utils مورد نیاز است
...
> لطفاً داده‌ها را دقیقاً مطابق با ساختار داده وارد کنید تا از خطاهای غیرضروری (مانند عدم تطابق نوع فیلد داده) جلوگیری شود.

<details>
<summary>برای مشاهده توضیحات واسط کلیک کنید</summary>
...
در اینجا چند روش برای مشارکت شما آورده شده است:

- **مشارکت در کدنویسی**: توسعه قابلیت‌های جدید یا بهینه‌سازی کد موجود <[مستندات توسعه](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Develop.md)> <[مستندات Mcp](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Mcp.md)>
- **رفع اشکال**: ارسال اصلاحیه برای هرگونه اشکال کشف‌شده <[استاندارد ارسال](https://raw.githubusercontent.com/Hiram-Wong/zyfun/main/docs/Conventional_Commits.md)>
- **مدیریت مسائل**: کمک به مدیریت مسائل (Issues) گیت‌هاب
- **طراحی محصول**: مشارکت در بحث‌های طراحی
- **مستندسازی**: بهبود راهنمای کاربر و مستندات
- **مشارکت در جامعه**: پیوستن به بحث‌ها و کمک به کاربران
...
- [NodeSupport](https://github.com/NodeSeekDev/NodeSupport) حامی این پروژه بوده است
