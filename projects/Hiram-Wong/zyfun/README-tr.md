...
#### Linux Appimage Başarısız Oldu

> Kök olarak --no-sandbox olmadan çalıştırmak desteklenmiyor

```bash
./zyfun.AppImage --no-sandbox
```

> dlopen()：libfuse.so.2 yüklenirken hata oluştu
...
#### Linux deb paketi yüklemesi başarısız

> Paket libnss3-1d yüklü değil

```bash
sudo apt-get install libnss3-1d
```

> Paket libxss1 kurulu değil
...
> Lütfen verileri kesinlikle veri yapısına uygun olarak içe aktarın, gereksiz hata mesajlarından kaçının (ör: veri alanı türü uyumsuzluğu)

<details>
<summary>Arayüz açıklamasını görüntülemek için tıklayın</summary>
