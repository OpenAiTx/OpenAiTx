...
> データ構造に厳密に従ってデータをインポートしてください。不必要なエラー（例えばデータフィールド型の不一致）を避けるためです。

<details>
<summary>インターフェース説明を展開して表示</summary>
...
- [NodeSupport](https://github.com/NodeSeekDev/NodeSupport) が本プロジェクトをスポンサーしています
