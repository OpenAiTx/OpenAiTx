...
> Thoát khỏi tiến trình GPU do lỗi trong quá trình khởi tạo

```bash
xhost +
```

#### Cài đặt gói deb trên Linux thất bại
...
> Kiểm tra phụ thuộc thất bại xdg-utils là cần thiết
...
> Vui lòng nhập dữ liệu đúng theo cấu trúc dữ liệu, tránh các lỗi không cần thiết (ví dụ như kiểu trường dữ liệu không khớp)

<details>
<summary>Nhấn để xem giải thích về giao diện</summary>
...
<a href="https://www.star-history.com/#Hiram-Wong/zyfun&Date">
 <picture>
   ...
   <img alt="Biểu đồ lịch sử Star" src="https://api.star-history.com/svg?repos=Hiram-Wong/zyfun&type=Date" />
 </picture>
</a>
