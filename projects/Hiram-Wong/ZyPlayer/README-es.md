...
`zyfun` es un cliente de escritorio para reproductor multimedia gratuito y fácil de usar, compatible con Windows, Mac y Linux.

## 🌴 Avisos

- Solo se publica en Github, no se deje engañar; se ruega a los administradores no promocionar ni atraer tráfico a este software.
- Se fomenta firmemente la visualización legal; este software es solo una herramienta de reproducción y no almacena ni distribuye recursos.
- Solo para uso personal de aprendizaje y comunicación, desinstale conscientemente dentro de las 24 horas, no para fines comerciales.
- Algunas ideas provienen de [ZY-Player](https://github.com/Hunlongyu/ZY-Player), agradecimientos a [@fourbeauty] por los materiales de iconos.
- Antes de comenzar a usarlo, lea y acepte el acuerdo de usuario para asegurar el cumplimiento de las regulaciones.

## 🌟 Características principales

- **Amplia compatibilidad**: Soporte multiplataforma para Windows, Mac y Linux.
- **Modo oscuro**: Adaptado para uso nocturno, protege la vista.
- **Acceso a recursos**: Gestión sencilla de CMS en formatos json, xml, etc.
- **Soporte IPTV**: Reproducción fluida de formatos m3u, genre, etc.
- **Ocultación rápida**: Tecla de jefe incorporada para protección de privacidad con un solo clic.
- **Múltiples reproductores**: Núcleos de varios reproductores integrados para diferentes necesidades.
- **Más contenido**: Descúbralo por usted mismo...


## 🖼️ Vista previa del software

<details>
<summary>Expandir para ver capturas de pantalla del software</summary>

|                            Películas (Inicio)                            |                            Películas (Buscar)                            |
| :----------------------------------------------------------------------: | :----------------------------------------------------------------------: |
| ![Películas-Inicio](https://s2.loli.net/2024/07/20/T8diRvA1q2QaJmP.png) | ![Películas-Buscar](https://s2.loli.net/2024/07/20/utwCUsVG6c7ShRJ.png)  |
|                            Películas (Reproducción)                      |                            Análisis (Inicio)                            |
| ![Películas-Reproducir](https://s2.loli.net/2024/07/20/DNFBu3LphASROVy.png) | ![Análisis-Inicio](https://s2.loli.net/2024/07/20/JZANVebW4EHOU7I.png)   |
|                            Transmisión en vivo (Inicio)                  |                            Transmisión en vivo (Reproducir)              |
| ![Transmisión-Inicio](https://s2.loli.net/2024/07/20/ucxSw3nR2EahG59.png) | ![Transmisión-Reproducir](https://s2.loli.net/2024/07/20/jYEFc6NOwtdWJBV.png) |
|                             Historial                                  |                               Configuración                               |
| ![Historial](https://s2.loli.net/2024/07/20/DiYsx4fbcH3KU6T.png)         |   ![Configuración](https://s2.loli.net/2024/07/20/QeaDxZ2IYCFoVki.png)   |
...
- **MacOS**:
  - Paquetes de instalación para arquitecturas arm64 (chip Apple) / x64 (chip Intel)
  - Ruta de base de datos/archivos/plugins/logs: `~/Library/Application\ Support/zyfun/`
  - Ruta binaria: `~/.zy/bin/`
- **Linux**:
  - Paquetes image/deb para arquitecturas arm64/x64
  - Ruta de base de datos/archivos/plugins/logs: `~/.config/zyfun/`
  - Ruta binaria: `~/.zy/bin`
- **Windows**:
  - Paquetes de instalación para arquitecturas arm64/x64
  - Ruta de base de datos/archivos/plugins/logs: `%USERPROFILE%\AppData\Roaming\zyfun\`
  - Ruta binaria: `%USERPROFILE%\.zy\bin`
  <!-- - **OpenHarmony**:
  - Paquetes de instalación para arquitecturas arm64/x64
  - Ruta de base de datos/archivos/plugins/logs: `/data/storage/zyfun/base/files/log`
  - Ruta binaria: `~/.zy/bin`-->

## 🛠️ Instalación y descarga

> **Descarga de la última versión publicada**: Visita la [página de lanzamientos de GitHub](https://github.com/Hiram-Wong/ZyPlayer/releases) para obtenerla.

> **Descarga de la última versión en desarrollo**: Visite la [página de GitHub Actions](https://github.com/Hiram-Wong/ZyPlayer/actions) para obtenerla, se requiere iniciar sesión en la cuenta de Github.

### Al abrir en MacOS después de la instalación aparece el mensaje "El archivo está dañado"
...
```
### Error al ejecutar Linux Appimage
...
### Error en la instalación de Linux deb
...
> Por favor, complete estrictamente según la estructura de datos para evitar errores innecesarios (como incompatibilidad de tipos de campos de datos)

> Para la fusión de datos, primero exporte manualmente, luego edite los datos antes de importarlos (la importación directa en el software sobrescribirá los datos)

<details>
<summary>Expandir para ver la descripción de la interfaz</summary>
...
[Documentación de desarrollo](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Develop.md)
...
<a href="https://www.star-history.com/#Hiram-Wong/ZyPlayer&Date">
 <picture>
   ...
   <img alt="Gráfico de historial de estrellas" src="https://api.star-history.com/svg?repos=Hiram-Wong/ZyPlayer&type=Date" />
 </picture>
</a>
