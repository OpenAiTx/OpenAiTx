...
### Linux Appimage çalıştırılamadı
...
> Başlatma sırasında oluşan hatalar nedeniyle GPU işlemi sonlandırılıyor
...
> Lütfen verileri kesinlikle veri yapısına uygun şekilde aktarın, gereksiz hata mesajlarından kaçının (ör. veri alanı türü uyumsuzluğu)

<details>
<summary>Arayüz açıklamasını görmek için açın</summary>
...
- **Kod katkısı**: Yeni özellikler geliştirin veya mevcut kodu optimize edin <[Geliştirme Dokümanı](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Develop.md)>
- **Hata düzeltme**: Karşılaştığınız hataları düzeltin ve gönderin <[Gönderim Standartları](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Conventional_Commits.md)>
- **Sorun yönetimi**: GitHub sorunlarını yönetmeye yardımcı olun
- **Ürün tasarımı**: Tasarım tartışmalarına katılın
- **Dokümantasyon yazımı**: Kullanıcı kılavuzlarını ve rehberleri iyileştirin
