...
zyfun هو مدير وسائط متعدد المنصات مجاني، بسيط للغاية، وقوي، لإدارة جميع أنواع الموارد من T1 إلى T4 في مكان واحد، مع مشغل داخلي متعدد النوى يمكنك التبديل بينه بسهولة. زر الإخفاء الحصري يتيح لك الاختفاء بنقرة واحدة والقيام بمهامك دون قلق. اكتشف العالم من خلال المشاهدة!

<details>
<summary>انقر هنا لمشاهدة لقطات من البرنامج</summary>

|                    الأفلام                     |                   البث المباشر                   |
| :-----------------------------------------: | :--------------------------------------: |
|  ![الأفلام](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/assets/images/app-film.png)   | ![البث المباشر](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/assets/images/app-live.png) |
|                  **السجل**                   |                 **التشغيل**                 |
| ![السجل](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/assets/images/app-history.png) | ![التشغيل](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/assets/images/app-play.png) |

</details>

## 🌴 ملاحظات هامة

- يصدر هذا البرنامج فقط عبر Github، يرجى عدم الوقوع في عمليات الاحتيال؛ يُرجى من جميع المدراء عدم الترويج أو جذب المستخدمين لهذا البرنامج.
- نحث بشدة على المشاهدة القانونية، هذا البرنامج هو أداة تشغيل فقط ولا يتضمن تخزين أو توزيع أي مصادر.
- مخصص فقط للتعلم والتبادل الشخصي، يرجى إزالته ذاتياً خلال 24 ساعة وعدم استخدامه لأغراض تجارية.
- المصدر السابق من [ZY-Player](https://github.com/Hunlongyu/ZY-Player)، الأيقونة من تصميم @fourbeauty.
- قبل البدء في الاستخدام، يُرجى قراءة اتفاقية المستخدم بعناية والموافقة عليها، لضمان الالتزام بالتعليمات.

## 💻 شرح الدعم عبر الأنظمة

- **ماك أو إس**:
  - متوفر حزم تثبيت لمعمارية arm64 (رقاقة أبل)/x64 (رقاقة إنتل)
  - مسار قاعدة البيانات/الملفات/الإضافات/السجلات: `~/Library/Application Support/zyfun/`
  - مسار الملفات التنفيذية: `~/.zy/bin/`
- **لينكس**:
  - متوفر حزم تثبيت لمعمارية arm64/x64 (image/deb)
  - مسار قاعدة البيانات/الملفات/الإضافات/السجلات: `~/.config/zyfun/`
  - مسار الملفات التنفيذية: `~/.zy/bin/`
- **ويندوز**:
  - متوفر حزم تثبيت لمعمارية arm64/x64
...
> **تحميل الإصدار الأحدث**: قم بزيارة [صفحة الإصدارات على GitHub](https://github.com/Hiram-Wong/ZyPlayer/releases) للحصول عليه

> **تحميل أحدث نسخة تطويرية**: قم بزيارة [صفحة Github Actions](https://github.com/Hiram-Wong/ZyPlayer/actions/workflows/nightly-build.yml)، يتطلب تسجيل الدخول إلى حساب Github
...
### فشل تثبيت حزمة rpm على لينكس

> فشل التحقق من الاعتماديات libXScrnSaver مطلوب
...
> فشل التحقق من الاعتماد، أداة xdg-utils مطلوبة
