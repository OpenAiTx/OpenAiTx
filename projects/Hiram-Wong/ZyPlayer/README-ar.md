...
zyfun هو مدير وسائط مجاني، بسيط، وقوي متعدد المنصات، لإدارة جميع أنواع الموارد T1-T4 في مكان واحد، مع مشغل مدمج متعدد النوى قابل للتبديل بحرية. مفتاح رئيس حصري، بنقرة واحدة للاختفاء والعمل بسرية. اكتشف العالم من خلال مشاهدة الأفلام!

<details>
<summary>انقر لعرض لقطات الشاشة للبرنامج</summary>

|                            الأفلام (الرئيسية)                           |                            الأفلام (بحث)                           |
| :--------------------------------------------------------------: | :--------------------------------------------------------------: |
| ![الأفلام-الرئيسية](https://s2.loli.net/2024/07/20/T8diRvA1q2QaJmP.png) | ![الأفلام-بحث](https://s2.loli.net/2024/07/20/utwCUsVG6c7ShRJ.png) |
|                            الأفلام (تشغيل)                            |                            التحليل (الرئيسية)                            |
| ![الأفلام-تشغيل](https://s2.loli.net/2024/07/20/DNFBu3LphASROVy.png)  | ![التحليل-الرئيسية](https://s2.loli.net/2024/07/20/JZANVebW4EHOU7I.png) |
|                            البث المباشر (الرئيسية)                            |                            البث المباشر (تشغيل)                            |
| ![البث المباشر-الرئيسية](https://s2.loli.net/2024/07/20/ucxSw3nR2EahG59.png) | ![البث المباشر-تشغيل](https://s2.loli.net/2024/07/20/jYEFc6NOwtdWJBV.png) |
|                             سجل التاريخ                             |                               الإعدادات                               |
| ![سجل التاريخ](https://s2.loli.net/2024/07/20/DiYsx4fbcH3KU6T.png)  |   ![الإعدادات](https://s2.loli.net/2024/07/20/QeaDxZ2IYCFoVki.png)    |

</details>

## 🌴 ملاحظات هامة

- النشر حصري على Github فقط، يرجى عدم الوقوع ضحية لأي احتيال؛ يرجى من جميع المدراء عدم الترويج أو جذب المستخدمين لهذا البرنامج.
- نحث بشدة على المشاهدة القانونية، هذا البرنامج يُستخدم فقط كأداة تشغيل ولا يتضمن تخزين أو توزيع الموارد.
- مخصص فقط للتعلم والتبادل الشخصي، يرجى إزالته ذاتيًا خلال 24 ساعة وعدم استخدامه لأغراض تجارية.
- المصدر الأساسي من [ZY-Player](https://github.com/Hunlongyu/ZY-Player)، والأيقونات من تصميم @fourbeauty.
- يرجى قراءة اتفاقية المستخدم بعناية والموافقة عليها قبل بدء الاستخدام، والتأكد من الالتزام باللوائح ذات الصلة.

## 💻 شرح عبر الأنظمة

- **MacOS**:
  - توفر حزم تثبيت بمعمارية arm64 (رقاقة أبل)/x64 (رقاقة إنتل)
  - مسارات قاعدة البيانات/الملفات/الإضافات/السجلات: `~/Library/Application Support/zyfun/`
  - مسار الملفات التنفيذية: `~/.zy/bin/`
- **Linux**:
  - توفر حزم تثبيت للمعماريات arm64/x64-image/deb
  - مسارات قاعدة البيانات/الملفات/الإضافات/السجلات: `~/.config/zyfun/`
  - مسار الملفات التنفيذية: `~/.zy/bin/`
- **Windows**:
  - توفر حزم تثبيت للمعماريات arm64/x64
  - مسارات قاعدة البيانات/الملفات/الإضافات/السجلات: `%USERPROFILE%\AppData\Roaming\zyfun\`
  - مسار الملفات التنفيذية: `%USERPROFILE%\.zy\bin\`
  <!-- - **OpenHarmony**:
  - توفر حزم تثبيت للمعماريات arm64/x64
  - مسارات قاعدة البيانات/الملفات/الإضافات/السجلات: `/data/storage/zyfun/base/files/log`
  - مسار الملفات التنفيذية: `~/.zy/bin/`-->

## 🛠️ التحميل والتثبيت

> **تحميل أحدث إصدار مستقر**: قم بزيارة [صفحة الإصدارات على GitHub](https://github.com/Hiram-Wong/ZyPlayer/releases) للحصول عليه

> **تحميل أحدث إصدار تطويري**: قم بزيارة [صفحة إجراءات GitHub](https://github.com/Hiram-Wong/ZyPlayer/actions/workflows/nightly-build.yml) للحصول عليه (يتطلب تسجيل الدخول بحساب Github)
...
> التشغيل كمستخدم root بدون خيار --no-sandbox غير مدعوم
...
> يرجى استيراد البيانات وفقًا لهياكل البيانات بدقة لتجنب الأخطاء غير الضرورية (مثل عدم تطابق نوع حقل البيانات)
...
## 🤝 طرق المشاركة والمساهمة

فيما يلي بعض الطرق التي يمكنك من خلالها المساهمة:

- **المساهمة بالكود**: تطوير ميزات جديدة أو تحسين الكود الحالي <[وثائق التطوير](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Develop.md)>
- **إصلاح الأخطاء**: تقديم إصلاحات لأي أخطاء تكتشفها <[معايير التقديم](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Conventional_Commits.md)>
