...
### Linux Appimage chạy không thành công
...
> Thoát tiến trình GPU do lỗi xảy ra trong quá trình khởi tạo
...
> Vui lòng nhập dữ liệu theo đúng cấu trúc dữ liệu, tránh các lỗi không cần thiết (ví dụ như kiểu trường dữ liệu không khớp)

<details>
<summary>Nhấp để xem hướng dẫn giao diện</summary>
...
- **Đóng góp mã nguồn**: Phát triển tính năng mới hoặc tối ưu mã hiện tại <[Tài liệu phát triển](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Develop.md)>
- **Sửa lỗi**: Gửi bản sửa cho bất kỳ lỗi nào bạn phát hiện <[Quy chuẩn gửi](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Conventional_Commits.md)>
- **Quản lý vấn đề**: Hỗ trợ quản lý các vấn đề trên GitHub
- **Thiết kế sản phẩm**: Tham gia thảo luận thiết kế
- **Viết tài liệu**: Cải thiện hướng dẫn và tài liệu người dùng
...
<a href="https://www.star-history.com/#Hiram-Wong/ZyPlayer&Date">
 <picture>
   ...
   <img alt="Biểu đồ lịch sử Star" src="https://api.star-history.com/svg?repos=Hiram-Wong/ZyPlayer&type=Date" />
 </picture>
</a>

## 💰 Nhà tài trợ

- [NodeSupport](https://github.com/NodeSeekDev/NodeSupport) đã tài trợ dự án này
