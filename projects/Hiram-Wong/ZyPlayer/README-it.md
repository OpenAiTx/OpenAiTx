...
### Errore di esecuzione di Linux Appimage
...
> Si prega di importare i dati seguendo rigorosamente la struttura dei dati, per evitare errori inutili (come la mancata corrispondenza dei tipi di campo)

<details>
<summary>Espandi per vedere la descrizione dell'interfaccia</summary>
...
- **Contribuire al codice**: sviluppare nuove funzionalità o ottimizzare il codice esistente <[Documentazione di sviluppo](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Develop.md)>
- **Correggere errori**: invia correzioni per eventuali bug riscontrati <[Linee guida per le submission](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Conventional_Commits.md)>
- **Gestione delle issue**: aiuta a gestire le issue su GitHub
- **Progettazione del prodotto**: partecipa alle discussioni di design
- **Scrivere documentazione**: migliora il manuale utente e le guide
- **Partecipazione alla community**: unisciti alle discussioni e aiuta gli utenti
...
<a href="https://www.star-history.com/#Hiram-Wong/ZyPlayer&Date">
 <picture>
   ...
   <img alt="Grafico storico delle Star" src="https://api.star-history.com/svg?repos=Hiram-Wong/ZyPlayer&type=Date" />
 </picture>
</a>
