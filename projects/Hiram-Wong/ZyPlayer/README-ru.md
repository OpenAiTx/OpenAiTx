...
zyfun — это бесплатный, минималистичный и универсальный кроссплатформенный медиаменеджер, который позволяет управлять всеми типами ресурсов T1-T4 в одном месте. Встроенный многозадачный проигрыватель с возможностью переключения. Уникальная "клавиша босса" — мгновенное скрытие для безопасного просмотра. Откройте мир с помощью фильмов!

<details>
<summary>Развернуть для просмотра скриншотов программы</summary>

|                            Видео (Главная)                            |                            Видео (Поиск)                            |
| :-------------------------------------------------------------------: | :------------------------------------------------------------------: |
| ![Видео-Главная](https://s2.loli.net/2024/07/20/T8diRvA1q2QaJmP.png)  | ![Видео-Поиск](https://s2.loli.net/2024/07/20/utwCUsVG6c7ShRJ.png)  |
|                            Видео (Воспроизведение)                    |                            Разбор (Главная)                         |
| ![Видео-Воспроизведение](https://s2.loli.net/2024/07/20/DNFBu3LphASROVy.png) | ![Разбор-Главная](https://s2.loli.net/2024/07/20/JZANVebW4EHOU7I.png) |
|                            ТВ (Главная)                               |                            ТВ (Воспроизведение)                      |
| ![ТВ-Главная](https://s2.loli.net/2024/07/20/ucxSw3nR2EahG59.png)     | ![ТВ-Воспроизведение](https://s2.loli.net/2024/07/20/jYEFc6NOwtdWJBV.png) |
|                             История                                    |                               Настройки                               |
| ![История](https://s2.loli.net/2024/07/20/DiYsx4fbcH3KU6T.png)  |   ![Настройки](https://s2.loli.net/2024/07/20/QeaDxZ2IYCFoVki.png)    |

</details>

## 🌴 Важные замечания

- Публикуется только на Github, остерегайтесь мошенничества; администраторам запрещено рекламировать и продвигать это ПО.
- Настоятельно призывается к легальному просмотру, данное ПО — только инструмент воспроизведения, не занимается хранением или распространением ресурсов.
- Используйте только для личного обучения и обмена, удалите в течение 24 часов, не используйте в коммерческих целях.
- Проект основан на [ZY-Player](https://github.com/Hunlongyu/ZY-Player), иконка разработана @fourbeauty.
- Перед началом использования обязательно внимательно прочтите и согласитесь с пользовательским соглашением, чтобы соблюдать соответствующие правила.

## 💻 О кроссплатформенности

- **MacOS**:
  - Доступны установочные пакеты для arm64 (чип Apple)/x64 (чип Intel)
  - Путь к базе данных/файлам/плагинам/логам: `~/Library/Application Support/zyfun/`
  - Путь к бинарным файлам: `~/.zy/bin/`
- **Linux**:
  - Доступны образы/DEB-пакеты для arm64/x64
  - Путь к базе данных/файлам/плагинам/логам: `~/.config/zyfun/`
  - Путь к бинарным файлам: `~/.zy/bin/`
- **Windows**:
  - Доступны установочные пакеты для arm64/x64
...
> **Скачать последнюю версию:** Перейдите на [страницу релизов GitHub](https://github.com/Hiram-Wong/ZyPlayer/releases)

> **Скачать последнюю версию для разработчиков:** Перейдите на [GitHub Actions](https://github.com/Hiram-Wong/ZyPlayer/actions/workflows/nightly-build.yml), требуется вход в аккаунт Github

### После установки на MacOS появляется сообщение "Файл поврежден"
