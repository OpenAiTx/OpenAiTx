...
> データ構造に厳密に従ってデータをインポートしてください。不要なエラー（例：データフィールドの型が一致しないなど）を避けるためです。

<details>
<summary>クリックしてインターフェースの説明を表示</summary>
...
- **コードの貢献**：新機能の開発や既存コードの最適化 <[開発ドキュメント](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Develop.md)>
- **バグ修正**：発見したバグの修正を送信 <[コミット規約](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Conventional_Commits.md)>
- **イシューの管理**：GitHubイシューの管理をサポート
- **製品設計**：設計ディスカッションへの参加
- **ドキュメント作成**：ユーザーマニュアルやガイドの改善
- **コミュニティ参加**：ディスカッションに参加しユーザーをサポート
...
- [NodeSupport](https://github.com/NodeSeekDev/NodeSupport) は本プロジェクトをスポンサーしています
