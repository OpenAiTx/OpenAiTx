...
zyfun เป็นผู้จัดการสื่อมัลติมีเดียข้ามแพลตฟอร์มที่ฟรี เรียบง่าย และครบทุกฟังก์ชัน จัดการทรัพยากรทุกประเภท T1-T4 ในที่เดียว มาพร้อมเครื่องเล่นแบบหลายคอร์ สลับได้ตามใจ ฟีเจอร์เฉพาะ Boss Key ซ่อนหน้าจอได้ทันที ดูหนังอย่างไร้กังวล ค้นพบโลกผ่านการรับชม!

<details>
<summary>คลิกเพื่อดูภาพหน้าจอซอฟต์แวร์</summary>

|                            ภาพยนตร์(หน้าแรก)                           |                           ภาพยนตร์(ค้นหา)                           |
| :--------------------------------------------------------------: | :--------------------------------------------------------------: |
| ![ภาพยนตร์-หน้าแรก](https://s2.loli.net/2024/07/20/T8diRvA1q2QaJmP.png) | ![ภาพยนตร์-ค้นหา](https://s2.loli.net/2024/07/20/utwCUsVG6c7ShRJ.png) |
|                            ภาพยนตร์(เล่น)                            |                            การแยกวิเคราะห์(หน้าแรก)                   |
| ![ภาพยนตร์-เล่น](https://s2.loli.net/2024/07/20/DNFBu3LphASROVy.png)  | ![การแยกวิเคราะห์-หน้าแรก](https://s2.loli.net/2024/07/20/JZANVebW4EHOU7I.png) |
|                            ถ่ายทอดสด(หน้าแรก)                         |                           ถ่ายทอดสด(เล่น)                            |
| ![ถ่ายทอดสด-หน้าแรก](https://s2.loli.net/2024/07/20/ucxSw3nR2EahG59.png) | ![ถ่ายทอดสด-เล่น](https://s2.loli.net/2024/07/20/jYEFc6NOwtdWJBV.png) |
|                             ประวัติการรับชม                             |                               การตั้งค่า                              |
| ![ประวัติการใช้งาน](https://s2.loli.net/2024/07/20/DiYsx4fbcH3KU6T.png)  |   ![การตั้งค่า](https://s2.loli.net/2024/07/20/QeaDxZ2IYCFoVki.png)    |

</details>

## 🌴 ข้อควรระวัง

- เผยแพร่เฉพาะบน Github นี้เท่านั้น กรุณาอย่าหลงเชื่อมิจฉาชีพ; ผู้ดูแลทุกท่านโปรดงดประชาสัมพันธ์หรือดึงคนเข้าสู่ซอฟต์แวร์นี้
- สนับสนุนการรับชมอย่างถูกกฎหมาย ซอฟต์แวร์นี้เป็นเพียงเครื่องมือเล่นไฟล์ ไม่เกี่ยวข้องกับการจัดเก็บหรือกระจายแหล่งข้อมูล
- สำหรับการเรียนรู้และแลกเปลี่ยนส่วนตัวเท่านั้น โปรดลบออกเองภายใน 24 ชั่วโมง ห้ามใช้ในเชิงพาณิชย์
- มีต้นกำเนิดจาก [ZY-Player](https://github.com/Hunlongyu/ZY-Player) ไอคอนออกแบบโดย @fourbeauty
- ก่อนใช้งานโปรดอ่านและยอมรับข้อตกลงผู้ใช้โดยละเอียด เพื่อปฏิบัติตามข้อกำหนดที่เกี่ยวข้อง

## 💻 คำอธิบายข้ามแพลตฟอร์ม

- **MacOS**:
  - มีแพ็คเกจติดตั้งสำหรับสถาปัตยกรรม arm64(ชิป Apple)/x64(ชิป Intel)
  - ฐานข้อมูล/ไฟล์/ปลั๊กอิน/บันทึกเส้นทาง: `~/Library/Application Support/zyfun/`
  - ไฟล์ไบนารีเส้นทาง: `~/.zy/bin/`
- **Linux**:
  - มีแพ็คเกจติดตั้ง-image/deb สำหรับสถาปัตยกรรม arm64/x64
  - ฐานข้อมูล/ไฟล์/ปลั๊กอิน/บันทึกเส้นทาง: `~/.config/zyfun/`
  - ไฟล์ไบนารีเส้นทาง: `~/.zy/bin/`
- **Windows**:
  - มีแพ็คเกจติดตั้งสำหรับสถาปัตยกรรม arm64/x64
  - ฐานข้อมูล/ไฟล์/ปลั๊กอิน/บันทึกเส้นทาง: `%USERPROFILE%\AppData\Roaming\zyfun\`
  - ไฟล์ไบนารีเส้นทาง: `%USERPROFILE%\.zy\bin\`
  <!-- - **OpenHarmony**:
  - มีแพ็คเกจติดตั้งสำหรับสถาปัตยกรรม arm64/x64
  - ฐานข้อมูล/ไฟล์/ปลั๊กอิน/บันทึกเส้นทาง: `/data/storage/zyfun/base/files/log`
  - ไฟล์ไบนารีเส้นทาง: `~/.zy/bin/`-->

## 🛠️ การติดตั้งและดาวน์โหลด

> **ดาวน์โหลดรุ่นล่าสุด**: เยี่ยมชม [หน้าปล่อยเวอร์ชัน GitHub](https://github.com/Hiram-Wong/ZyPlayer/releases) เพื่อรับ

> **ดาวน์โหลดรุ่นพัฒนาใหม่ล่าสุด**: เยี่ยมชม [หน้ากระบวนการ GitHub Actions](https://github.com/Hiram-Wong/ZyPlayer/actions/workflows/nightly-build.yml) เพื่อรับ ต้องเข้าสู่ระบบด้วยบัญชี Github

### หลังติดตั้งบน MacOS แล้วเปิดขึ้นมาขึ้นแจ้งว่า “ไฟล์เสียหาย”
...
### การติดตั้ง deb บน Linux ล้มเหลว
