<div align="right">
  <details>
    ...
    <div>
      <div align="center">
        <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=en">ইংৰাজী</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=zh-CN">সৰল চাইনীজ</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=zh-TW">পৰম্পৰাগত চাইনীজ</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=ja">জাপানী</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=ko">কোৰিয়ান</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=hi">হিন্দী</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=th">থাই</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=fr">ফ্ৰেঞ্চ</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=de">জাৰ্মান</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=es">স্পেনিছ</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=it">ইটালিয়ান</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=ru">ৰাছিয়ান</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=pt">পৰ্তুগীজ</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=nl">ডাচ</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=pl">প'লিছ</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=ar">আৰবী</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=fa">ফাৰ্সী</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=tr">তুৰ্কী</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=vi">ভিয়েটনামীজ</a>
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=id">ইণ্ডোনেছিয়ান</a>
...
zyfun এটা বিনামূলীয়া, অতি সহজ, সকলো ক্ষমতা থকা, বহু প্লেটফৰ্মত চলা অডিঅ' ভিডিঅ' ব্যৱস্থাপনা ছফ্টৱেৰ, T1-T4 সকলো ধৰণৰ উৎস একে স্থানতে পৰিচালনা কৰে। ইন্টাৰনেল মাল্টিক'ৰ প্লেয়াৰ যিকোনো সময়ত সলনি কৰিব পাৰি। বিশেষ "বচ"-কী, এক ক্লিকে গোপনীয়ভাৱে ব্যৱহাৰ কৰিব পাৰি। চিনেমা চাই বিশ্ব আৱিষ্কাৰ কৰক!

<details>
<summary>ছফ্টৱেৰ স্ক্ৰীনছট চাওক</summary>

|                            চলচ্চিত্ৰ(মূল পৃষ্ঠা)                            |                            চলচ্চিত্ৰ(অনুসন্ধান)                            |
| :--------------------------------------------------------------: | :--------------------------------------------------------------: |
| ![চলচ্চিত্ৰ-মূল পৃষ্ঠা](https://s2.loli.net/2024/07/20/T8diRvA1q2QaJmP.png) | ![চলচ্চিত্ৰ-অনুসন্ধান](https://s2.loli.net/2024/07/20/utwCUsVG6c7ShRJ.png) |
|                            চলচ্চিত্ৰ(চলোৱা)                            |                            বিশ্লেষণ(মূল পৃষ্ঠা)                            |
| ![চলচ্চিত্ৰ-চলোৱা](https://s2.loli.net/2024/07/20/DNFBu3LphASROVy.png)  | ![বিশ্লেষণ-মূল পৃষ্ঠা](https://s2.loli.net/2024/07/20/JZANVebW4EHOU7I.png) |
|                            লাইভ(মূল পৃষ্ঠা)                            |                            লাইভ(চলোৱা)                            |
| ![লাইভ-মূল পৃষ্ঠা](https://s2.loli.net/2024/07/20/ucxSw3nR2EahG59.png) | ![লাইভ-চলোৱা](https://s2.loli.net/2024/07/20/jYEFc6NOwtdWJBV.png) |
|                             ইতিহাস ৰেকৰ্ড                             |                               ছেটিংছ                               |
| ![ঐতিহাসিক ৰেকৰ্ড](https://s2.loli.net/2024/07/20/DiYsx4fbcH3KU6T.png)  |   ![ছেটিংছ](https://s2.loli.net/2024/07/20/QeaDxZ2IYCFoVki.png)    |

</details>

## 🌴 মনোযোগৰ বিষয়সমূহ

- কেৱল এই Github ত প্ৰকাশিত, অনুগ্ৰহ কৰি কোনো ধোঁকা নখাওক; সকলো পৰিচালকক অনুৰোধ, এই ছফ্টৱেৰ প্ৰচাৰ বা ডাঙৰ কৰা নকৰিব।
- আইনসন্মত ভিউইংৰ বাবে দৃঢ়ভাৱে প্ৰস্তাৱিত, এই ছফ্টৱেৰে কেৱল প্লে টুল হিচাপে ব্যৱহাৰ কৰা হয়, ৰিসোর্স সংৰক্ষণ বা বিতৰণত জড়িত নহয়।
- কেৱল ব্যক্তিগত অধ্যয়ন আৰু আদান-প্ৰদানৰ বাবে, ২৪ ঘণ্টাৰ ভিতৰত নিজেৰে আনইনষ্টল কৰক, ব্যৱসায়িক উদ্দেশ্যে ব্যৱহাৰ নকৰিব।
- মূল উৎস [ZY-Player](https://github.com/Hunlongyu/ZY-Player) ৰ পৰা, আইকন @fourbeauty দ্বাৰা ডিজাইন কৰা।
- ব্যৱহাৰ আৰম্ভণিৰ আগতে, অনুগ্ৰহ কৰি ব্যৱহাৰকাৰী চুক্তি সম্পূৰ্ণ পঢ়ক আৰু একমত হোৱা নিশ্চয়তা কৰক, সংশ্লিষ্ট নিয়ম মানি চলক।

## 💻 প্লেটফৰ্ম-ক্ৰছ ব্যৱহাৰৰ বিৱৰণ

- **MacOS**:
  - arm64(এপল চিপ)/x64(ইণ্টেল চিপ) আৰ্হিৰ ইনষ্টলেশ্যন পেকেজ উপলব্ধ
  - ডেটাবেছ/ফাইল/প্লাগিন/লগ পথ: `~/Library/Application Support/zyfun/`
  - বাইনাৰী পথ: `~/.zy/bin/`
- **Linux**:
  - arm64/x64 আৰ্হি-image/deb ইনষ্টলেশ্যন পেকেজ উপলব্ধ
  - ডেটাবেছ/ফাইল/প্লাগিন/লগ পথ: `~/.config/zyfun/`
  - বাইনাৰী পথ: `~/.zy/bin/`
- **Windows**:
  - arm64/x64 আৰ্হিৰ ইনষ্টলেশ্যন পেকেজ উপলব্ধ
  - ডেটাবেছ/ফাইল/প্লাগিন/লগ পথ: `%USERPROFILE%\AppData\Roaming\zyfun\`
  - বাইনাৰী পথ: `%USERPROFILE%\.zy\bin\`
  <!-- - **OpenHarmony**:
  - arm64/x64 আৰ্হিৰ ইনষ্টলেশ্যন পেকেজ উপলব্ধ
  - ডেটাবেছ/ফাইল/প্লাগিন/লগ পথ: `/data/storage/zyfun/base/files/log`
  - বাইনাৰী পথ: `~/.zy/bin/`-->

## 🛠️ ডাউনলোড আৰু ইনষ্টল

> **নৱতম ৰিলিজ সংষ্কৰণ ডাউনলোড**: [GitHub Releases পৃষ্ঠা](https://github.com/Hiram-Wong/ZyPlayer/releases) ত প্ৰবেশ কৰক

> **নৱতম ডেভেলপমেণ্ট সংষ্কৰণ ডাউনলোড**: [GitHub Actions পৃষ্ঠা](https://github.com/Hiram-Wong/ZyPlayer/actions/workflows/nightly-build.yml) ত প্ৰবেশ কৰক, Github একাউণ্ট লগইন প্ৰয়োজন

### MacOS ইনষ্টল কৰাৰ পাছত খোলাত “ফাইলটো নষ্ট হৈছে” বুলি দেখুৱায়
...
### Linux Appimage চলোৱা বিফল

> root হিচাপে --no-sandbox নথকা অৱস্থাত চলোৱা সমৰ্থিত নহয়

```bash
./文件名.AppImage --no-sandbox
```

> dlopen() : libfuse.so.2 লোড কৰোঁতে ত্ৰুটি

```bash
sudo apt-get install libfuse2
```

> আৰম্ভণিৰ সময়ত ত্ৰুটিসমূহৰ বাবে GPU প্ৰক্ৰিয়া বন্ধ কৰা হৈছে

```bash
xhost +
```

### Linux deb স্থাপন বিফল

> Package libnss3-1d স্থাপন হোৱা নাই

```bash
sudo apt-get install libnss3-1d
```

> পেকেজ libxss1 ইনষ্টল কৰা হোৱা নাই
...
> অনুগ্ৰহ কৰি ডাটা গঠন অনুসৰি ডাটা আমদানি কৰক, অপ্রয়োজনীয় ত্ৰুটি (যেনে ডাটা ক্ষেত্ৰৰ ধৰণ মিল নোহোৱা) এৰাৰ বাবে

<details>
<summary>ইন্টাৰফেছৰ বিৱৰণ চাওক</summary>
...
## 🤝 অৱদানৰ বাবে অংশগ্ৰহণ

তলত আপোনাৰ অৱদান আগবঢ়াবলৈ কিছুমান উপায় দিয়া হৈছে:

- **কোড অৱদান**: নতুন ফিচাৰ বিকাশ কৰক বা বিদ্যমান কোড উন্নত কৰক <[উন্নয়ন ডকুমেন্ট](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Develop.md)>
- **বাগ সমাধান**: আপোনাই দেখা পোৱা যিকোনো ত্ৰুটিৰ সমাধান জমা কৰক <[জমা বিধি](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Conventional_Commits.md)>
- **সমস্যা পৰিচালনা**: GitHub সমস্যাসমূহ পৰিচালনাত সহায় কৰক
- **উৎপাদন পৰিকল্পনা**: ডিজাইন আলোচনাত অংশগ্ৰহণ কৰক
- **ডকুমেন্ট লিখা**: ব্যৱহাৰকাৰীৰ মেনুয়েল আৰু গাইড উন্নত কৰক
- **সম্প্ৰদায় অংশগ্ৰহণ**: আলোচনা যোগদান কৰক আৰু ব্যৱহাৰকাৰীক সহায় কৰক
...
<a href="https://www.star-history.com/#Hiram-Wong/ZyPlayer&Date">
 <picture>
   ...
   <img alt="ষ্টাৰ ইতিহাস চাৰ্ট" src="https://api.star-history.com/svg?repos=Hiram-Wong/ZyPlayer&type=Date" />
 </picture>
</a>

## 💰 অৰ্থিক সহায়

- [NodeSupport](https://github.com/NodeSeekDev/NodeSupport) এই প্ৰকল্পটোত আৰ্থিক সহায় আগবঢ়াইছে
