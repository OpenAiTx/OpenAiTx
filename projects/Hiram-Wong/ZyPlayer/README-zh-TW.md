  ...
  <details>
    ...
    <div>
      <div align="center">
        ...
        | <a href="https://openaitx.github.io/view.html?user=Hiram-Wong&project=ZyPlayer&lang=zh-CN">簡體中文</a>
...
> 請嚴格按照資料結構導入資料，避免不必要的錯誤（如資料欄位類型不匹配）
...
- **貢獻程式碼**：開發新功能或優化現有程式碼 <[開發文件](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Develop.md)>
- **修復錯誤**：提交您發現的任何錯誤修復 <[提交規範](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Conventional_Commits.md)>
- **維護議題**：協助管理GitHub議題
- **產品設計**：參與設計討論
- **撰寫文件**：改進用戶手冊與指南
- **社群參與**：加入討論並協助用戶
