...
zyfun एक मुफ़्त, अति-सरल, सर्व-समर्थित क्रॉस-प्लेटफ़ॉर्म मीडिया मैनेजर है, जो एक ही जगह पर T1-T4 सभी प्रकार के संसाधनों का प्रबंधन करता है, और इसमें मल्टी-कोर प्लेयर भी अंतर्निहित है जिसे आप अपनी पसंद से बदल सकते हैं। अनूठा बॉस-कुंजी, एक क्लिक में छिपें और निश्चिंत रहें। फिल्मों के साथ दुनिया को खोजिए!
...
- केवल इसी Github पर जारी किया गया है, कृपया धोखा न खाएँ; सभी व्यवस्थापकों से अनुरोध है कि इस सॉफ़्टवेयर का प्रचार या ट्रैफ़िक न बढ़ाएँ।
- वैध रूप से फिल्में देखने का दृढ़ता से समर्थन करते हैं, यह सॉफ़्टवेयर केवल एक प्लेयर टूल है, संसाधनों का संग्रहण या वितरण इसमें शामिल नहीं है।
- केवल व्यक्तिगत अध्ययन व交流 के लिए, कृपया 24 घंटे के भीतर खुद से अनइंस्टॉल करें, व्यावसायिक उपयोग न करें।
- पूर्ववर्ती संस्करण [ZY-Player](https://github.com/Hunlongyu/ZY-Player) से आया है, आइकन @fourbeauty द्वारा डिज़ाइन किया गया।
- उपयोग शुरू करने से पहले, कृपया यूज़र एग्रीमेंट ध्यानपूर्वक पढ़ें और सहमति दें, और संबंधित नियमों का पालन सुनिश्चित करें।

## 💻 क्रॉस-प्लेटफ़ॉर्म विवरण

- **MacOS**:
  - arm64 (एप्पल चिप)/x64 (इंटेल चिप) आर्किटेक्चर इंस्टॉलर पैकेज उपलब्ध
  - डेटाबेस/फ़ाइल/प्लगइन/लॉग पथ: `~/Library/Application Support/zyfun/`
  - बाइनरी पथ: `~/.zy/bin/`
- **Linux**:
  - arm64/x64 आर्किटेक्चर-इमेज/डेब इंस्टॉलर पैकेज उपलब्ध
  - डेटाबेस/फ़ाइल/प्लगइन/लॉग पथ: `~/.config/zyfun/`
  - बाइनरी पथ: `~/.zy/bin/`
- **Windows**:
  - arm64/x64 आर्किटेक्चर इंस्टॉलर पैकेज उपलब्ध
  - डेटाबेस/फ़ाइल/प्लगइन/लॉग पथ: `%USERPROFILE%\AppData\Roaming\zyfun\`
  - बाइनरी पथ: `%USERPROFILE%\.zy\bin\`
  <!-- - **OpenHarmony**:
  - arm64/x64 आर्किटेक्चर इंस्टॉलर पैकेज उपलब्ध
  - डेटाबेस/फ़ाइल/प्लगइन/लॉग पथ: `/data/storage/zyfun/base/files/log`
  - बाइनरी पथ: `~/.zy/bin/`-->

## 🛠️ डाउनलोड व इंस्टॉल

> **नवीनतम रिलीज़ संस्करण डाउनलोड करें**: [GitHub Releases पेज](https://github.com/Hiram-Wong/ZyPlayer/releases) पर जाएँ

> **नवीनतम डेवलपमेंट संस्करण डाउनलोड करें**: [GitHub Actions पेज](https://github.com/Hiram-Wong/ZyPlayer/actions/workflows/nightly-build.yml) पर जाएँ, Github अकाउंट से लॉगिन आवश्यक

### MacOS इंस्टॉल के बाद खोलने पर "फ़ाइल क्षतिग्रस्त है" संदेश आता है
...
### Linux Appimage चलाने में विफलता

> रूट के रूप में बिना --no-sandbox के चलाना समर्थित नहीं है
...
> प्रारंभिककरण के दौरान त्रुटियों के कारण GPU प्रक्रिया समाप्त हो रही है

```bash
xhost +
```

### Linux deb पैकेज इंस्टॉल करने में विफल
...
> पैकेज libxss1 स्थापित नहीं है

```bash
sudo apt-get install libxss1
```

### Linux rpm पैकेज इंस्टॉलेशन विफल
...
> कृपया डेटा संरचना के अनुसार ही डेटा आयात करें, अनावश्यक त्रुटियों से बचें (जैसे डेटा फ़ील्ड प्रकार मेल न खाना)
...
नीचे दिए गए कुछ तरीके हैं जिनसे आप योगदान कर सकते हैं:

- **कोड योगदान करें**: नई सुविधाएँ विकसित करें या मौजूदा कोड का अनुकूलन करें <[डेवलपमेंट डॉक्युमेंटेशन](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Develop.md)>
- **बग सुधारें**: आपके द्वारा पाए गए किसी भी त्रुटि के लिए सुधार जमा करें <[सबमिशन गाइडलाइन](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Conventional_Commits.md)>
- **समस्या बनाए रखें**: GitHub समस्याओं का प्रबंधन करने में मदद करें
- **प्रोडक्ट डिज़ाइन**: डिज़ाइन चर्चाओं में भाग लें
- **डॉक्युमेंटेशन लिखें**: उपयोगकर्ता मैनुअल और गाइड सुधारें
- **समुदाय भागीदारी**: चर्चाओं में शामिल हों और उपयोगकर्ताओं की सहायता करें
...
- [NodeSupport](https://github.com/NodeSeekDev/NodeSupport) ने इस प्रोजेक्ट को प्रायोजित किया है
