...
`zyfun` is a free and easy-to-use media player desktop client, suitable for Windows, Mac, and Linux.

## 🌴 Notes

- Only released on Github, please do not be deceived; administrators are kindly requested not to spend effort promoting or directing traffic to this software.
...
- Some inspirations come from [ZY-Player](https://github.com/Hunlongyu/ZY-Player), icon materials thanks to contributions from [@fourbeauty].
- Before starting to use, please be sure to read and agree to the user agreement to ensure compliance with relevant regulations.

## 🌟 Main Features

- **Wide Compatibility**: Cross-platform support for Windows, Mac, and Linux systems.
- **Dark Mode**: Adapted for nighttime use, protects eyesight.
- **Resource Access**: Easily manage CMS in json, xml, and other formats.
- **IPTV Support**: Seamlessly play m3u, genre, and other formats.
- **Quick Hide**: Built-in boss key for one-click privacy protection.
- **Multiple Players**: Built-in multiple player cores to meet different needs.
- **More Content**: Explore on your own...
...
|                            Movies & TV (Home)                            |                            Movies & TV (Search)                            |
| :-----------------------------------------------------------------------: | :------------------------------------------------------------------------: |
| ![Movies & TV - Home](https://s2.loli.net/2024/07/20/T8diRvA1q2QaJmP.png) | ![Movies & TV - Search](https://s2.loli.net/2024/07/20/utwCUsVG6c7ShRJ.png) |
|                            Movies & TV (Playback)                         |                            Parsing (Home)                                  |
| ![Movies & TV Playback](https://s2.loli.net/2024/07/20/DNFBu3LphASROVy.png) | ![Parsing - Home](https://s2.loli.net/2024/07/20/JZANVebW4EHOU7I.png)       |
|                            Live Streaming (Home)                          |                            Live Streaming (Playback)                       |
| ![Live Streaming - Home](https://s2.loli.net/2024/07/20/ucxSw3nR2EahG59.png) | ![Live Streaming - Playback](https://s2.loli.net/2024/07/20/jYEFc6NOwtdWJBV.png) |
|                             History Records                               |                               Settings                                     |
| ![History Records](https://s2.loli.net/2024/07/20/DiYsx4fbcH3KU6T.png)    |   ![Settings](https://s2.loli.net/2024/07/20/QeaDxZ2IYCFoVki.png)           |
...
- **MacOS**:
  - Provides arm64 (Apple Silicon) / x64 (Intel) architecture installers
  - Database/files/plugins/logs path: `~/Library/Application\ Support/zyfun/`
  - Binary path: `~/.zy/bin/`
- **Linux**:
  - Provides arm64/x64 architecture image/deb installers
  - Database/files/plugins/logs path: `~/.config/zyfun/`
  - Binary path: `~/.zy/bin`
- **Windows**:
  - Provides arm64/x64 architecture installers
...
> **Latest Development Version Download**: Access the [GitHub Actions page](https://github.com/Hiram-Wong/ZyPlayer/actions) to get it, login with a Github account is required.

### MacOS Shows "File is Damaged" After Installation
...
### Linux deb Installation Failure
...
> Please strictly follow the data structure to avoid unnecessary errors (such as data field type mismatches)

> For data merging, please manually export, edit the data, and then import (direct import by the software will overwrite data)

<details>
<summary>Expand to view interface description</summary>
...
[Development Documentation](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Develop.md)
