...
<div align="right" >
  <details>
    ...
    <div>
      <div align="right">
        <p><a href="https://openaitx.github.io/#/view?user=Hiram-Wong&project=ZyPlayer&lang=en">Anglais</a></p>
...
`zyfun` est un lecteur multimédia gratuit et facile à utiliser, compatible avec Windows, Mac et Linux.

## 🌴 Remarques

- Publié uniquement sur Github, ne vous laissez pas tromper ; nous demandons aux administrateurs de ne pas faire d’efforts pour promouvoir ou rediriger vers ce logiciel.
- Fortement encouragé à regarder légalement, ce logiciel est uniquement un outil de lecture, il ne stocke ni ne distribue de contenu.
- Destiné uniquement à un usage personnel et d’apprentissage, veuillez le désinstaller dans les 24 heures et ne pas l’utiliser à des fins commerciales.
- Certaines idées sont inspirées de [ZY-Player](https://github.com/Hunlongyu/ZY-Player), merci à [@fourbeauty] pour les icônes.
- Avant de commencer, veuillez lire attentivement et accepter le contrat utilisateur afin de respecter les règles en vigueur.

## 🌟 Principales fonctionnalités

- **Compatibilité étendue** : prise en charge multiplateforme Windows, Mac, Linux.
- **Mode sombre** : adapté pour une utilisation nocturne, protège la vue.
- **Gestion des ressources** : gestion facile des CMS aux formats json, xml, etc.
- **Support IPTV** : lecture fluide des formats m3u, genre, etc.
- **Masquage rapide** : raccourci "touche patron" intégré, confidentialité garantie en un clic.
- **Multiples lecteurs** : plusieurs moteurs de lecture intégrés pour divers besoins.
- **Plus de contenu** : explorez par vous-même...


## 🖼️ Aperçu du logiciel

<details>
<summary>Développer pour voir les captures d'écran du logiciel</summary>

|                            Film & TV (Accueil)                            |                            Film & TV (Recherche)                            |
| :----------------------------------------------------------------------: | :------------------------------------------------------------------------: |
| ![Film & TV - Accueil](https://s2.loli.net/2024/07/20/T8diRvA1q2QaJmP.png) | ![Film & TV - Recherche](https://s2.loli.net/2024/07/20/utwCUsVG6c7ShRJ.png) |
|                            Film & TV (Lecture)                            |                            Analyse (Accueil)                            |
| ![Lecture Film & TV](https://s2.loli.net/2024/07/20/DNFBu3LphASROVy.png)  | ![Analyse - Accueil](https://s2.loli.net/2024/07/20/JZANVebW4EHOU7I.png) |
|                            Direct (Accueil)                            |                            Direct (Lecture)                            |
| ![Direct - Accueil](https://s2.loli.net/2024/07/20/ucxSw3nR2EahG59.png) | ![Direct - Lecture](https://s2.loli.net/2024/07/20/jYEFc6NOwtdWJBV.png) |
...
## 💻 Informations multiplateformes

- **MacOS** :
  - Fournit des paquets d'installation pour architectures arm64 (puce Apple) / x64 (puce Intel)
  - Chemin des bases de données/fichiers/plugins/journaux : `~/Library/Application\ Support/zyfun/`
  - Chemin binaire : `~/.zy/bin/`
- **Linux** :
  - Fournit des paquets image/deb pour architectures arm64/x64
  - Chemin des bases de données/fichiers/plugins/journaux : `~/.config/zyfun/`
  - Chemin binaire : `~/.zy/bin`
- **Windows** :
  - Fournit des paquets d'installation pour architectures arm64/x64
  - Chemin des bases de données/fichiers/plugins/journaux : `%USERPROFILE%\AppData\Roaming\zyfun\`
  - Chemin binaire : `%USERPROFILE%\.zy\bin`
  <!-- - **OpenHarmony** :
  - Fournit des paquets d'installation pour architectures arm64/x64
  - Chemin des bases de données/fichiers/plugins/journaux : `/data/storage/zyfun/base/files/log`
  - Chemin binaire : `~/.zy/bin`-->

## 🛠️ Installation et téléchargement

> **Téléchargement de la dernière version publiée** : Visitez la [page des Releases GitHub](https://github.com/Hiram-Wong/ZyPlayer/releases) pour obtenir.

> **Téléchargement de la dernière version en développement** : Visitez la [page GitHub Actions](https://github.com/Hiram-Wong/ZyPlayer/actions) pour obtenir la version, connexion au compte Github requise.

### MacOS affiche «Fichier endommagé» après l'installation et à l'ouverture
...
### Échec d'exécution de l'AppImage Linux
...
> Veuillez remplir strictement selon la structure des données pour éviter les erreurs inutiles (comme le non-respect des types de champs de données)

> Pour la fusion des données, veuillez d'abord exporter manuellement, éditer les données, puis importer (l'importation directe via le logiciel écrase les données)

<details>
<summary>Développer pour voir la description de l'interface</summary>
...
[Documentation de développement](https://raw.githubusercontent.com/Hiram-Wong/ZyPlayer/main/docs/Develop.md)
...
<a href="https://www.star-history.com/#Hiram-Wong/ZyPlayer&Date">
 <picture>
   ...
   <img alt="Graphique de l'historique des étoiles" src="https://api.star-history.com/svg?repos=Hiram-Wong/ZyPlayer&type=Date" />
 </picture>
</a>
