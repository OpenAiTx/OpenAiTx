...
1. rusty_v8 library has not yet implemented the V8 Locker API. Accessing the Ssr struct from a different thread will cause the V8 engine to panic.
2. Rendering HTML does not require shared state across threads.
