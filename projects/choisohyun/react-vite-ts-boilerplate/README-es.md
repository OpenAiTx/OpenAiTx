...
```
2. Inicie el servidor de desarrollo. Y abra http://localhost:3000 en su navegador.


```
  yarn dev
```
3. Construya su producto.
...
✨  Done in 2.22s.
```
- Comprobación de tipos por [vite-plugin-checker](https://www.npmjs.com/package/vite-plugin-checker)
