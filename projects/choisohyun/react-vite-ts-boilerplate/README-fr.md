...
```
2. Démarrez le serveur de développement. Et ouvrez http://localhost:3000 dans votre navigateur.
...
$ vite
  ...
  ready in 776ms.
```
- vitesse de construction rapide
...
- Vérification de type par [vite-plugin-checker](https://www.npmjs.com/package/vite-plugin-checker)
