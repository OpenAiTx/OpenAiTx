...
<div align="center">
 여러분의 <a href="https://github.com/OpenAiTx/OpenAiTx">Star</a>가 Open Ai Tx를 더 나아지게 만듭니다
</div>
...
1. 프리미엄급 LLM을 이용한 1회 번역으로, 결과를 오픈소스 커뮤니티에 무료로 공개합니다.
2. Google/Bing 다국어 SEO 검색 지원, 클라이언트 번역 도구는 이를 할 수 없습니다.
3. 영원히 무료 & 오픈 소스
4. 한 번 제출하면 자동으로 향후 업데이트, 프로젝트 관리자라면 시간을 절약할 수 있습니다.


## 시작하기

1. URL에서 `GitHub`를 `OpenAiTx`로 교체하세요. 예: https://github.com/OpenAiTx/OpenAiTx → https://openaitx.com/OpenAiTx/OpenAiTx  
2. 프로젝트를 제출하세요.
3. 원하는 스타일 배지 또는 텍스트를 클릭하여 복사하세요.
4. readme 파일에 업데이트하세요.

또는

1. https://openaitx.com 접속
2. 프로젝트 링크를 제출하세요.
3. 원하는 스타일 배지 또는 텍스트를 클릭하여 복사하세요.
4. readme 파일에 업데이트하세요.
...
프로젝트에 기여하고 싶으시다면, 다음을 따라 하시면 됩니다:
...
## 프론트엔드 프로젝트
[소스 코드 프로젝트 링크](https://github.com/OpenAiTx/OpenAiTx_FrontEnd) by [@mikechen](https://github.com/mikechen-git)

## 기타

- 프로젝트당 10~30분 소요
- 콘솔당 200~400개 프로젝트/일 처리 가능
- 3~7일마다 기존 프로젝트가 업데이트됩니다 (향후 컴퓨팅 자원에 따라 다름)
