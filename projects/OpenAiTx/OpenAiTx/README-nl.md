...
<div style="text-align: center">
 Jouw <a href="https://github.com/OpenAiTx/OpenAiTx">Ster</a> en <a href="https://miniexcel.github.io">Donatie</a> kunnen Open Ai Tx beter maken
</div>
...
**OpenAiTx** maakt automatisch vertaalde README's in 20 talen voor je GitHub-project. Je hoeft alleen maar de project-URL `GitHub` te vervangen door `OpenAiTx`, bijvoorbeeld: https://github.com/OpenAiTx/OpenAiTx => https://openaitx.com/OpenAiTx/OpenAiTx .
...
Opmerking: **Upload of lek je tokens niet!**



## Overig

- 50 KB readme kost `2 minuten/per taal` via GPT4.1.
- 200-400 projecten/één console per dag.
- Elke 3-N dagen worden bestaande projecten bijgewerkt (afhankelijk van toekomstige computercapaciteit😎)



### Dankwoord

- Microsoft MVP-team levert 150USD/maand open source community Azure platform budget.
