...
**OpenAiTx** is een automatische vertaalsysteem voor 20 talen voor je GitHub-project README.

## Waarom?

1. Eenmalige vertaling met LLM van premiumkwaliteit en maak het resultaat vrij toegankelijk voor de open source-gemeenschap.
2. Ondersteunt Google/Bing SEO-zoekopdrachten in meerdere talen, iets wat client-vertalingstools niet kunnen.
3. Voor altijd gratis & open source
4. Dien één keer in en automatische toekomstige updates, dit bespaart tijd als je een projectbeheerder bent.


## Aan de slag

1. Vervang de URL `GitHub` door `OpenAiTx`, bijvoorbeeld https://github.com/OpenAiTx/OpenAiTx → https://openaitx.com/OpenAiTx/OpenAiTx  
2. Klik en kopieer de stijlbadges of tekst die je leuk vindt, het systeem maakt automatisch een PR aan voor het project nadat deze is geïndexeerd.
