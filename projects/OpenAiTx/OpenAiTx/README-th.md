...
<div align="center">
 การ <a href="https://github.com/OpenAiTx/OpenAiTx">Star</a> ของคุณสามารถทำให้ Open Ai Tx ดีขึ้นได้
</div>


## แนะนำ

**OpenAiTx** เครื่องมือแปลอัตโนมัติ 20 ภาษา สำหรับไฟล์ readme โปรเจกต์ GitHub ของคุณ

## ทำไมต้องใช้?

1. แปลเพียงครั้งเดียวโดยใช้ LLM คุณภาพพรีเมียม และเผยแพร่ผลลัพธ์ให้ชุมชนโอเพ่นซอร์สเข้าถึงได้ฟรี
2. รองรับ SEO การค้นหาหลายภาษา Google/Bing ซึ่งเครื่องมือแปลฝั่งไคลเอนต์ไม่สามารถทำได้
3. ฟรีและโอเพ่นซอร์สตลอดไป
4. ส่งเพียงครั้งเดียวและอัปเดตอัตโนมัติในอนาคต ประหยัดเวลาสำหรับผู้ดูแลโปรเจกต์
...
2. คลิกและคัดลอกสไตล์ badge หรือข้อความที่คุณชอบ
  ...
  <details>
    ...
    <div>
      <div align="right">
        ...
        <p><a href="https://openaitx.github.io/view.html?user=OpenAiTx&project=OpenAiTx&lang=de">Deutsch</a></p>
        <p><a href="https://openaitx.github.io/view.html?user=OpenAiTx&project=OpenAiTx&lang=es">Español</a></p>
        <p><a href="https://openaitx.github.io/view.html?user=OpenAiTx&project=OpenAiTx&lang=it">อิตาเลียน</a></p>
        <p><a href="https://openaitx.github.io/view.html?user=OpenAiTx&project=OpenAiTx&lang=ru">Русский</a></p>
        <p><a href="https://openaitx.github.io/view.html?user=OpenAiTx&project=OpenAiTx&lang=pt">Português</a></p>
        <p><a href="https://openaitx.github.io/view.html?user=OpenAiTx&project=OpenAiTx&lang=nl">Nederlands</a></p>
        <p><a href="https://openaitx.github.io/view.html?user=OpenAiTx&project=OpenAiTx&lang=pl">Polski</a></p>
...
## การมีส่วนร่วมในการประมวลผล

หากคุณต้องการมีส่วนร่วมกับโปรเจกต์นี้ สิ่งที่คุณต้องทำคือ:
Fork โปรเจกต์ → Clone โปรเจกต์ → เลือกสคริปต์ในภาษาของคุณ → กรอกโทเคน AI ของคุณ → รัน → Commit & push & สร้าง PR

> หมายเหตุ: **กรุณาอย่าอัปโหลดโทเคนของคุณ!**

## หมายเหตุ

- รองรับเฉพาะ github markdown readme เท่านั้น
- หากคุณเป็นเจ้าของโปรเจกต์หรือผู้พัฒนาหลัก คุณสามารถยืนยันบัญชี github เพื่อสร้าง PR อัตโนมัติหลังจากถูกจัดทำดัชนีแล้ว

## อื่น ๆ

- 10~30 นาที/ ต่อโปรเจกต์
- 200~400 โปรเจกต์/คอนโซลหนึ่งตัวต่อวัน
- ทุก ๆ 3~7 วันจะอัปเดตโปรเจกต์ที่มีอยู่ (ขึ้นอยู่กับทรัพยากรการประมวลผลในอนาคต)


## ขอบคุณ

- ทีม Microsoft MVP มอบงบประมาณแพลตฟอร์ม Azure สำหรับชุมชนโอเพ่นซอร์ส 150USD/เดือน



## แผนในอนาคต

- รองรับการแปลอัตโนมัติ GitHub wiki 
- รองรับแพลตฟอร์ม Gitee
