...
## การคำนวณการมีส่วนร่วม

ถ้าคุณต้องการมีส่วนร่วมในโปรเจกต์นี้ สิ่งที่คุณต้องทำคือ:
Fork โปรเจกต์ → Clone โปรเจกต์ → เลือกสคริปต์ในภาษาของคุณ → กรอก AI token ของคุณ  → รันโปรแกรม → Commit & push & สร้าง PR

> หมายเหตุ: **กรุณาอย่าอัพโหลดโทเคนของคุณ!**
...
## โปรเจกต์ FrontEnd
[ลิงก์โปรเจกต์ Source Code](https://github.com/OpenAiTx/OpenAiTx_FrontEnd) โดย [@mikechen](https://github.com/mikechen-git)

## อื่นๆ

- 10~30 นาที/ ต่อโปรเจกต์
- 200~400 โปรเจกต์/หนึ่งคอนโซลต่อวัน
- ทุกๆ 3~7 วันจะอัปเดตโปรเจกต์ที่มีอยู่ (ขึ้นอยู่กับทรัพยากรการประมวลผลในอนาคต)
