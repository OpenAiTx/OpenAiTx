...
## Contribuire con la Computazione

Se desideri contribuire al progetto, tutto ciò che devi fare è:
Forka il progetto → Clona il progetto → Scegli uno script nella tua lingua → Inserisci il tuo token AI → Esegui → Commit & push & crea una PR
