...
**OpenAiTx** crea automáticamente archivos README traducidos a 20 idiomas para tu proyecto de GitHub. Solo necesitas reemplazar la URL del proyecto `GitHub` por `OpenAiTx`. Ejemplo: https://github.com/OpenAiTx/OpenAiTx : a https://openaitx.com/OpenAiTx/OpenAiTx
...
**Este proyecto no necesita tu dinero, pero sí necesita la potencia de cómputo de tu ordenador, contribuciones vía PR y Tokens.**
...
- Si deseas obtener alta prioridad y actualizaciones continuas, crea un PR y añade el enlace de tu proyecto de GitHub en `priority-list.json`.
- Puedes obtener el índice de proyectos en `projects-data.json`.
- Un README de 50 KB necesita `2 minutos/por idioma` usando GPT4.1.

### Agradecimientos

- El equipo Microsoft MVP proporciona presupuesto gratuito de Azure para la comunidad de código abierto.
