...
1. Traduction unique utilisant un LLM de qualité premium et mise à disposition gratuite du résultat pour la communauté open source.
2. Prise en charge du référencement multilingue Google/Bing, ce que les outils de traduction côté client ne peuvent pas faire.
3. Gratuit & Open Source pour toujours
4. Soumettez une seule fois et mettez à jour automatiquement à l'avenir, cela peut vous faire gagner du temps si vous êtes mainteneur de projet.
...
2. Cliquez et copiez les badges de style ou le texte qui vous plaît.

ou

1. Accédez à https://openaitx.github.io/ 
...
- Prend uniquement en charge le markdown de Github.
- Si vous êtes le propriétaire du projet ou un développeur principal, vous pouvez authentifier votre compte Github pour créer automatiquement une PR après l’indexation.

## Autre
- 10~30 minutes / par projet
