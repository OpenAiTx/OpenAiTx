...
عمل Fork للمشروع → استنساخ المشروع → اختيار سكربت بلغتك → تعبئة رمز AI الخاص بك → تشغيله → الالتزام & الدفع & إنشاء طلب دمج PR

> ملاحظة: **يرجى عدم رفع رموزك المميزة!**



## ملاحظات

- يدعم فقط ماركداون جيت هاب.



## مشروع الواجهة الأمامية
[رابط كود المصدر للمشروع](https://github.com/OpenAiTx/OpenAiTx_FrontEnd) بواسطة [@mikechen](https://github.com/mikechen-git)

## أخرى

- 10~30 دقيقة/لكل مشروع
- 200~400 مشروع/لكل وحدة تحكم في اليوم.
