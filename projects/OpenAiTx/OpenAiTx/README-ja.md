...
もし本プロジェクトに貢献したい場合、必要な手順は以下の通りです：
プロジェクトをFork → プロジェクトをClone → 自分の言語のスクリプトを選択 → AIトークンを入力 → 実行 → コミット＆プッシュ＆PRを作成

> 注記: **トークンは絶対にアップロードしないでください！**



## 注意事項

- Githubマークダウンのみサポートしています。 



## フロントエンドプロジェクト
[ソースコードプロジェクトリンク](https://github.com/OpenAiTx/OpenAiTx_FrontEnd) by [@mikechen](https://github.com/mikechen-git)

## その他

- 1プロジェクトあたり10～30分
- 1台のコンソールで1日200～400プロジェクト
- 既存プロジェクトは3～7日ごとに更新（将来の計算リソース次第）
