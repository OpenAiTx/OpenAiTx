...
Сделайте форк проекта → Клонируйте проект → Выберите скрипт на вашем языке → Укажите свой AI токен → Запустите его → Сделайте commit & push и создайте Pull Request
