...
Projeye katkı sağlamak istiyorsanız, yapmanız gerekenler:
Projeyi çatallayın → Projeyi klonlayın → Dilinizde bir betik seçin → AI tokenınızı ekleyin → Çalıştırın → Commit & push & PR oluşturun
...
## FrontEnd Projesi
[Kaynak Kod Proje Linki](https://github.com/OpenAiTx/OpenAiTx_FrontEnd) [@mikechen](https://github.com/mikechen-git) tarafından
