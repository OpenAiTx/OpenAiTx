...
**OpenAiTx** आपके GitHub प्रोजेक्ट के रीडमी के लिए 20 भाषाओं का ऑटो-ट्रांसलेट टूल।

## क्यों?

1. प्रीमियम-ग्रेड LLM का उपयोग करके एक बार अनुवाद करें और परिणाम को ओपन-सोर्स समुदाय के लिए स्वतंत्र रूप से सुलभ बनाएं।
2. Google/Bing बहुभाषी SEO खोज समर्थन, क्लाइंट ट्रांसलेट टूल यह नहीं कर सकते।
...
2. अपनी पसंद के स्टाइल बैज या टेक्स्ट पर क्लिक करें और कॉपी करें।
...
यदि आप परियोजना में योगदान करना चाहते हैं, तो आपको बस यह करना है:
प्रोजेक्ट फोर्क करें → प्रोजेक्ट क्लोन करें → अपनी भाषा में एक स्क्रिप्ट चुनें → अपना AI टोकन भरें → इसे चलाएँ → कमिट करें & पुश करें & PR बनाएं

> नोट: **कृपया अपने टोकन अपलोड न करें!**

## नोट्स

- केवल Github मार्कडाउन रीडमी को सपोर्ट करता है।
- यदि आप प्रोजेक्ट ओनर या कोर डेवलपर हैं, तो आप गिटहब अकाउंट को प्रमाणित कर सकते हैं ताकि इंडेक्सिंग के बाद ऑटो-PR बनाया जा सके।

## अन्य

- 10~30 मिनट/प्रति प्रोजेक्ट
- 200~400 प्रोजेक्ट/एक कंसोल प्रति दिन।
- हर 3~7 दिन में मौजूदा प्रोजेक्ट्स को अपडेट किया जाएगा (आगे की कंप्यूटिंग संसाधनों के आधार पर)

## धन्यवाद

- Microsoft MVP टीम 150USD/माह ओपन सोर्स कम्युनिटी अज्योर प्लेटफॉर्म बजट प्रदान करती है।

## भविष्य की योजना

- GitHub विकी ऑटो अनुवाद का समर्थन करें
- Gitee प्लेटफॉर्म का समर्थन करें
