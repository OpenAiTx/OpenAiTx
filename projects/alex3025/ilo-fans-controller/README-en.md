...
This tool requires a **patched iLO firmware** that exposes to the iLO SSH interface some commands to manipulate the fans speeds. You can find more information about this patch on [this Reddit post](https://www.reddit.com/r/homelab/comments/sx3ldo/hp_ilo4_v277_unlocked_access_to_fan_controls/).
...
> ⚠ **IMPORTANT!** ⚠
>
> Again, this tool works thanks to a **[patched iLO firmware](#can-i-use-this-tool-with-my-hp-server-%EF%B8%8F)** that exposes to the iLO SSH interface some commands to manipulate the fan speeds.
>
...
1. Open the `config.inc.php` file in your favourite text editor and change the variables according to your configuration.
