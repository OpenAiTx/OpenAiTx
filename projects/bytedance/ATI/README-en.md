...
[![Watch the video](https://raw.githubusercontent.com/bytedance/ATI/main/assets/thumbnail.jpg)](https://youtu.be/76jjPT0f8Hs)

This is the repo for Wan2.1 ATI (Any Trajectory Instruction for Controllable Video Generation), a trajectory-based motion control framework that unifies object, local and camera movements in video generation. This repo is based on [Wan2.1 official implementation](https://github.com/Wan-Video/Wan2.1).

Compared with the original Wan2.1. We add the following files:
- wan/modules/motion_patch.py          | Trajectory instruction kernel module
...
## Community Works
### ComfyUI
Thanks to Kijai for developing the ComfyUI nodes for ATI:
...
ATI requires the same environment as official Wan 2.1. Follow the instruction of INSTALL.md (Wan2.1).
