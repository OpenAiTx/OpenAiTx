...
See [examples/http_bench_tui.py](https://raw.githubusercontent.com/Andarius/piou/master/examples/http_bench_tui.py) for the full implementation using `TuiContext` and custom widgets.
