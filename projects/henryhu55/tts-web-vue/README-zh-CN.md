...
> ✅ **在线演示（推荐）**: [https://xiaoying.work](https://xiaoying.work) (🎁 **每天免费 10,000 字符**)
>
> 🚀 **新品上线**: 专业配音产品 / 更加稳定 / 支持套餐 / 支持更多声音 / 支持任务队列

🎤 微软语音合成工具，Web版本，基于 `Vue` + `ElementPlus` + `Vite` 构建。

## 托管版本 / 在线体验
这个仓库是开源 Web UI 的参考实现。如果您需要更稳定、功能更强大的服务，推荐使用我们的官方托管版。

| 特性               | 自托管 (此仓库)            | [小影工作 (官方托管)](https://xiaoying.work)  |
| :----------------- | :------------------------- | :---------------------------------------------- |
