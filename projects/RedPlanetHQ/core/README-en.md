...
2. Enter the code below in the configuration file and click on the `Add server` button
...
2. Choose the Remote Servers tab and click the Edit Configuration button
