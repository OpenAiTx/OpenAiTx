...
To support me, you can make a donation :smile: with **PayPal** or **LiberaPay**:
...
This extension allows you to copy an emoji to the clipboard. There are many emojis, more than **1900**!

Emojis are divided into several sections to help you find the correct emoji quickly (in order):
