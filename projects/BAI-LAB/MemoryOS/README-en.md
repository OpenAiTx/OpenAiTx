...
## 📣 Latest News
*   *<mark>[new]</mark>* 🔥  **[2025-06-15]**:🛠️ Open-sourced **MemoryOS-MCP** released! Now configurable on agent clients for seamless integration and customization. [👉 View](#memoryos_mcp-getting-started)
...
@misc{kang2025memoryosaiagent,
      ...
      eprint={2506.06326},
## Contact us
BaiJia AI is a research group led by Associate Professor Bai Ting at Beijing University of Posts and Telecommunications, dedicated to creating emotionally rich and exceptionally memorable brains for silicon-based humans.<br>
Collaboration & Suggestions: baiting@bupt.edu.cn<br>
Follow the BaiJia Agent official WeChat account and WeChat group to connect and exchange ideas!  
<div style="display: flex; justify-content: center; gap: 20px;">
  <img src="https://github.com/user-attachments/assets/42651f49-f1f7-444d-9455-718e13ed75e9" alt="BaiJia Agent Official WeChat" width="250"/>
  <img src="https://github.com/user-attachments/assets/6b15a873-9e9a-44ee-b0b3-64f488fbd5d8" alt="WeChat Group QR Code" width="300"/>
</div>
