...
<details>
<summary>Using Package Manager</summary>
...
```
NoneBot プロジェクトのルートディレクトリにある設定ファイルを開き、 `[plugin]` セクションに追記してください。
...
ショートカットコマンド：`/ds [内容]` またはテキストメッセージに返信
...
ショートカットコマンド：`/ds --with-context [内容]` `/多輪対話`
...
ショートカットコマンド：`/モデル一覧` `/デフォルトモデル設定 [モデル名]`

### カスタムショートカットコマンド

> この機能は [Alconna ショートカットコマンド](https://nonebot.dev/docs/2.3.3/best-practice/alconna/command#command%E7%9A%84%E4%BD%BF%E7%94%A8) に依存しています。カスタムコマンドには `COMMAND_START` が含まれておらず、必要に応じて手動で記入する必要があります。
...
<p align="center">
  <a href="https://github.com/KomoriDev/nonebot-plugin-deepseek" target="__blank">
    <picture>
      ...
      <img src="https://raw.githubusercontent.com/KomoriDev/nonebot-plugin-deepseek/master/./docs/screenshot-light.png" alt="DeepSeek - プレビュー" width="100%" />
    </picture>
  </a>
</p>
...
- [`KomoriDev/Starify`](https://github.com/KomoriDev/Starify)：魅力的なバッジを提供
...
本プロジェクトは [MIT](./LICENSE) ライセンスのもとで公開されています
