...
- Invio di newsletter tramite `mailerlite` 📮
- Questo progetto è ospitato su `netlify`, utilizza un `crawler` per estrarre i documenti necessari allo `schema` di ricerca su `algolia`
