...
- Commentaires et discussions via `giscus` 🌈
- Abonnement et envoi d'emails avec `mailerlite` 📮
- Ce projet est hébergé sur `netlify`, et repose sur un `crawler` pour extraire les documents et alimenter le `schema` de recherche requis par `algolia`
