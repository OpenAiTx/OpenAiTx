...
- Comentários e discussões via `giscus` 🌈
- Envio de newsletter por `mailerlite` 📮
- Projeto hospedado na `netlify`, utilizando `crawler` para coletar documentos e armazenar o `schema` de busca necessário ao `algolia`
