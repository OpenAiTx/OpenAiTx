...
- Comentários e discussões com `giscus` 🌈
- Envio de assinaturas de e-mail usando `mailerlite` 📮
- Este projeto está hospedado no `netlify`, utilizando um `crawler` para coletar documentos e armazenar o `schema` de pesquisa necessário pelo `algolia`
