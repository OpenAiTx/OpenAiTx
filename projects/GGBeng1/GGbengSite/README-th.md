...
- เว็บไซต์ส่วนตัวที่พัฒนาโดยใช้ `Astro`
- ใช้ `algolia` สำหรับค้นหา 🔍
- ใช้ `giscus` สำหรับฝากข้อความและอภิปราย 🌈
- ใช้ `mailerlite` สำหรับส่งจดหมายข่าวสาร 📮
- โปรเจกต์นี้โฮสต์บน `netlify` และอาศัย `crawler` สำหรับเก็บเอกสารแบบสไปเดอร์และจัดเก็บ `schema` ที่จำเป็นสำหรับการค้นหาของ `algolia`
