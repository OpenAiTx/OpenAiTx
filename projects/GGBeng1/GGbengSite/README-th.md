...
- เว็บไซต์ส่วนตัวที่พัฒนาด้วย `Astro`
- ใช้ `algolia` สำหรับการค้นหา 🔍
- ใช้ `giscus` สำหรับฝากข้อความและอภิปราย 🌈
- ใช้ `mailerlite` สำหรับส่งจดหมายสมัครรับข่าวสาร 📮
- โปรเจกต์นี้โฮสต์อยู่บน `netlify` โดยใช้ `crawler` เพื่อดึงเอกสารและจัดเก็บ `schema` สำหรับการค้นหาที่ `algolia` ต้องการ
