...
- Suche über `algolia` 🔍
- Kommentare und Diskussionen über `giscus` 🌈
- E-Mail-Abonnements und Versand über `mailerlite` 📮
- Dieses Projekt wird auf `netlify` gehostet und nutzt einen `crawler`, um Dokumente für das Such-`schema` von `algolia` zu erfassen und zu speichern
