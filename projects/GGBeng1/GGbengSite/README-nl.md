...
- Zoeken met behulp van `algolia` 🔍
- Reacties en discussies via `giscus` 🌈
- E-mailabonnementen verstuurd met `mailerlite` 📮
- Dit project wordt gehost op `netlify`, waarbij een `crawler` wordt gebruikt om documenten te crawlen en het voor `algolia` benodigde zoek-`schema` op te slaan
