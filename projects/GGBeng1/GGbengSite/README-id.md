...
- Situs pribadi yang dikembangkan dengan `Astro`
...
- Proyek ini dihosting di `netlify`, memanfaatkan `crawler` untuk mengambil dokumen dan menyimpan `schema` pencarian yang dibutuhkan oleh `algolia`
