...
- Menggunakan `mailerlite` untuk pengiriman dan berlangganan email 📮
- Proyek ini dihosting di `netlify`, didukung oleh `crawler` untuk mengambil dokumen dan menyimpan `schema` pencarian yang dibutuhkan oleh `algolia`
