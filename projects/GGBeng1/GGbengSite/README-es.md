...
- Utiliza `algolia` para la búsqueda 🔍
- Usa `giscus` para mensajes y discusión 🌈
- Usa `mailerlite` para el envío de suscripciones por correo 📮
- Este proyecto está alojado en `netlify`, y utiliza `crawler` para rastrear documentos y almacenar el `schema` de búsqueda necesario para `algolia`
