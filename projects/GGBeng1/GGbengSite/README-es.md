...
- Mensajes y discusión a través de `giscus` 🌈
- Suscripción y envío de correos electrónicos mediante `mailerlite` 📮
- Este proyecto está alojado en `netlify`, utilizando un `crawler` para rastrear documentos y almacenar el `schema` de búsqueda requerido por `algolia`
