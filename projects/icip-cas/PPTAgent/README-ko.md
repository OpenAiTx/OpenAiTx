...
- [2025/09]: 🛠️ MCP 서버 지원 추가 - 구성 방법은 [MCP Server](https://raw.githubusercontent.com/icip-cas/PPTAgent/main/PPTAgent/DOC.md#mcp-server-) 참고
- [2025/09]: 🚀 주요 개선 사항과 함께 v2 출시 - 상세 내용은 [릴리즈 노트](https://github.com/icip-cas/PPTAgent/releases/tag/v0.2.0) 참고
- [2025/08]: 🎉 논문이 **EMNLP 2025**에 채택되었습니다!
- [2025/05]: ✨ 주요 기능 포함 v1 출시 및 🌟 돌파: GitHub 스타 1,000개 돌파! - 상세 내용은 [릴리즈 노트](https://github.com/icip-cas/PPTAgent/releases/tag/v0.1.0) 참고
- [2025/01]: 🔓 코드베이스 오픈소스화, 실험 코드는 [experiment release](https://github.com/icip-cas/PPTAgent/releases/tag/experiment)에서 확인 가능

## 📖 사용법

> [!중요]
> 1. 아래 모든 API 키, 구성, 서비스는 **필수**입니다.
...
- **온라인 설정**:
  - **MinerU**: [mineru.net](https://mineru.net/apiManage/docs)에서 API 키를 신청하세요. 각 키는 14일 동안 유효합니다.
  - **Tavily**: [tavily.com](https://www.tavily.com/)에서 API 키를 신청하세요.
  - **LLM**: `config.yaml` 파일에 모델 엔드포인트, API 키 및 관련 파라미터를 설정하세요.

- **오프라인 설정**:
  - **MinerU**: [MinerU docker guide](https://opendatalab.github.io/MinerU/quick_start/docker_deployment/#start-services-directly-with-docker-compose)를 참고하여 MinerU 서버를 배포하세요.
  - **설정 스위치**: 네트워크 의존 툴(e.g., `fetch`, `search`) 로딩을 방지하려면 [`config.yaml`](https://raw.githubusercontent.com/icip-cas/PPTAgent/main/deeppresenter/deeppresenter/config.yaml)에서 `offline_mode: true`로 설정하세요.
  - **MinerU 엔드포인트**: [`mcp.json`](https://raw.githubusercontent.com/icip-cas/PPTAgent/main/deeppresenter/deeppresenter/mcp.json)의 `MINERU_API_URL`을 로컬 MinerU 서비스 URL로 설정하세요.
