...
- [2025/09]: 🚀 Выпущена версия v2 с крупными улучшениями — см. [заметки о релизе](https://github.com/icip-cas/PPTAgent/releases/tag/v0.2.0) для подробностей
- [2025/08]: 🎉 Статья принята на **EMNLP 2025**!
- [2025/05]: ✨ Выпущена версия v1 с основной функциональностью и 🌟 прорывом: достигнуто 1 000 звёзд на GitHub! — см. [заметки о релизе](https://github.com/icip-cas/PPTAgent/releases/tag/v0.1.0) для подробностей
