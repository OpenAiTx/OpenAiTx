...
## الأخبار 📅
- [2026/03]: أصبحنا الآن ندعم CLI وأصدرنا نماذجنا المعدلة على [Hugging Face 🤗](https://huggingface.co/collections/ICIP/deeppresenter)!
...
- [2025/09]: 🛠️ تمت إضافة دعم خادم MCP - راجع [خادم MCP](https://raw.githubusercontent.com/icip-cas/PPTAgent/main/PPTAgent/DOC.md#mcp-server-) لتفاصيل التكوين
- [2025/09]: 🚀 إصدار v2 مع تحسينات كبيرة - راجع [ملاحظات الإصدار](https://github.com/icip-cas/PPTAgent/releases/tag/v0.2.0) للتفاصيل
- [2025/08]: 🎉 تم قبول الورقة في **EMNLP 2025**!
- [2025/05]: ✨ إصدار v1 مع الوظائف الأساسية و 🌟 إنجاز: وصلنا إلى 1,000 نجمة على GitHub! - راجع [ملاحظات الإصدار](https://github.com/icip-cas/PPTAgent/releases/tag/v0.1.0) للتفاصيل
- [2025/01]: 🔓 تم فتح مصدر الكود، مع أرشفة الكود التجريبي في [الإصدار التجريبي](https://github.com/icip-cas/PPTAgent/releases/tag/experiment)
...
- **Tavily**: يحسن جودة البحث على الويب. قدم طلبًا لمفتاح API في [tavily.com](https://www.tavily.com/)، ثم عيّن `TAVILY_API_KEY` في [`deeppresenter/mcp.json`](https://raw.githubusercontent.com/icip-cas/PPTAgent/main/deeppresenter/mcp.json).
- **MinerU**: يحسن جودة استخلاص PDF. يمكنك إما التقديم على مفتاح API في [mineru.net](https://mineru.net/apiManage/docs) وتعيين `MINERU_API_KEY` في [`deeppresenter/mcp.json`](https://raw.githubusercontent.com/icip-cas/PPTAgent/main/deeppresenter/mcp.json)، أو نشر MinerU محليًا وتعيين `MINERU_API_URL` بدلاً من ذلك.
- **نموذج تحويل النص إلى صورة**: يحسن جودة توليد الصور. قم بتهيئة `t2i_model` في [`deeppresenter/config.yaml`](https://raw.githubusercontent.com/icip-cas/PPTAgent/main/deeppresenter/config.yaml).
...
يمكن العثور على المزيد من المتغيرات القابلة للتهيئة في [constants.py](https://raw.githubusercontent.com/icip-cas/PPTAgent/main/deeppresenter/utils/constants.py).
...
<tr>
    <td align="center" style="word-wrap: break-word; width: 120.0; height: 120.0">
        <a href=https://github.com/DeJeune>
            ...
            <br />
            <sub style="font-size:14px"><b>سو ياو</b></sub>
        </a>
    </td>
    <td align="center" style="word-wrap: break-word; width: 120.0; height: 120.0">
