...
## Tin tức 📅
- [2026/03]: Chúng tôi hiện hỗ trợ CLI và đã phát hành các mô hình tinh chỉnh trên [Hugging Face 🤗](https://huggingface.co/collections/ICIP/deeppresenter)!
...
- [2025/09]: 🚀 Phát hành v2 với nhiều cải tiến lớn - xem [ghi chú phát hành](https://github.com/icip-cas/PPTAgent/releases/tag/v0.2.0) để biết thêm chi tiết
- [2025/08]: 🎉 Bài báo được nhận đăng ở **EMNLP 2025**!
- [2025/05]: ✨ Phát hành v1 với các chức năng cốt lõi và 🌟 đột phá: đạt 1.000 sao trên GitHub! - xem [ghi chú phát hành](https://github.com/icip-cas/PPTAgent/releases/tag/v0.1.0) để biết chi tiết
- [2025/01]: 🔓 Mã nguồn được mở, với mã thử nghiệm được lưu tại [experiment release](https://github.com/icip-cas/PPTAgent/releases/tag/experiment)
...
- **Tavily**: nâng cao chất lượng tìm kiếm web. Đăng ký API key tại [tavily.com](https://www.tavily.com/), sau đó thiết lập `TAVILY_API_KEY` trong [`deeppresenter/mcp.json`](https://raw.githubusercontent.com/icip-cas/PPTAgent/main/deeppresenter/mcp.json).
- **MinerU**: nâng cao chất lượng phân tích PDF. Bạn có thể đăng ký API key tại [mineru.net](https://mineru.net/apiManage/docs) và thiết lập `MINERU_API_KEY` trong [`deeppresenter/mcp.json`](https://raw.githubusercontent.com/icip-cas/PPTAgent/main/deeppresenter/mcp.json), hoặc triển khai MinerU cục bộ và thiết lập `MINERU_API_URL` thay thế.
- **Mô hình chuyển đổi văn bản thành hình ảnh**: nâng cao chất lượng tạo hình ảnh. Cấu hình `t2i_model` trong [`deeppresenter/config.yaml`](https://raw.githubusercontent.com/icip-cas/PPTAgent/main/deeppresenter/config.yaml).
...
Nhiều biến cấu hình khác có thể được tìm thấy trong [constants.py](https://raw.githubusercontent.com/icip-cas/PPTAgent/main/deeppresenter/utils/constants.py).
...
| Lệnh                | Mô tả                                              |
| ------------------- | ------------------------------------------------- |
| `pptagent onboard`  | Trình hướng dẫn cấu hình tương tác                |
| `pptagent generate` | Tạo bài thuyết trình                              |
| `pptagent config`   | Xem cấu hình hiện tại                             |
| `pptagent reset`    | Đặt lại cấu hình                                   |
| `pptagent serve`    | Khởi động dịch vụ suy luận cục bộ sử dụng bởi CLI |
...
[![Biểu Đồ Lịch Sử Star](https://api.star-history.com/svg?repos=icip-cas/PPTAgent&type=Date)](https://star-history.com/#icip-cas/PPTAgent&Date)
