...
<br/>
   ...
   On OSX [???]:<br/>
 * I don't have access to OSX and am not even sure how well AMaDiA runs on it (it should work flawlessly?)... Sorry but I cannot help you...<br/>
 * If anyone has a good description of how to easily install/update+run a python script on OSX feel free to inform me so I can add it here<br/>
