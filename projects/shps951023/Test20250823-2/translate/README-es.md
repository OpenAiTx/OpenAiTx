...
Comienza bien, sin embargo solo la parte superior de la imagen es realmente convertida y en la cadena le siguen miles de "A" repetidos. Reconstruir la imagen solo muestra la parte superior de la imagen. ¿Qué estoy haciendo mal?

Actualmente no he subido ni vuelto a descargar la cadena, todo está local hasta que pueda descubrir qué está mal. Estoy usando imageString como la fuente de la imagen. Estoy usando .net 6.0.
