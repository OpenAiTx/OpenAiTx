...
Une bibliothèque complète cliente ACME v2 en PHP pour automatiser la gestion des certificats SSL/TLS avec Let's Encrypt, ZeroSSL et d'autres autorités de certification compatibles ACME.
...
[![Licence : MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/anhao/acme-client)
[![Version PHP](https://img.shields.io/badge/PHP-%3E%3D8.2-blue.svg)](https://www.php.net/)

> **Langue / 语言** : [Anglais](https://raw.githubusercontent.com/anhao/acme-client/main/README.md) | [中文](https://raw.githubusercontent.com/anhao/acme-client/main/README_ZH.md)

## Fonctionnalités

- **Prise en charge du protocole ACME v2** : Compatibilité totale avec la spécification ACME v2
- **Prise en charge de plusieurs autorités de certification** : Fonctionne avec Let's Encrypt, ZeroSSL et d'autres fournisseurs ACME
- **Gestion de comptes** : Création, stockage et gestion des comptes ACME
- **Opérations sur les certificats** : Demande, renouvellement et révocation de certificats SSL
- **Validation de domaine** : Prise en charge des défis HTTP-01 et DNS-01
- **Prise en charge ARI** : Informations de renouvellement automatique pour un timing optimal
- **Types de clés flexibles** : Prise en charge des clés RSA et ECC
- **Journalisation complète** : Journalisation intégrée compatible PSR-3
- **Intégration facile** : Conception d'API simple et intuitive
...
### 1. Créer des clés de compte locales

Vous avez deux façons de créer et gérer les clés de compte ACME :

**Option A : Utiliser des clés existantes avec la classe Account**
...
**Option B : Utilisation de AccountStorage pour la gestion des clés basée sur les fichiers**
...
### 3. Enregistrer un compte ACME

Pour Let's Encrypt (aucune EAB requise) :
...
### 5. Validation Complète du Domaine

Après avoir placé les fichiers de défi sur votre serveur web :
...
Pour les certificats génériques ou lorsque la validation HTTP n'est pas possible :
...
### Renouvellement de certificat avec ARI
...
**Utilisation de AccountStorage pour la gestion basée sur les fichiers :**
...
**Utilisation de la classe Account pour les clés existantes :**
...
1. **Clés Privées** : Stockez les clés privées de manière sécurisée avec des permissions de fichier appropriées (600)
2. **Clés de Compte** : Gardez les clés de compte séparées des clés de certificat
3. **Environnement de Mise en Scène** : Utilisez un environnement de mise en scène pour les tests
4. **Limites de Taux** : Soyez conscient des limites de taux des AC
5. **Validation** : Validez toujours les défis localement avant de déclencher la validation ACME
...
- [Spécification ACME RFC 8555](https://tools.ietf.org/html/rfc8555)
- [Guide ACME ZeroSSL](https://zerossl.com/documentation/acme/)

## Support

Si vous rencontrez des problèmes ou avez des questions :

1. Consultez la [documentation](#quick-start)
2. Recherchez les [issues](https://github.com/anhao/acme-client/issues) existantes
3. Créez une [nouvelle issue](https://github.com/anhao/acme-client/issues/new) si nécessaire
