...
Una completa biblioteca cliente ACME v2 en PHP para automatizar la gestión de certificados SSL/TLS con Let's Encrypt, ZeroSSL y otras Autoridades Certificadoras compatibles con ACME.

[![estadísticas github](https://img.shields.io/github/stars/anhao/acme-client?style=flat-square&label=github%20stats)](https://github.com/anhao/acme-client)
[![Licencia: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/anhao/acme-client)
[![Versión PHP](https://img.shields.io/badge/PHP-%3E%3D8.2-blue.svg)](https://www.php.net/)

> **Idioma / 语言**: [Inglés](https://raw.githubusercontent.com/anhao/acme-client/main/README.md) | [中文](https://raw.githubusercontent.com/anhao/acme-client/main/README_ZH.md)

## Características

- **Soporte del Protocolo ACME v2**: Compatibilidad total con la especificación ACME v2
- **Soporte para múltiples CA**: Funciona con Let's Encrypt, ZeroSSL y otros proveedores ACME
- **Gestión de cuentas**: Crear, almacenar y administrar cuentas ACME
- **Operaciones de certificados**: Solicitar, renovar y revocar certificados SSL
- **Validación de dominio**: Soporte para desafíos HTTP-01 y DNS-01
- **Soporte ARI**: Información de Renovación Automática para un tiempo de renovación óptimo
- **Tipos de claves flexibles**: Soporte para claves RSA y ECC
- **Registro integral**: Registro incorporado compatible con PSR-3
- **Integración sencilla**: Diseño de API simple e intuitivo
...
**Opción A: Usar claves existentes con la clase Account**
...
**Opción B: Uso de AccountStorage para la gestión de claves basada en archivos**
...
### 5. Validación Completa del Dominio

Después de colocar los archivos de desafío en su servidor web:
...
Para certificados comodín o cuando la validación HTTP no es posible:
...
### Renovación del Certificado con ARI
...
**Uso de AccountStorage para la gestión basada en archivos:**
...
4. **Límites de Tasa**: Esté atento a los límites de tasa del CA
5. **Validación**: Siempre valide los desafíos localmente antes de activar la validación ACME
...
- [Especificación ACME RFC 8555](https://tools.ietf.org/html/rfc8555)
- [Guía ACME de ZeroSSL](https://zerossl.com/documentation/acme/)

## Soporte

Si encuentra algún problema o tiene preguntas:

1. Revise la [documentación](#quick-start)
