...
To get the image, you'll need to convert the `byte[]` into a string. For example:
...
## Custom styling
You can customize the looks of SignaturePad by either overriding the CSS classes or by specifying your own classes.
