...
Mobiele webcomponentenbibliotheek gebaseerd op [Svelte](https://svelte.dev) en [Tailwind](https://www.tailwindcss.com) .

> **S**impel • **T**iny (Klein) • **D**esign • **F**ast (Snel)

# Kenmerken

- 🔥 Volledige ondersteuning voor Svelte v5, Tailwind CSS v4 en TypeScript.
- 🚀 Geen runtime, geen virtuele DOM — draait sneller online.
- 🧰 Rijke API — configureer componentstijlen eenvoudig om aan uw wensen te voldoen.
- 🍭 Ondersteunt donkere modus en meerdere themaconfiguraties.
- 📖 Biedt uitgebreide Chinese en Engelse documentatie en componentvoorbeelden.
- 🌍 Ondersteunt internationalisatie, met meer dan 60 ingebouwde taalpakketten.
- 🫰 Gebruiksvriendelijke interactie, animatieparameters zijn configureerbaar en aangepaste thema's worden ondersteund.
- 🤝 Ondersteunt Tailwind-bibliotheken zoals UnoCSS.
- 🫡 Geen externe afhankelijkheden — geen zorgen over bibliotheekversies of beveiligingsproblemen.
- 📦 Ondersteunt importeren op aanvraag om de bundelgrootte te verkleinen.
- 🪜 Wordt geleverd met een scaffolding-tool voor snelle projectaanmaak.
- 🔗 Wordt geleverd met een SVG-merge plugin voor het snel samenvoegen van SVG-bestanden, ondersteuning voor Iconify.
- 🍺 IDE-plugin om snel component-API's te bekijken.
...
Scan de QR-code om toegang te krijgen tot de mobiele demo:
...
Je kunt STDF snel proberen op StackBlitz's [STDF Demo](https://stackblitz.com/github/any-tdf/demo-stdf?startScript=dev_en).

# Feedback en Communicatie

We raden aan om [GitHub Issues](https://github.com/any-tdf/stdf/issues) te gebruiken voor directe en effectieve feedback en communicatie. Bijdragen aan de code worden ook zeer gewaardeerd. Je kunt ook kiezen uit de volgende opties:

- [QQ Groep](https://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=U8ZlXJ3KVpTI9oZzs1jBnyWc3gVA0h6Y&authKey=ScWu0nU9g8BqNsC7o2eYkESwgVDVz9vzGNZEb17MrEAay9%2F7bTkXDiLJRIzo2vrg&noverify=0&group_code=581073686)
- [QQ Discord](https://pd.qq.com/s/fdd8incyr)
- [Discord](https://discord.gg/DMkHu8GGre)
- [Discussies](https://github.com/any-tdf/stdf/discussions)
...
Dit project is gelicenseerd onder de [MIT-licentie](https://github.com/any-tdf/stdf/blob/main/LICENSE). Voel je vrij om van dit open source-project te genieten en bij te dragen.
