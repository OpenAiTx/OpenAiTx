...
Biblioteka komponentów mobilnych oparta na [Svelte](https://svelte.dev) oraz [Tailwind](https://www.tailwindcss.com) .

> **S**imple • **T**iny • **D**esign • **F**ast

# Funkcje

- 🔥 Pełna obsługa Svelte v5, Tailwind CSS v4 oraz TypeScript.
- 🚀 Brak środowiska uruchomieniowego, brak wirtualnego DOM — szybsze działanie online.
- 🧰 Bogate API — łatwa konfiguracja stylów komponentów według własnych potrzeb.
- 🍭 Obsługa trybu ciemnego oraz wielu konfiguracji motywów.
- 📖 Obszerna dokumentacja w języku chińskim i angielskim oraz przykłady komponentów.
- 🌍 Obsługa internacjonalizacji, ponad 60 wbudowanych pakietów językowych.
- 🫰 Przyjazna interakcja, możliwość konfiguracji parametrów animacji oraz wsparcie dla własnych motywów.
- 🤝 Obsługa bibliotek Tailwind takich jak UnoCSS.
- 🫡 Brak zależności zewnętrznych — brak obaw o wersje bibliotek czy kwestie bezpieczeństwa.
- 📦 Obsługa importu na żądanie w celu zmniejszenia rozmiaru paczki.
- 🪜 Wbudowane narzędzie szkieletowe do szybkiego tworzenia projektów.
- 🔗 Wbudowana wtyczka do łączenia SVG pozwalająca na szybkie scalanie plików SVG, wsparcie Iconify.
- 🍺 Wtyczka IDE do szybkiego podglądu API komponentów.
...
Zeskanuj kod QR, aby uzyskać dostęp do wersji demonstracyjnej na urządzeniu mobilnym:
...
Możesz szybko przetestować STDF w [STDF Demo na StackBlitz](https://stackblitz.com/github/any-tdf/demo-stdf?startScript=dev_en).

# Zgłaszanie uwag i komunikacja

Zalecamy korzystanie z [GitHub Issues](https://github.com/any-tdf/stdf/issues) w celu bezpośredniego i skutecznego przekazywania informacji zwrotnych oraz komunikacji. Wkład w postaci kodu jest również mile widziany. Możesz także skorzystać z poniższych opcji:

- [Grupa QQ](https://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=U8ZlXJ3KVpTI9oZzs1jBnyWc3gVA0h6Y&authKey=ScWu0nU9g8BqNsC7o2eYkESwgVDVz9vzGNZEb17MrEAay9%2F7bTkXDiLJRIzo2vrg&noverify=0&group_code=581073686)
- [QQ Discord](https://pd.qq.com/s/fdd8incyr)
- [Discord](https://discord.gg/DMkHu8GGre)
- [Dyskusje](https://github.com/any-tdf/stdf/discussions)
...
Ten projekt jest objęty licencją [MIT License](https://github.com/any-tdf/stdf/blob/main/LICENSE). Zachęcamy do korzystania i współtworzenia tego projektu open-source.
