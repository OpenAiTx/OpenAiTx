> *[Tritt unserer Community bei](https://metadevelopment.io/)* für professionelle Softwareentwickler und erhalte mehr Kontrolle über dein Leben und deine Karriere!

----

# Was jeder Programmierer wissen sollte :thinking:
Eine Sammlung von (meist) technischen Dingen, die jeder Softwareentwickler wissen sollte.

:point_up: *Dies sind Ressourcen, die ich jedem Programmierer empfehlen kann, unabhängig von Erfahrungslevel oder Tech-Stack.*

Stark subjektiv :bomb:. Nicht wissenschaftlich belegt.
Ohne bestimmte Reihenfolge :recycle:

Gefällt's dir? :star: Markiere es und [teile es](https://twitter.com/mr_mig_by/status/900735231552098306) mit einem befreundeten Entwickler!
Gefällt's dir nicht? [Schau dir den Hund an](https://twitter.com/RespectfulMemes/status/900147758845308930) :dog:

*P.S. Du [musst das nicht alles](https://xkcd.com/1050/) auswendig können, um Programmierer zu sein.
Aber das Wissen hilft dir, besser zu werden! :muscle:*

*P.P.S. [Beiträge](CONTRIBUTING.md) sind willkommen!*
...
- [Awesome Falsehoods](https://github.com/kdeldycke/awesome-falsehood)
  💊 Kuratierte Liste von Irrtümern, die Programmierer glauben.
  Prüfe, was du nicht über Strings, Adressen, Namen, Zahlen, E-Mails, Zeitzonen, Daten und mehr weißt.
...
- [Learn X in Y Minutes](https://learnxinyminutes.com/)
  Lerne die Grundlagen einer Sprache auf sehr komprimierte Weise.
- [Hyperpolyglot](http://hyperpolyglot.org/)
  Vergleiche gängige Features ähnlicher Programmiersprachen Seite an Seite. Hilft dir beim Wechsel zwischen Python<->Ruby, Ocaml<->Haskell, etc.
...
- :moneybag: [Levels FYI](https://www.levels.fyi)  
  Gehaltsstatistiken für verschiedene Tech-Unternehmen. Besser als Glassdoor.
...
- [Awesome Mental Health](https://github.com/dreamingechoes/awesome-mental-health)  
  Eine kuratierte Liste großartiger Artikel, Webseiten und Ressourcen rund um mentale Gesundheit in der Softwarebranche.

### Publikationen zum Programmieren
...
### Kostenlose Bücher zum Programmieren
