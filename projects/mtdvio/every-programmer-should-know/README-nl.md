> *[Word lid van onze community](https://metadevelopment.io/)* voor professionele Software Developers en krijg meer controle over je leven en carrière! 

----

# Wat Elke Programmeur Zou Moeten Weten :thinking:
Een verzameling van (voornamelijk) technische zaken die elke softwareontwikkelaar zou moeten weten.

:point_up: *Dit zijn bronnen die ik aan elke programmeur kan aanbevelen, ongeacht hun vaardigheidsniveau of tech-stack*

Sterk subjectief :bomb:. Niet wetenschappelijk onderbouwd.
In willekeurige volgorde :recycle:

Vind je het leuk? :star: Geef een ster en [deel](https://twitter.com/mr_mig_by/status/900735231552098306) het met een bevriende ontwikkelaar!
Vind je het niet leuk? [Bekijk de hond](https://twitter.com/RespectfulMemes/status/900147758845308930) :dog:

*P.S. Je [hoeft niet alles](https://xkcd.com/1050/) hiervan uit je hoofd te kennen om programmeur te zijn.
Maar deze kennis helpt je wel om beter te worden! :muscle:*

*P.P.S. [Bijdragen](CONTRIBUTING.md) zijn welkom!*

----

### Introductie
- :movie_camera: [Map of Computer Science](https://www.youtube.com/watch?v=SzJ46YA_RaA)
- :movie_camera: [40 Belangrijke Informatica Concepten Uitgelegd in Jip-en-Janneketaal](http://carlcheo.com/compsci)
- :page_facing_up: [Computer Science Roadmap](https://roadmap.sh/computer-science)

### Misvattingen
- [Awesome Falsehoods](https://github.com/kdeldycke/awesome-falsehood)
  💊 Geselecteerde lijst van misvattingen waarin programmeurs geloven.
  Controleer zaken die je niet weet over Strings, Adressen, Namen, Nummers, E-mails, Tijdzones en Datums en meer.
...
### Strings
- :page_facing_up: [Unicode en Karaktersets](https://www.joelonsoftware.com/articles/Unicode.html)
...
### Latentie
- [Interactieve Latency Infographics](https://people.eecs.berkeley.edu/~rcs/research/interactive_latency.html)
- :page_facing_up: [Latency Getallen Die Elke Programmeur Zou Moeten Weten](https://gist.github.com/jboner/2841832)

### Tijd
- :page_facing_up: [Enkele notities over tijd](https://unix4lyfe.org/time/)
- :movie_camera: [Het Probleem met Tijdzones](https://www.youtube.com/watch?v=-5wpm-gesOY)

### Geheugen
- :page_facing_up: [Wat elke Programmeur zou moeten weten over geheugen](https://lwn.net/Articles/250967/)
...
- :page_facing_up: [Jepsen: hoe verschillende databases zich gedragen bij partitionering](https://aphyr.com/tags/jepsen)
- :scroll: [Fallacies of Distributed Computing Explained](https://pages.cs.wisc.edu/~zuyu/files/fallacies.pdf)

### RegExp
- [RegexHQ](https://github.com/regexhq)
- [Leer regex op een makkelijke manier](https://github.com/ziishaned/learn-regex)

### Beveiliging
- :book: [Security Programming](https://www.dwheeler.com/secure-programs/)
- :page_facing_up: [Roll Your Own Crypto](http://loup-vaillant.fr/articles/rolling-your-own-crypto)
...
- :page_facing_up: [Hashing, Encryptie en Codering](https://www.integralist.co.uk/posts/hashing-and-encryption/)
...
### SEO
- :page_facing_up: [Wat elke programmeur moet weten over SEO](https://katemats.com/blog/what-every-programmer-should-know-about-seo)
...
- :movie_camera: [CQRS en Event Sourcing](https://www.youtube.com/watch?v=JHGkaShoyNs)
...
- :page_facing_up: [Hoe JavaScript werkt: deel-1](https://blog.sessionstack.com/how-does-javascript-actually-work-part-1-b0bacc073cf), [2](https://blog.sessionstack.com/how-javascript-works-inside-the-v8-engine-5-tips-on-how-to-write-optimized-code-ac089e62b12e), [3](https://blog.sessionstack.com/how-javascript-works-memory-management-how-to-handle-4-common-memory-leaks-3f28b94cfbec), [4](https://blog.sessionstack.com/how-javascript-works-event-loop-and-the-rise-of-async-programming-5-ways-to-better-coding-with-2f077c4438b5)
- :movie_camera: [Entity-Component-System Architectuur met Unity als voorbeeld](https://www.youtube.com/watch?v=lNTaC-JWmdI&t=166s&list=PLZlJZzHmx31XvgT96DfbXQ4IMb1ryztbp&index=33)
...
- :page_facing_up: [Snelheid in softwareontwikkeling](https://www.targetprocess.com/articles/speed-in-software-development/)
...
- :page_facing_up: [De Tien Regels van een Zen Programmeur](https://www.zenprogrammer.org/en/10-rules-of-a-zen-programmer.html)
- :page_facing_up: [De mythische 10x programmeur](http://antirez.com/news/112)
- :page_facing_up: [De Debugging Mindset](https://queue.acm.org/detail.cfm?id=3068754)
- :movie_camera: [De toekomst van programmeren](http://worrydream.com/dbx/)
- :page_facing_up: [Het Good Software Development Manifest](https://www.infoworld.com/article/3214481/application-development/the-good-software-development-manifesto.html)
- :movie_camera: [All the Little Things](https://www.youtube.com/watch?v=8bZh5LMaSmE)
- :page_facing_up: [Leer jezelf programmeren in tien jaar](http://norvig.com/21-days.html)
...
- :page_facing_up: [Dertien manieren om naar een schildpad te kijken](https://fsharpforfunandprofit.com/posts/13-ways-of-looking-at-a-turtle-3/)
- :scroll: [Programming Paradigms for Dummies: Wat elke programmeur moet weten](https://www.info.ucl.ac.be/~pvr/VanRoyChapter.pdf)
- [Learn X in Y Minutes](https://learnxinyminutes.com/)
  Leer de basis van een taal op een zeer compacte manier.
- [Hyperpolyglot](http://hyperpolyglot.org/)
  Vergelijk veelgebruikte features van min of meer vergelijkbare talen naast elkaar. Helpt je om te switchen tussen Python<->Ruby, Ocaml<->Haskell, enz.
- :page_facing_up: [Pomodoro voor Programmeurs](https://medium.com/@mr_mig_by/pomodoro-for-programmers-d6568dd1e6fc)
...
- :moneybag: [Levels FYI](https://www.levels.fyi)  
  Salarisstatistieken voor verschillende techbedrijven. Beter dan Glassdoor.
- :page_facing_up: [10 Dingen Die Elke Programmeur Zou Moeten Weten Voor Hun Eerste Baan](http://www.applematters.com/article/10-things-every-programmer-should-know-for-their-first-job/)
- :page_facing_up: [Hoeveel Verdienen Software Engineers Echt in Elke Stad?](https://www.codementor.io/blog/best-cities-software-engineer-earnings-271vpf599k)
...
- [Een lijst van Europese investeerders](https://docs.google.com/spreadsheets/d/1hfl67rI0Pk_hSm0GIX0QByW4NgfAH-cEmMa4N6UoO1w/edit#gid=1203141194)
- :page_facing_up: [Tien Regels voor het Onderhandelen over een Baan](https://medium.com/free-code-camp/ten-rules-for-negotiating-a-job-offer-ee17cccbdab6)
- :page_facing_up: [Hoe interview je als ontwikkelaarskandidaat](https://medium.freecodecamp.com/how-to-interview-as-a-developer-candidate-b666734f12dd)
- :page_facing_up: [Hoe Krijg Je Sneller Een Techbaan In Het Buitenland](https://relocate.me/blog/job-relocation/landing-a-tech-job-abroad-7-simple-tips/#more-514)
...
- :page_facing_up: [Equity 101 voor Startup Medewerkers](https://blog.carta.com/equity-101-stock-option-basics/)
- :book: [Cracking the Coding Interview: 189 Programmeervragen en Oplossingen](https://www.goodreads.com/book/show/25707092-cracking-the-coding-interview)
- :fire: [Alles wat je moet weten om de baan te krijgen](https://github.com/kdn251/interviews)
- :book: [Tech Interview Handbook](https://github.com/yangshun/tech-interview-handbook)
- :page_facing_up: [Leer jezelf programmeren in tien jaar](https://norvig.com/21-days.html)
- :page_facing_up: [Wat je zou moeten weten als oprichter van een softwarebedrijf](https://qotoqot.com/blog/founder-skills/)
- :movie_camera: [Code Interview Prep & Programmeervragen | Pramp](https://www.pramp.com/)
- :book: [97 Dingen Die Elke Programmeur Zou Moeten Weten](https://github.com/97-things/97-things-every-programmer-should-know)
...
### Open Source
- :globe_with_meridians: [Leer hoe je Git en GitHub gebruikt](https://www.deployhq.com/git)

### Remote Werken
- :globe_with_meridians: [Remotive.io: Startups die remote aannemen](https://docs.google.com/spreadsheets/d/1TLJSlNxCbwRNxy14Toe1PYwbCTY7h0CNHeer9J0VRzE/htmlview?sle=true#gid=1279011369)
- :globe_with_meridians: [Remote Work Lijst voor Ontwikkelaars](https://github.com/georgemandis/remote-working-list)
- :zap: [NomadList](https://nomadlist.com/)
- :book: [De Ultieme Gids voor Remote Werken](https://zapier.com/learn/remote-work/)
...
- [Awesome Mental Health](https://github.com/dreamingechoes/awesome-mental-health)  
  Een samengestelde lijst van geweldige artikelen, websites en bronnen over mentale gezondheid in de software-industrie.

### Papers over Programmeren
...
### Gratis Boeken Over Programmeren
...
### Licenties
- [Kies een Open Source Licentie](https://choosealicense.com/)
- [Goed uitgelegde softwarelicenties in TLDR-versie](https://tldrlegal.com/)
- [Hoe open source licenties werken en hoe je ze toevoegt aan je projecten](https://medium.freecodecamp.org/how-open-source-licenses-work-and-how-to-add-them-to-your-projects-34310c3cf94)

### Waar Verder Te Zoeken
...
### Oefensites Voor Programmeren :zap:
